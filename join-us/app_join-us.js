      ...
      el.addEventListener("click", function (e) {
        ...
        function createModalContent(tingleModalData) {
          ...
          if (tingleModalData["company-link"]) {
            ...
            modalHtml +=
              '<a class="cat-details col-3 modal" href="' +
              tingleModalData["company-link"] +
              '">' +
              tingleModalData.company +
              '<span id="ico-info" class="material-symbols-outlined">arrow_right_alt</span>' +
              "</a>";
...
function initStep(stepperBlockId) {
  ...
  $(
    ...
    if (step - 1 < 0) {
      $(
        stepperBlockId +
          ' .step-content .step-content-foot button[name="prev"]',
      ).addClass("out");
    }
  });
}
