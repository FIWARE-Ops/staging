...
var dropdownFilters = (filter) => {
  ...
  var currentCompany = jQuery('#filterCompany').val();
  if (currentCompany !== '*'){
...
pageData.forEach((gridElementData, i) => {
  var gridElement = `<div class="grid-item ${createClassFilter(
    ...
    <div class="gridElementTextContainer">
      ...
      <div class="label-certification"><span class="material-icons-outlined" id="ico-featured">verified</span> <span class="year">${gridElementData.year}</span></div>
      </div>
