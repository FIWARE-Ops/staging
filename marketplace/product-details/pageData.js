var pageData = {
  powered: {
    ...
    'martelinnovate-orchestracities': {
      ...
      challenge: '',
      references:
        '<ul> <li>Antwerp</li> <li>Helsinki</li> <li>Wolfsburg</li> <li>POC in Switzerland</li> </ul>',
      awards:
  ...
  services: {
    ...
    'mnxonline-coachingtrainingservices': {
      ...
      featuredImage:
        'https://scontent.ftia9-1.fna.fbcdn.net/v/t1.18169-9/522871_340679879331342_532333432_n.jpg?_nc_cat=111&ccb=1-7&_nc_sid=e3f864&_nc_ohc=mzmwd7tZP_MAX-uvzgi&_nc_ht=scontent.ftia9-1.fna&oh=00_AT9EhUT_BlgW_x9LoDlDYtyVzjszRiY3kEo4kJWQWbjhhA&oe=631AC3ED',
      furtherImages: '',
      related: [
        {
          category: 'Services',
