var pageData = {
  powered: {
    'uiurbansoftware-uiurbanpulse': {
      ...
      organisationEmail: 'mailto:info@ui.city',
      linkedIn: 'https://www.linkedin.com/company/uigroup/',
      twitter: 'https://twitter.com/ui_city',
      productWebsite: 'https://www.ui.city/loesungen#urbanpulse',
      excerpt:
    ...
    'absolutezero-thor': {
      ...
      productName: 'Thor',
      organisationWebsite: '',
      organisationEmail: 'mailto:hello@absolutezerovr.com',
      linkedIn: '',
      twitter: '',
      productWebsite: 'http://www.absolutezerovr.com',
      excerpt:
      ...
      description:
        '<p>AZ’s VR camera and cloud platform are currently introduced to the EU market. Interactive AR 360° streaming (currently at TRL 6) is achieved through:</p>\n<ul>\n<li>Multiple AZ’s VR cameras individually record 12 video streams and collect positioning metadata via an in-built GPS sensor. The metadata enables the cameras to become aware of their locations in step F). </li>\n<li>Each camera sends all 12 streams( including metadata) to the Cloud for further processing. </li>\n<li>Optical flow algorithms stitch all 12 streams into a 360° format for each camera; </li>\n<li>The resulting 360° videos are stored conjointly in a content delivery network container, which has a universal timeline that  synchronizes all videos to run simultaneously when viewing. </li>\n<li>A 360° media player interfaces to this container and allows to view the 360° video; </li>\n<li>A real-time AR layer, embedded in the 360° media player, visualizes all metadata and shows the other cameras as position markers. Each marker can be activated via an eye gaze trigger.</li>\n</ul>\n<p>Interactive VR streaming is a novel technology with massive potential, enabling new possibilities for audiences who are not able to be at a location physically. AZ technology enables twofold unique benefits:</p>\n<p>Production\nEvent broadcasters can stream with multiple AZ cameras simultaneously. Our self-aware VR cameras are key to enabling a maximum level of automation, and hence facilitate easy adoption through first moving TV studios, event broadcasters, and video producers.</p>\n<p>Consumption\nAudiences can revisit respective events in real-time, and jump between each of AZ’s camera’s locations at will. The cloud architecture furthermore creates a P2P ecosystem to host and distribute content directly to the end-user seamlessly. Consumers can view AR- enabled VR streams from any device, without the need for installation of additional software.</p>',
      challenge:
        '<p>On the huge field, one camera, even a 360° one is usually not enough. It is quite problematic both to switch between multiple streaming windows (especially with the hmd on) and to upload multiple streams with different metadata.</p>\n<p>VR is a young medium and requires a significant infrastructure push to become adopted to the mainstream. A lack of infrastructure is found on both ends of the value chain of digital media creation:\n1.Production\nInteractivity in a 360° video can only be achieved if the video is embedded on a website, which creates additional costs for web development. An average video production company with two clients per month will spend an estimate of:</p>\n<ul>\n<li><p>5,350€ for PC and 360° camera; </p></li>\n<li><p>2,600€ per year for software licenses and freelance web developers; </p></li>\n<li><p>20 hours of work per project.</p></li>\n</ul>\n<ol>\n<li>Consumption</li>\n</ol>\n<p>The access to interactive content and the device used for consumption is  as important as the content creation itself. The US alone counts 2,2 mio. people in a wheelchair who are significantly limited in participating in socio-cultural events like festivals or football matches. Interactive 360 streaming creates freedom in exploration for people who are bound by physical or regional limitations.</p>',
      references: '',
      awards: '',
      ...
      featuredImage: 'https://i.ytimg.com/vi/ReKIfNCd-h8/maxresdefault.jpg',
      furtherImages: ''
    },
    'accelogresslimited-saveaspace': {
      ...
      organisationEmail: 'mailto:hello@accelogress.com',
      linkedIn: 'https://www.linkedin.com/company/accelogress-limited/',
      twitter: 'https://mobile.twitter.com/sasparking',
      productWebsite: 'https://www.save-a-space.com',
      excerpt:
      ...
      domains: ['Cities', 'Mobility', 'Sustainability', 'Transport'],
      docs: [],
      videos: [],
      materials: [],
      logo:
      ...
      featuredImage:
        'https://pbs.twimg.com/profile_banners/707587044348919808/1458038594/1500x500',
      furtherImages: ''
    },
    'agricolus-agricolus': {
      category: 'Powered by FIWARE',
      ...
      awards:
        '<p>First prize of the Startup Forum at the Food 4 Future event in Bilbao in 2021\nAward for the best team at Global Agripreneurs Summit 2019\nSME Instrument Phase 1 winner with Agricolus DSS project ID: 719968 Fractals winner with Oliwes solution is sub granted by FP7 Fractals ref. GA 632874 European Agricultural Fund for Rural Development (EAFRD) \nSpeed Up Europe winner with Agricolus Web Awareness project sub granted by FP7 Speed UP! Europe ref. GA 632858</p>',
      technologies: [
    ...
    'amigo-indexdesignandanalysis': {
      ...
      organisationEmail: '',
      linkedIn:
        'https://www.linkedin.com/in/amigoclimate/?originalSubdomain=it',
      twitter: 'https://twitter.com/Amigo_climate',
      productWebsite: 'https://amigoclimate.com/',
      excerpt:
      ...
      yearOfValidation: 2019,
      description:
        '<p>With IDA we radically change the use of climate data and climate information in the climate risk management industry, since References/Customers will be able to perform tailored analysis for the index-based insurance industry, automatically getting maps and reports, effectively calculating premiums. Compared to existing solutions IDA is more performing and scalable, easier to use, cloud-based, cheaper and it offers over time continuity for monitoring indices, thus ensuring economic benefits to References/Customers. IDA allows References/Customers to enter a huge variety of data that could be customized according to users’ needs.</p>',
      challenge:
        '<p>A crucial problem affecting insurance and reinsurance companies in climate index-based risk transfer schemes is the lack of a trusted, transparent, independent and affordable way to design, compute and monitor the underpinning climate indices . AMIGO - as an innovative SME providing climate solutions to international organizations, insurers and reinsurers, for the management of climate-related risk in the agricultural sector - has developed a new generation of methods and tools for climate risk management.</p>',
      references: '<p>Insurance Companies, international organizations</p>',
      awards: '',
    ...
    'atos-masai': {
      ...
      twitter:
        'https://twitter.com/Atos?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor',
      productWebsite: 'https://booklet.atosresearch.eu/shuttles/masai-ip',
      excerpt:
      ...
      yearOfValidation: 2019,
      description:
        '<p>MASAI is a Data Collector and System Integrator middleware component focused on IoT devices developed based on the experience gained in Manufacturing. MASAI is composed of  a set of components that tackle three different issues: communication, management of the devices and handling of data. </p>\n<ul>\n<li>Communication: grating interoperability and adaptation between different protocols and the matching between consumers and providers of data. </li>\n<li>Device Management functionalities to enclose generic information about devices and also to address their security and connectivity. </li>\n<li>Data handling functionalities, MASAI is also granted with a subcomponent that ensures that the data obtained in the IoT world is pre-filtered before being passed to a consumer, reducing the flow or the quantity of inaccurate data. Among its main capabilities, it can be highlighted: </li>\n<li>Based on Generic Enablers from FIWARE and extended to enhance communication capabilities. * Facilitates interoperability among systems. </li>\n<li>Devices Virtualization, which allows  aggregating of data and the creation of virtual entities. </li>\n<li>Data filtering, limiting dataflow or access to inaccurate data to higher layers. </li>\n<li>Provides monitoring of device capacities. </li>\n<li>Supports well-known IoT protocols: MQTT, OPC UA, AMQP, and socket.io. </li>\n<li>Allows communication with Cloud platforms like FIWARE and Siemens MindSphere. Visualization capabilities of real-time and historical data to facilitate the follow up of a process.</li>\n</ul>',
      challenge:
        "<p>Today's enterprises are linearly organized and optimized within the boundaries of companies and system silos, while companies of the future will fulfill individual customer needs by using a collaborative and agile network of capabilities. In this context, IoT will have an important role in the vertical and horizontal integration of systems. New IT technologies allow us to retrieve, connect and interpret all the data generated during the manufacturing process. Making use of that data will help companies to have more control over their own processes, supporting them when decision making is needed and so, becoming more effective and competitive</p>",
      references:
        '<p>SMEs and software developers interested in FIWARE based technologies</p>',
      awards: '',
      technologies: [
        'Internet of Things',
    ...
    'bettaircities-bettair': {
      ...
      productName: 'Bettair',
      organisationWebsite: '',
      organisationEmail: 'mailto:info@bettaircities.com',
      linkedIn: 'https://www.linkedin.com/company/bettair-cities/',
      twitter: '',
      productWebsite: 'https://bettaircities.com',
      excerpt:
      ...
      description:
        '<p>Bettair – high-quality large scale pollution mapping tools for big cities.</p>\n<p>Description &amp; Benefit\nBettair® is a Platform as a Service (PaaS) that permits, for the first time, to map urban air pollution in cities on a previously unimaginable scale based on a large deployment of outstandingly accurate gas sensors by using an advanced post-processing algorithm. A proprietary calibration process combined with the use of unsupervised machine learning techniques to take into account both the known and unknown factors that affect the sensors allows Bettair® to increase the accuracy of the measurement up to 90% and more depending on the pollutant.</p>\n<p>Bettair Static Node. The Bettair Static Nodes are standalone sensor packs. The nodes do not require any external power supply and transmit data directly to a server for cloud processing. The specifications of the node are as follows:</p>\n<p>The static nodes are composed of electrochemical gas sensors (up to 4) to measure (ppb or ug/m3):  NO2 </p>\n<ul>\n<li><p>NO </p></li>\n<li><p>CO or H2S </p></li>\n<li><p>O3 or SO2\nOptical Particle Counter (ug/m3) for: PM1 </p></li>\n<li><p>PM2.5 </p></li>\n<li><p>PM10\nOther ambient quality indicators are also measured such as:</p></li>\n<li><p>Temperature (ºC) </p></li>\n<li><p>Relative humidity (%RH) </p></li>\n<li><p>Atmospheric pressure (hPa) </p></li>\n<li><p>Ambient noise (dbA)\nFeatures</p></li>\n<li><p>Dust tight and water resistant (IP65 rated) </p></li>\n<li><p>Extended battery life (over 1 year of operation) </p></li>\n<li><p>Fully customized design </p></li>\n<li><p>Low-power electronics </p></li>\n<li><p>Wireless</p></li>\n</ul>',
      challenge:
        '<p>Our solution helps to mitigate air pollution by providing the cities with the insights of real- time pollution data.</p>',
      references: '<p>Smart cities, environmental Institutions.</p>',
      awards: '',
      technologies: [
        'Internet of Things',
        'Data Analytics',
    ...
    'bookingabus-bookingabuscom': {
      ...
      organisationWebsite: '',
      organisationEmail: 'mailto:info@bookingabus.com',
      linkedIn: 'https://www.linkedin.com/company/bookingabus-com/',
      twitter: 'https://twitter.com/Bookingabus',
      productWebsite: 'https://www.bookingabus.com',
      excerpt:
      ...
      yearOfValidation: 2017,
      description:
        '<p>Bus rental is one of the most non-transparent businesses. Bookingabus.com is here to change that. In our two years of operation, we have provided thousands of buses across Europe, offering all our References/Customers the best deals available to meet their individual needs. Ranging from groups and clubs to companies and the public sector, we strive to make your bus and coach hire as simple as possible. With us, you get the price of your trip instantly. The price always includes driver, VAT, and any potential tolls. Bookingabus.com provides an easy overview of the market including prices from all relevant bus operators.</p>',
      challenge: '',
      references:
        '<p>We have had the opportunity to provide transportation to thousands of References/Customers. Our References/Customers range from large corporations attending team events and conferences to small groups wanting to travel abroad or even take a day trip. No matter what event or the size of your group, we always aim to provide a safe and secure means of transportation.</p>',
      awards: '',
    ...
    'bosonit-elliotcloud': {
      ...
      organisationEmail: 'mailto:info@bosonit.com',
      linkedIn:
        'https://www.linkedin.com/company/bosonit/?originalSubdomain=es',
      twitter: 'https://twitter.com/Bosonit',
      productWebsite:
        'https://bosonit.com/en/elliot-cloud-diseno-application-platform-iot-branding/',
      excerpt:
      ...
      yearOfValidation: 2020,
      description:
        '<p>The solution is oriented to link all sorts of data origins in a range of sectors (agro-food, smart cities, industry, etc.) We provide a general firmware to connect sensors and applications to provide analytic services into a myriad of domains. Adding intelligence on top of industrial processes.</p>',
      challenge: '',
      references:
        '<p>CEFA, sabespe, standard profil, bodegas Franco Españolas, motorland Aragón</p>',
      awards: '',
    ...
    'breezetechnologies-breezeenvironmentalintelligencecloud': {
      ...
      productWebsite: 'http://www.breeze-technologies.de',
      excerpt:
    ...
    'breezetechnologies-environmentalintelligencesuite': {
      ...
      linkedIn: 'https://www.linkedin.com/company/breeze-technologies/',
      twitter: 'https://twitter.com/projectbreeze',
      productWebsite: 'https://www.breeze-technologies.de/solutions/',
      excerpt:
        "Breeze Technologies\\' Environmental Intelligence Suite consists of indoor and outdoor air quality sensors, and the Environmental Intelligence Cloud, a SaaS data analytics platform for large air quality datasets. It supports cities, businesses and NGOs to collect and analze air quality in real time.",
      yearOfValidation: 2015,
      description:
        '<p>Breeze Technologies helps cities and businesses create better clean air action plans and a more liveable environment based on the internet of things and artificial intelligence. The company provides lower-cost air quality sensors that measure all common air pollutants. Sensor data is calibrated in real-time by the Environmental Intelligence Cloud, greatly increasing accuracy and reliability of the solution.\nThe EI Cloud provides advanced analytics and intelligence tools to identify trends and manage targeted action. Smart algorithms suggest the most efficient and effective clean air actions based on a catalogue of more than 3,500 measures. The platform also connects cities to potential suppliers of those clean air actions, and tracks their effect and efficiency to create a fully-agile clean air action plan.\nCollected data can also be dissiminated to the public through a global air quality citizen platform, and citizens can be involved in measurement campaigns as sensor hosts.</p>',
      challenge:
        '<p>Air pollution is the single biggest environmental health threat of our time, killing 7 million people and costing the world economy 5 trillion USD per year. Data-driven decision making remains unfeasible as sensing equipment is expensive, stakeholders lack necessary knowledge to analyse the data and suitable interventions are unknown.\nThough they share both sources and solutions, climate change and air pollution are often treated as separate issues. Addressing them together could create immediate and substantive effects for the world’s most vulnerable by reducing climate change and delivering local health and development benefits.</p>',
      references:
        '<p>City of Vilnius\nCity of Neckarsulm\nCity of Moers\nCity of Hennef\nCity of Siegburg\n(non-exhaustive list)</p>',
      awards:
        '<p>Future Hamburg Award\nNordic Smart City Award\nSmavard Smart City Awards - Special Merits Award - Sensing and ICT\nGerman Startup Games Winner\nPorsche Mobility for a better world award\n(non-exhaustive list)</p>',
      technologies: [
        'Artificial Intelligence',
        'Big Data',
        'Data Analytics',
    ...
    'cardioid-cardiowheel': {
      ...
      organisationEmail: 'mailto:info@cardio-id.com',
      linkedIn: 'https://www.linkedin.com/company/cardioid-technologies/',
      twitter: 'https://twitter.com/CardioIDTech',
      productWebsite: 'https://www.cardio-id.com/automotive/',
      excerpt:
      ...
      yearOfValidation: 2018,
      description:
        '<p>CardioWheel is an Advanced Driver Assistance System that acquires the electrocardiogram (ECG) from the driver’s hands to continuously detect drowsiness, cardiac health problems, and biometric identity recognition.</p>\n<p>The cardiac signal is acquired in real-time from your hands. We do this using a custom steering wheel cover equipped with special conductive elements, thus capturing the electrical impulses generated by your heart. After acquisition, the cardiac signal is processed locally, making use of advanced signal processing and machine learning algorithms to extract information related to drowsiness and fatigue. An alert is immediately issued to the driver if fatigue has been detected.\nFor fleets of vehicles, we provide a dashboard aggregating geographically referenced fatigue information. This enables the fleet manager to take action and plan for fatigue-related driver performance.</p>\n<p>Lastly, CardioWheel can be extended with third-party systems, such as Mobileye and GeoTab, providing complete fleet management solutions for enhanced road safety.</p>',
      challenge:
        '<p>Safety on the road has always been of utmost concern to authorities and governments around the globe, where countless lives have been taken due to carelessness, negligence, or sheer bad luck. CardioWheel aims to make the roads feel much safer.</p>',
      references:
        "<p>CardioWheel market focus are primarily transportation and logistic companies. The largest passenger transportation company in Portugal - Barraqueiro Transportes is one of the major clients of CardioID, having several buses with CardioID's ADAS solution - CardioWheel + Mobileye + Geotab (only in some situations).</p>",
      awards: '',
      technologies: ['Internet of Things', 'Data Analytics'],
      domains: ['Health'],
      docs: [
    ...
    'carto-urbo': {
      ...
      organisationEmail: 'mailto:support@carto.com',
      linkedIn: 'https://www.linkedin.com/company/carto/',
      twitter: 'https://twitter.com/CARTO',
      productWebsite: 'https://carto.com/industries/cities-government/',
      excerpt:
      ...
      yearOfValidation: 2018,
      description:
        '<p>Urbo is a Smart Cities operational dashboard. It analyzes real-time data coming from sensors on parking, waste management, street lighting, water management, environmental data, city alerts, etc. It shows in real-time the values that  each sensor emits for the management and monitoring of the results, while enabling the generation of essential KPI reports. It includes Machine Learning for predictions. The aim of the project is to improve  efficiency, reduce energy costs and environmental impact.\nLastly, there are multiple possibilities for prediction and optimization, using a groundbreaking user experience:</p>\n<ul>\n<li><p>Relocate or create new facilities and resources for optimizing their indicators, like parking.</p></li>\n<li><p>Prevent through prediction unwanted events, like traffic jams. </p></li>\n<li><p>Optimize repetitive tasks, like a waste collection.</p></li>\n</ul>',
      challenge:
        '<p>City governments and managers need to monitor and predict in real-time the results of sensors scattered in cities, analyzing information and offering it to managers to facilitate the decision-making process.</p>\n<p>Set of applications that process data in real-time. The private portal displays all the information, it shows in real-time the values that each sensor emits for the management and monitoring of the results while enabling the generation of essential KPI reports.</p>',
      references: '<p>Telefónica, Indra, México City, Sorigué</p>',
      awards: '',
    ...
    'ciclogreenmovewin-ciclogreen': {
      ...
      organisationWebsite: '',
      organisationEmail: 'mailto:info@ciclogreen.com',
      linkedIn: 'https://www.linkedin.com/company/ciclogreen/',
      twitter: 'https://twitter.com/ciclogreen?lang=es',
      productWebsite: 'https://www.ciclogreen.com/?lan=en',
      excerpt:
      ...
      yearOfValidation: 2017,
      description:
        '<p>We provide an easy-to-use online reward system (web + app) to promote and analyze sustainable mobility practices in companies, universities, and city councils in any urban area of the world, helping our References/Customers to achieve the objectives of their sustainable mobility plans and get healthier and more productive employees, students and citizens.</p>\n<p>Employees register their urban trips on the platform using our tracking app and they stay  motivated thanks to gamification elements (ranking, points, Mobility Challenges). Consequently, Ciclogreen supports companies and city councils to achieve the objectives of their Sustainable Mobility Plan as well as creating a healthier workforce by increasing their productivity by 15% and reducing their absenteeism rate by 25% while reducing CO2 emissions. Furthermore, Ciclogreen analyzes accumulated mobility data to give mobility patterns insights to city councils so they can monitor cycling and pedestrians’ infrastructure use and design new ones.</p>',
      challenge:
        '<p>Air pollution kills 7 million people in the world every year. According to the European Commission, congestion in the EU costs annually around 1% of the EU’s GDP (around 100 billion EUR) (European Commission, 2015). Most of the negative external effects appear in the form of health loss of people exposed to transport emissions.</p>\n<p>Most employees drive to work, increasing air pollution and suffering from a sedentary lifestyle. Those passive commuters are less productive and show a higher absenteeism rate than employees who cycle to work. European companies lose 102 billion euros per year due to absenteeism (calculation based on the number from Eurofound).</p>\n<p>Companies are implementing sustainable mobility plans, but they are not able to increase the number of employees cycling and walking to work using only mobility surveys and communication campaigns. Some companies are implementing incentives to encourage their employees to be active commuters, but lack a tool to measure changes in employees’ mobility habits.</p>',
      references: '<p>Companies, universities and city councils</p>',
      awards: '',
      technologies: [
        'Big Data',
        'Gamification',
      ...
      featuredImage:
        'https://drive.google.com/file/d/1fApltCN-dYcF_cju4gW8BfudxQiNK47x/view',
      furtherImages: ''
    },
    'civity-snifferbike': {
      category: 'Powered by FIWARE',
      ...
      organisationEmail: 'mailto:info@civity.de',
      linkedIn:
        'https://www.linkedin.com/company/civity-b-v-/?originalSubdomain=nl',
      twitter: 'https://twitter.com/civitynl?lang=en',
      productWebsite:
        'https://civity.nl/en/data-management-platform-cip/cip-iot/sniffer-bike/',
      excerpt:
      ...
      yearOfValidation: 2019,
      description:
        '<p>Sniffer Bike is a mobile solution that is mounted to the bicycle steer. Every 10 seconds the GPS location and air quality is measured. With Sniffer Bike we measure:</p>\n<p>PM10: 0-500 μg/m3\nPM2.5: 0-500 μg/m3\nPM1.0: 0-500 μg/m3\nLocation: GPS\nIrregularities in the road\nTemperature: -40°C to 125°C\nHumidity: 0% tot 80%\nBarometric pressure: Pa\nTime\nVolatile Organic Compounds</p>\n<p>All data is sent through LTE-M to the Orion Contextbroker and Cygnus. All data is provided through CKAN as open data. Sniffer Bike collaborates with the Dutch National Institute for Public Health and the Environment (RIVM). All air quality data is also sent to the RIVM for validation and calibration of the data against the official measuring stations. It increases the value of the data. All data is visualized in a dashboard and available through the FIWARE NGSI API (based on the air quality data model).</p>',
      challenge:
        '<p>Bad air quality is a cause of many health-related problems. On the other hand cities and regions are heavily promoting cycling as a healthy transportation alternative. At this moment there is little insight into where people cycle and where the hot spots are for bad air quality during the day. Current measurements are based on models and cover a large area. Detailed insight (time, location) is missing. Data-driven policies to improve air quality and cycle routes are hard to implement.</p>',
      references:
        '<p>References/Customers and Partners:</p>\n<p>This project is developed in collaboration with the province of Utrecht and municipalities in the Utrecht region. Since then, other provinces and municipalities have also joined. Also local (cycling and sustainability) communities are participating. Non-profit organizations like the cyclist union and the RIVM are also partners.</p>',
      awards: '',
    ...
    'communithings-stopbuy': {
      ...
      organisationEmail: 'mailto:brussels@communithings.com',
      linkedIn:
        'https://www.linkedin.com/company/communithings-s.a./?originalSubdomain=fr',
      twitter: 'https://twitter.com/communithings',
      productWebsite: 'http://www.communithings.com/',
      excerpt:
      ...
      references:
        '<p>Live deployments in the cities of: - Belgium: Mons, Mechelen, Bree, - Netherlands: Utrecht, Leusden Other deployments on-going in several other cities are to be announced soon.</p>',
      awards: '',
      technologies: ['Internet of Things', 'Data Analytics'],
      domains: ['Cities'],
      docs: [],
    ...
    'connectrobotics-drone2me': {
      ...
      organisationEmail: 'mailto:contact@connect-robotics.com',
      linkedIn: 'https://www.linkedin.com/company/connect-robotics/',
      twitter: 'https://twitter.com/connectrobotics',
      productWebsite: 'http://connect-robotics.com',
      excerpt:
    ...
    'digitalilusion-outbarriers': {
      ...
      linkedIn: '',
      twitter: 'https://twitter.com/outbarriers',
      ...
      awards:
        '<ul>\n<li><p>3rd FIWARE Smart Society Challenge (Sevilla) 2014 - https://www.fiware.org/2014/10/18/fiware-challenges-awards</p></li>\n<li><p>Winners of Call for Apps (mobility) Smart City Expo World Congress 2015 - http://www.smartcityexpo.com/outbarriers</p></li>\n<li><p>Winners of Madrid Appetece 2017 - http://forodeempresaspormadrid.es/actividades/premios-madrid-appetece</p></li>\n</ul>',
    ...
    'dksr-openurbandataplatform': {
      ...
      organisationEmail: 'mailto:info@dksr.city',
      linkedIn: 'https://www.linkedin.com/company/dksr/?viewAsMember=true',
      twitter: '',
      productWebsite: 'https://www.dksr.city/en/the-data-platform/',
      excerpt:
      ...
      description:
        "<p>The Open Urban Data Platform (OUP) is the basic building block for the use of digital solutions to achieve sustainable and public welfare-oriented urban development. Via the OUP, urban data can be integrated, networked, and used to meet challenges in various areas of urban design.\nAn open platform approach such as DKSR's OUP has the enormous advantage that data sets from different systems can be easily added, harmonized, and linked: This way, data-based solutions that individual municipalities develop are easily and quickly scalable and transferable and can contribute to the efficient management of similar tasks in numerous municipalities beyond organizational and city boundaries.</p>",
      challenge: '',
      references:
        '<p>City of Cologne (Germany), City of Mainz (Germany), City of Mönchengladbach (Germany)</p>',
      awards: '',
    ...
    'egm-carpoolparking': {
      ...
      productWebsite: 'https://www.egm.io/en/the-smart-camera-for-carpooling',
      excerpt:
      ...
      description:
        '<p>SOLUTION </p>\n<p>The solution has been conceptualized to measure the impact and the use of car parks. The solution integrates artificial intelligence algorithms allowing the detection of cars and statistics (distribution of parking times, determination and counting of carpoolers, counting of "suction cars", etc.) The statistics are displayed via a customized dashboard.</p>\n<p>ROI\n *To know the occupancy rate of the car park *To know if the car park is used for carpooling *Estimate the CO2 emissions avoided thanks to the carpooling encouraged by this car park *Determine whether the car park is used for other purposes (in particular, to identify "suction cars")</p>',
      challenge:
        '<p>For cities or municipalities they want to know if their car parks are really used for carpooling.</p>',
      references:
        '<p>*Departmental council of the Pyrénées-Orientales https://www.ledepartement66.fr/</p>',
      awards: '',
      technologies: [
      ...
      domains: ['Automotive', 'Cities', 'Measurement', 'Mobility', 'Transport'],
      docs: [],
      videos: [],
      materials: [],
      logo:
      ...
      related: [
        ...
        },
        {
          category: 'FIWARE-Ready',
          featuredImage:
            'https://www.egm.io/wp-content/uploads/2020/08/egm-home-pic.png',
          excerpt:
        ...
        },
        {
          category: 'Services',
          featuredImage:
            'https://pbs.twimg.com/profile_banners/4419455500/1610366049/1500x500',
          excerpt:
    ...
    'egm-smartirrigation': {
      ...
      linkedIn: 'https://www.linkedin.com/company/easy-global-market/',
      twitter: 'https://twitter.com/egm_sophia',
      productWebsite: 'https://www.egm.io/en/smart-irrigation',
      excerpt:
        'EGM offers a complete solution for determining the amount of water that can be saved on a green space and deploying the control solution in addition to an existing watering system to achieve the water savings in question. Our solution saved 35% of the water on the first deployment.',
      yearOfValidation: 2021,
      description:
        '<p>ASSESSMENT\nWater consumption can be considerably reduced by dosing it according to the real water needs of the grass. It allows eliminating a recurrent tendency to over-water the ground.</p>\n<p>SOLUTIONS </p>\n<p>The solution includes: *humidity sensors set up on the ground *the interoperable context broker Stellio in order to contextualize data and propose an automatized watering schedule.\nROI\n *up to 30% of water consumption savings *operations associated with the maintenance (watering, mowing, use of fertilizers, mechanical operations) can be greatly simplified and reduced to the strict minimum thanks to an autonomous and remote control system of various equipment (mower, sprinklers) *obtaining a better quality ground allowing to reduce interventions on-site (fertilization, mechanical operations)</p>',
      challenge:
        '<p>The management of watering by municipalities is a subject where significant savings can be made quickly in terms of both finances and natural resources. Up to a 30% reduction in water consumption can be achieved.</p>',
      references: '<p>Ville de Saint-Quentin https://www.saint-quentin.fr/</p>',
      awards: '',
      technologies: ['Internet of Things', 'Sensory Systems'],
      domains: ['Agriculture', 'Cities', 'Measurement', 'Water', 'Weather'],
      docs: [],
      videos: [],
      materials: [
        [
    ...
    'elmitel-evineyard': {
      ...
      yearOfValidation: 2017,
      description:
        '<p>eVineyard matches the latest technology and science with the real needs of the winegrowers to help you grow grapes in the best way possible.</p>',
      challenge:
        '<p>Winegrowing as an industry is changing. More emphasis on quality, environmental friendliness, and playing well with regulations are nowadays mandatory for success.</p>',
      references: '',
      awards: '<p>FINODEX finalist SAP HCP Challenge 2016 Winner</p>',
      technologies: [
        'Data Analytics',
        'Data Spaces',
        'Digital Twins',
    ...
    'engineering-digitalenabler': {
      ...
      yearOfValidation: 2018,
      description:
        '<p>Digital Enabler TM looks for potential unknown data sources available on the web, real-time data coming from IoT devices, open data portals, legacy systems, data not processable, and makes all these information systems speak with one another, evaluating the quality of metadata and avoiding duplication. All the data sources are transformed into meaningful information accessible through the user interface and standard APIs.\nThanks to graphical and map-based innovative tools, decision-makers and developers can design data correlations, to design and create reusable interactive dashboards analyzing and visualizing data at the right-time. Digital Enabler harmonizes real-time information to adjust, for instance, public transport supply.\nDashboards/apps can be organized in domains like environment, mobility, or manufacturing and be used by businesses and developers to create new reusable services and apps that can be portable and replicable in different contexts. Digital Enabler makes free from any lock-in and embeds the following main functionalities:\nAutomatic Discovery of data sources\nData info collection and quality assessment: Detection of data sources from the web and support in the creation of the “Single Point of Knowledge (SPOK)”\nData Integration and Harmonization: Possibility to graphically integrate data coming from different data sources and wrap any kind of data structure in NGSI LD FIWARE Data Models\nAutomatic deduction of new information based on a repository of machine learning models and algorithms that can be composed through a specific tool for data scientists.\nAnalyze and render data through user-friendly dashboards and mobile apps: Assisted creation of apps and dashboards relying on data present in the SPOK, that are reusable among different customers.\nFull compliance with the EU GDPR covering both consents and personal data management\nDigital Enabler is fully compliant with OASC (Open &amp; Agile Smart Cities) principles, in particular:</p>\n<p>Open to other platforms through standard APIs (Application Program Interface)\nPortable and replicable, ensuring independence for vendors and full access to the local digital ecosystem\nIt covers all the three compliance levels with the Minimal Interoperability Mechanisms (MIMs)</p>\n<p>For more information, please contact: Lanfranco Marasso (lanfranco.marasso@eng.it) and Giovanni Aiello (giovanni.aiello@eng.it)</p>',
      challenge:
        '<p>Data providers are used to applying heterogeneous technical solutions. Information systems are closed within different siloes and therefore it is extremely hard to get access to available knowledge, actually scattered, and not valuable. Moreover, Decision makers, Businesses and Citizens often are not aware of available urban data and their quality, and are victims of several lock-ins (e.g. vendors and technology).</p>',
      references:
        '<p>Citizens, public administrations, data providers and companies jointly collaborate to consume and produce urban data, and to co-create urban services</p>',
      awards: '',
      technologies: ['Data Analytics', 'Open Data', 'Cloud Computing'],
      domains: ['Cities'],
      docs: [],
      ...
      related: [
        ...
        },
        {
          category: 'FIWARE-Ready',
          featuredImage:
            'https://www.knowage-suite.com/site/wp-content/uploads/2021/09/knowage-overview.jpg',
          excerpt:
    ...
    'engineeringdss-curavesta': {
      ...
      linkedIn: 'https://www.linkedin.com/company/engineeringits/',
      twitter:
        'https://twitter.com/engineering_its?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor',
      productWebsite: 'https://smart-solution.eng-its.de/curavesta/',
      excerpt:
        'CuraVesta© is an assistance system, which was developed by ENGINEERING for home care. As a Health solution, it supports people who care for and nurse their relatives at home.',
      yearOfValidation: 2020,
      description:
        '<p>CuraVesta© takes on this problem. This application software for mobile devices such as smartphones assists in the phase of preparation as well as in the phase of daily care. It is designed to provide effective and lasting support to people who care for their relatives and enable them to live independently and safely at home.</p>\n<p>The innovative mHealth service is available to the person providing care as well as the person in need of care, anytime, and anywhere. The system consists of three main components that support home care:</p>\n<p>Nursing Guide - The nursing app shall facilitate the accomplishment of daily tasks and reduce the mental pressure of nurturing persons. Directly at the place of nurturing, the app shall also impart knowledge on how to professionally execute typical tasks and which resources are available.\nExchange platform - The nursing app shall link the nursing persons with other relatives and suppliers such as doctors, nursing services, or centralized consultation services / telemed. providers.\nPurchasing avatar - The nursing app shall support the nursing persons to purchase medicine, resources, meals, and so on. The nursing app supervises the stock and encourages the nursing persons to re-order in time, e.g., before public holidays. Within these components, the App provides a variety of functions to support the carer and the person in daily needs . The main functions include:</p>\n<p>Module daily routine with assisting documentation and control of the nursing progress.\nElectronic patient file with export function and link to family and GP.\nAccelerated application and order processes as well as time management with cost objects and care providers (supplier independent).\nSupplier independent integration of digital medical products and AAL.\nMultimedia transfer of nursing know-how.\nThe advice of experienced nursing personnel and doctors using the patient file via video communication (support center).\nThe assisting system will be provided in a restricted basic version and – if user acceptance is proved - it will be further developed in at least three stages.</p>',
      challenge:
        '<p>In Germany, at least 1.9 million people are cared for at home by 4.5 million relatives. In more than two-thirds of these cases, no outpatient care service is involved! Caring for a person at home means a physically and mentally challenging task and a huge responsibility for the relatives. The users primarily care for relatives such as children, spouses, or other relatives. Therefore, it is an important goal to reduce the risk of stress reactions of care-giving persons due to overwork and social isolation. In this context, important questions often arise that require reliable answers. The whole daily routine also changes and requires a structured and efficient organization. Existing health care services and necessary information about home care are distributed heterogeneously on the internet or offline and have to be collected and managed by carers through time-consuming research when needed.</p>',
      references:
        '<p>Health insurance companies Care Services Healthcare Pharmaceutical industry</p>',
      awards: '',
      technologies: ['Internet of Things', 'Data Analytics'],
    ...
    'everimpact-everimpact': {
      ...
      organisationEmail: 'mailto:info@everimpact.com',
      linkedIn: 'https://www.linkedin.com/company/everimpact/',
      twitter: 'https://twitter.com/everimpact_com?lang=en',
      productWebsite: 'https://www.everimpact.com/',
      excerpt:
      ...
      yearOfValidation: 2017,
      description:
        '<p>Everimpact measures and monetizes Cities’ CO2 emission by combining satellites and ground sensors’ data. Cities get a real-time map of their emissions at street and building levels, at a precision never reached before. This is helpful for Cities to see whether their climate actions are working, and help them target key areas of interventions.\nMonitoring, reporting and verifying emissions as part of their climate plan, means that Cities can now monetize their CO2 reductions with various green finance instruments.\nIn a nutshell, Everimpact is an innovative concept because it helps Cities draw important revenues from monitoring their CO2 emissions.</p>',
    ...
    'farmdogtechnologies-farmdog': {
      ...
      organisationEmail: 'mailto:HELLO@FARMDOG.AG',
      linkedIn: 'https://www.linkedin.com/company/farm-dog/',
      twitter: 'https://twitter.com/farmdogag',
      productWebsite: 'https://farmdog.ag',
      excerpt:
      ...
      yearOfValidation: 2017,
      description:
        '<p>Farm Dog’s precision agriculture solution for pest and disease management provides the industry with the tools necessary to optimize pest and disease treatments, increase yields, and promote environmental sustainability. Utilizing a mobile-cloud analytics platform (think a combination of agronomist with crowd-sourced Waze with WebMD), Farm Dog’s technology ensures that fields get the right treatment, at the right amount, at the right time, and at the right location.With Farm Dog, growers transition from a completely offline decision-making process to a digital one. Utilizing Farm Dog’s easy-to-use interface, growers, while walking in their fields, submit field observations such as pest or disease observed in the field, its severity level, geo-markers on where the observation was made, and photographs. This digitization, compared to today’s pen-and-paper process, provides significant time savings from day 1. More importantly, digitization of in-field observations creates opportunities for analytics such as historical and field-by-field comparisons, crowd-sourced regional alerts, and treatment efficacy analysis, which Farm Dog provides.</p>',
      challenge:
        '<p>By 2050, farmers need to grow 70% more to feed our growing population. Making that challenge harder are the social and regulatory pressures to accomplish that goal while reducing environmental impact. To support agricultural production today, farmers spend $60 billion annually on pesticides. Despite this expense, growers still suffer 20% to 40% crop loss due to pest and disease, equivalent to $500 billion of lost yields, and adversely affect the environment. The industry is far from meeting its 2050 challenge.</p>',
      references:
        '<p>Farm Dog protects hundreds of thousands of hectares around the world and is working together with the largest of agricultural organizations, including governments and publicly-exchange companies.</p>',
      awards: '',
      technologies: ['Internet of Things', 'Data Analytics'],
      domains: ['AgriFood'],
      docs: [],
      ...
      featuredImage:
        'https://farmdog.ag/wp-content/uploads/2021/11/unsplash_yJDZTDeHeG8.png',
      furtherImages: ''
    },
    'fashioncloud-fashioncloud': {
      ...
      organisationEmail: 'mailto:info@fashion.cloud',
      linkedIn: 'https://www.linkedin.com/company/fashioncloud/',
      twitter: 'https://twitter.com/fashioncloud_?lang=en',
      productWebsite: 'https://fashion.cloud',
      excerpt:
        'FASHION CLOUD is the leading content exchange platform in the fashion industry.',
      yearOfValidation: 2017,
      description:
        '<p>FASHION CLOUD is Europe’s leading content exchange platform for the fashion industry. More than 250 brands share marketing material and product data on our platform. We have 2,500 wholesalers from more than 45 countries using our service to get easy access to high-quality image content from their suppliers. Brands such as GANT, Betty Barclay, Marc O’Polo, and Scotch &amp; Soda use FASHION CLOUD to distribute pictures to retailers like Engelhorn, Appelrath, and Kaufhof. All content can be accessed through an online platform (where images are downloaded manually) or via our API. Connecting ERP systems or webshops to our API allows all content to automatically flow into the retailer IT system without any manual effort. With FASHION CLOUD brands unify their brand presence and connect to potential new business partners. Retailers gain access to valuable content to run their marketing channels. Our database contains millions of product pictures. Our backend handles millions of API calls. Serving as a “content broker” for the fashion industry is basically our main task to be excellent at keeping tons of data. We decided to rely on FIWARE technology when it comes to analyzing what exactly happens with it.</p>',
      challenge:
        '<p>Many local fashion retailers are facing hard times competing against pure e-commerce players (Amazon, Zalando etc.) and vertical fashion companies (Zara, H&amp;M etc.). They are especially struggling when it comes to online visibility. For todays’ References/Customers, it is crucial to find stores and products online. It is still not the core competence of brick and mortar stores to run a website or even a webshop. Furthermore, it is very cumbersome for a retailer to collect and create content for digital marketing channels. Product photos, article descriptions and campaign shootings are required for hundreds of fashion brands. But where and how to  find them?</p>',
      references: '',
      awards: '<p>Best Startup @ SpeedUPEurope! Acceleration</p>',
      technologies: ['Data Analytics'],
      domains: ['Retail'],
      docs: [],
      videos: [],
      ...
      featuredImage:
        'https://fashion.cloud/wp-content/uploads/2020/01/Mobil-DE-min-1-800x816.png',
      furtherImages: ''
    },
    'faubourgnumérique-ouranosws': {
      ...
      linkedIn: '',
      twitter: '',
      productWebsite: 'https://ouranos-ws.com/en/',
      excerpt:
      ...
      yearOfValidation: 2022,
      description:
        '<p>ouranos-ws is an easy-to-use solution to enable the NGSI-LD super-powers, with the strategic goal to manage your virtualized assets as digital twins. This platform has been developed and used for many years by our FIWARE iHub Faubourg Numérique with mainly 3 groups of features that can be used through incremental management cycles: </p>\n<ul>\n<li>DESIGN your specific data models, possibly by reusing the existing ones, especially the ones from the Smart Data Models initiative </li>\n<li>NAVIGATE through your graphs of entities and relationships and to create and update the related objects </li>\n<li>CONTROL the interactions with the other systems, including the security layers, the subscription and registration mechanisms</li>\n</ul>',
      challenge:
        "<p>Whatever is your level of maturity about NGSI-LD usage it can be hard to deal with it only through APIs: - if you don't know about NGSI-LD but are eager to experiment and build your first use cases - or if you are managing complex NGSI-LD environments involving a wide variety of stakeholders ouranos-ws offers you an intuitive user interface to manage your NGSI-LD graphs of entities and relationships. It allows you and your team to better organize the data models and to continuously improve the smart solutions you build upon the NGSI-LD API</p>",
      references: '',
      awards: '',
      technologies: [
        'Data Spaces',
      ...
      related: [
        {
          category: 'Services',
          featuredImage:
            'https://pbs.twimg.com/profile_banners/4830648545/1542979261/1500x500',
          excerpt:
    ...
    'fiwoo-fiwoo': {
      ...
      organisationEmail: 'mailto:info@fiwoo.eu',
      linkedIn: 'https://www.linkedin.com/company/fiwoo/?originalSubdomain=in',
      twitter: 'https://twitter.com/fiwoo_platform',
      productWebsite: 'https://www.fiwoo.eu/en/',
      excerpt:
    ...
    'floud-floud': {
      ...
      organisationEmail: 'mailto:info@floud.eu',
      linkedIn: '',
      twitter: '',
      productWebsite: 'https://www.floud.eu/',
      excerpt:
      ...
      yearOfValidation: 2018,
      description:
        '<p>Based on sensors equipped with advanced video analysis software, FLOUD is the answer to our smart cities’ need for minimally invasive systems to improve transport management. The first key market application of the FLOUD system is flow-data provision for urban planning and operation. This refers to public authorities, particularly small and medium-sized cities, who require data for their transport/mobility management measures. It also refers to professionals (e.g. consultants, developers) that require data for their work and to companies investing in smart city products.</p>',
      challenge:
        '<p>The recent push towards Intelligent Transport Systems (ITS) within modern-day smart cities requires a large amount of high-quality data in real-time. These include traffic, bicycles, and people flow. The latter two are of particular importance to promote eco-friendly mobility plans and support the shift towards sustainable behaviors. However, there is a significant industrial and economic problem related to traffic monitoring. While high-tech monitoring technologies, based on inductive loops, cameras, ultrasound, radio waves, to cite but a few, have existed for some time, public and private organizations continue to rely largely on manual counts or other limited forms of data collection.</p>',
      references:
        '<p>Municipality of Prato (Public body - Italy)\nMunicipality of Funchal (Public body - Portugal)\nCATC SE (Company - sweden)\nHarris County Precinct Two (Public body - US)\nplus several other companies around the world.</p>',
      awards:
        "<p>FIWARE success story: https://twitter.com/fiware/status/725942769642930176\nPhilips Smart City Challenge - 2018 (https://www.agorize.com/en/challenges/philips-challenge)\nEuropa a misura d'impresa - 2017 (https://goo.gl/VDTwpc)</p>",
      technologies: ['Internet of Things', 'Data Analytics'],
    ...
    'freesense-freesense': {
      ...
      organisationEmail: 'mailto:nj@freesense.dk',
      linkedIn: 'https://www.linkedin.com/company/freesense/',
      twitter: '',
      productWebsite: 'http://www.freesense.dk/',
      excerpt:
    ...
    'fueloyal-fueloyal': {
      ...
      organisationEmail: 'mailto:info@fueloyal.com',
      linkedIn: 'https://www.linkedin.com/company/fueloyal/',
      twitter: 'https://twitter.com/fueloyal',
      productWebsite: 'https://www.fueloyal.com',
      excerpt:
      ...
      yearOfValidation: 2018,
      description:
        '<p>Fueloyal developed three unique and proprietary IoT sensors:</p>\n<ul>\n<li><p>Smart Fuel Cap: unique and patented IoT device reducing fuel theft and optimizing fuel purchases. </p></li>\n<li><p>Vehicle Sensor: device to be installed in the vehicle for the purpose of collecting data from driving behavior, location, temperature, fuel purchases, engine data, and maintenance schedule.</p></li>\n<li><p>Asset sensor: device to be installed on any asset for the purpose of collecting data from driving environment, location, temperature.</p></li>\n</ul>\n<p>All these devices are installed in the vehicles for the purpose of collecting 1000 data points a day. The collected data is mined, synthesized, and converted into actionable insights for the purpose of improving driving behavior and safety, reducing fuel consumption and optimizing fuel purchases, proactively performing predictive maintenance with derived reduction of costs and vehicle downtime.</p>\n<p>All devices can be installed either by hardwire or plug &amp; play via OBD Port or any other diagnostic port which makes them very easy to install and use without creating huge downtime or expensive installation cost.</p>\n<p>We at Fueloyal are proud to announce that on top of all the already existing advantages we have recently partnered with T-Mobile and Hellenic Oil &amp; Gas to provide our References/Customers (in the area of Macedonia) with unique deals for buying cheaper fuel at gas stations. Fueloyal is also exploring similar partnerships in countries where fleets using its solutions operate.</p>\n<p>This way, in addition to optimizing usage and reducing the vehicle and driver tear and wear based on the analysis of context data gathered from sensors, we are also adding one extra layer of savings by providing  discounts on gas stations without changing the user experience. This will allow them to use our solution at a fraction of the cost and in some cases, the customer can even make money by using Fueloyal.</p>',
      challenge:
        '<p>Companies operating fleets of vehicles are losing up to 30%* of all money due to poor driving behaviour and inadequate fleet management. These  inefficiencies are preventing the transportation and logistics cost to be reduced to the needed level, which in  the end hurts all the consumers in the way of overpaying consumer retail products due to inefficient transportation.</p>\n<p>Fuel is the biggest expense any trucking or company operating fleet of vehicles has - up to 35% of all revenue goes on fuel and for that reason, fuel management is the most important and ranked in  the 1st place among most wanted features among fleet managers. (Source: Continental Mobility Study 2016, The Connected Truck)</p>\n<p>All the losses are directly transferred to consumers which are hurt in a way of over-paying retail products. For example, up to 20% of the retail price of a bottle of water may correspond to transportation costs. As a consequence, all consumers are paying for more expensive products due to poor fleet management.\nCompany procedures, inadequate fuel and vehicle management combined with poor driver behaviour are the three main factors behind all those losses.</p>\n<p>Regarding company procedures - Introduced by owners or directors and aligned with fleet managers, very few companies gather and monitor data to better understand areas in which to optimize and save money.</p>\n<p>On the other hand, regarding fuel and vehicle management, drivers as  decision makers are lacking data on where to buy the cheapest fuel on the road. Instead of making the most cost-effective decision, they are deciding on where to buy fuel based on their personal pReference Material (where they like restaurants, toilets, coffee quality) which makes companies lose up to 300 EUR month/vehicle.</p>\n<p>Last but not least,  poor driving behaviours (e.g., unsafe and too aggressive driving) are increasing the wear and tear of the vehicles and equipment, generating multi-billion EUR losses a year.</p>',
      references: '',
      awards: '',
      technologies: ['Internet of Things', 'Data Analytics'],
    ...
    'futureintelligence-quhoma': {
      ...
      organisationEmail: 'mailto:finishman@f-in.gr',
      linkedIn: 'https://www.linkedin.com/company/future-intelligence-ltd/',
      twitter: 'https://mobile.twitter.com/futureintellig4',
      productWebsite: 'http://quhoma.com/',
      excerpt:
      ...
      yearOfValidation: 2017,
      description:
        '<p>QUHOMA is an innovative application of Smart Farming targeting quality farmers (BIO, GLOBAL GAP) as well as conventional farmers, too. Through QUHOMA not only does the end-user/farmer collect sensor data from the field but he can also share them with a community of users that whom these data make business sense to share with. Moreover, QUHOMA invites additional business entities to provide their content (agronomic services, business advices, quality inspection forms and procedures, administrative consultants) and also share these within QUHOMA common MARKET tool where everyone consumes and provides services. It is a win-win solution  for both producers, other established businesses in the agrifood value chain, and the final consumers all wishing to enjoy traceable quality products.</p>',
      challenge:
        "<p>QUHOMA was created to unveil the competitive advantage of farmers and industries committed to outstanding quality in end-products and farming procedures. At the same time, Future Intelligence's solution paves the way for rationalizing the required farm inputs thus maximizing profit margins.</p>",
      references: '',
      awards: '',
      technologies: [
        'Artificial Intelligence',
    ...
    'greenapes-greenapes': {
      ...
      organisationEmail: 'mailto:info@greenapes.com',
      linkedIn: 'https://www.linkedin.com/company/greenapes/',
      twitter: 'https://twitter.com/GreenApesJungle',
      productWebsite: 'https://www.greenapes.com/en/',
      excerpt:
      ...
      yearOfValidation: 2017,
      description:
        '<p>greenApes is a certified Benefit Corporation, founded with the mission of promoting sustainable lifestyles via digital solutions. A fun and inspiring solution for your lifestyle, for your company, and your city. greenApes can be integrated with third-party apps to reward your eco-friendly behaviors: from biking to car-sharing, from choosing renewable energy to recycling and purchasing sustainable products. On greenApes you will get to share your ideas and actions with others, and earn rewards for doing so. As you share your sustainable actions and ideas you will earn BankoNuts. You can use your BankoNuts to claim real life rewards offered by our partners, venues, and companies who care about the planet. Join a jungle populated with inspiring stories, a great community and earn real life rewards for your positive impact!</p>',
      challenge:
        '<p>Promoting sustainable lifestyles is one of the greatest challenges of our times. greenApes is here to help you, whether you’re a citizen, a public institution, a local NGO, or any other agent of change. By joining greenApes you’ll get access to many inspiring stories on sustainability and ecological living and earn real rewards for your positive impact.</p>',
      references: '',
      awards: '',
      ...
      featuredImage:
        'https://scontent-frx5-2.xx.fbcdn.net/v/t1.18169-9/734851_141741799313926_2094598020_n.jpg?_nc_cat=103&ccb=1-7&_nc_sid=19026a&_nc_ohc=NAu859zKo54AX_-S7iy&_nc_ht=scontent-frx5-2.xx&oh=00_AT-PZaNhY_EuYNsSyvJL4VbJ_y6SmwzsW3HreUXwfhE-Mw&oe=63058D31',
      furtherImages: ''
    },
    'gymcraft-gymcraft': {
      category: 'Powered by FIWARE',
      ...
      linkedIn: 'https://www.linkedin.com/company/gymcraft/about/',
      twitter: 'https://twitter.com/GymCraftVR',
      productWebsite: 'http://www.gymcraft.es',
      excerpt:
      ...
      featuredImage: 'https://gymcraft.es/wp-content/uploads/2019/03/sp3.png',
      furtherImages: ''
    },
    'hearingsoftware-sendacare': {
      ...
      linkedIn: 'https://www.linkedin.com/company/10234663/',
      twitter: 'https://twitter.com/Senda_byHS',
      productWebsite: 'https://byhs.eu/senda/',
      excerpt:
      ...
      yearOfValidation: 2018,
      description:
        '<p>Senda Care is a mobile app. We have developed a modular platform that has the following features:</p>\n<ul>\n<li>Care: This section is focused on the personalized care of elderly or disabled people.. Using a collaborative platform, we connect elderly or persons with disabilities with certified caregivers. Our users can look for a caregiver on an hourly-basis, for a weekend, or for weeks, while it gives relatives a chance to take some time off..</li>\n</ul>\n<p>Another feature is that families with economical difficulties every month can apply to share the home with the elderly. This is suitable for families who have lost their homes. In fact, this model already exists in some Universities, where young people can share their home with the elderly, in exchange for doing the shopping, making dinner, and taking care of other minor things. We are introducing this model to families at risk of social exclusion, and to match them with other areas of the population that are also isolated and at  risk of social exclusion. This way, it’s a win-win..</p>\n<ul>\n<li><p>Geolocalization: The relative or caregiver can track the last 12 hours of a person and check his or her last positions. This works in case of disorientation or if someone is lost. The elderly person just needs a GPS device.</p></li>\n<li><p>Communication: It is possible to call directly to the GPS device, or to make video calls using a tablet and a phone, with an easy and intuitive app for the elderly with big icons of every relative. Just click to call directly.</p></li>\n<li><p>Security: If the person needs help, the GPS device can send an alert to their relatives or caregivers, and automatically perform a voice call with  them. At this moment, the device also updates the position.</p></li>\n<li><p>Digital Home: The References/Customers can choose a variety of sensors and actuators in order to cover their needs. This gives more security and peace of mind. Some of these sensors are adapted for hearing impaired people (notification of bell doors, fire or gas leak alarms, etc), and also sensors and actuators for other collectives, digital lock, remote door opening, open/close windows, and others.</p></li>\n</ul>\n<p>The digital lock is a key advantage in our system, because in case of an emergency (for example, if the elderly falls down and lies unconscious on the ground), if he or she has the GPS device, it will detect the fall, notify the family and relatives, or caregivers, who can then open the door remotely for the emergency services once they arrive at the home. Without digital locks, they would need to wait for police or firefighters to open the door, or wait for someone with the physical keys. This saves a valuable time.</p>',
      challenge: '',
      references:
        '<p>Our stakeholders are:</p>\n<ul>\n<li><p>Elderly or Dependent Persons: Those who will receive the care and improve their quality of life.</p></li>\n<li><p>Relatives: It can be to be more connected to his/her loved ones, or to stay informed of the emergencies. Examples include an SOS alert, opening the digital lock remotely, or just to look for a caregiver for the weekend so they can take some time off.</p></li>\n<li><p>Caregivers: They are certified people that will charge for the services, for hours, weekend, or weeks, whatever the relatives and caregivers agree on.</p></li>\n<li><p>Social Caregivers: In case of house sharing with families, we want to add social caregivers from the council in order to defend and guarantee the rights of the elderl</p></li>\n</ul>',
      awards: '',
      technologies: ['Gamification', 'Internet of Things'],
      domains: ['Home', 'Health'],
      docs: [],
      ...
      featuredImage:
        'https://pbs.twimg.com/media/DPFqiy_WAAAb-_W?format=jpg&name=900x900',
      furtherImages: '',
      related: [
        {
          category: 'Services',
          featuredImage:
            'https://scontent-frt3-1.xx.fbcdn.net/v/t31.18172-8/12719417_1118777238164687_4966661782678389763_o.jpg?_nc_cat=107&ccb=1-7&_nc_sid=e3f864&_nc_ohc=qycqrabP1vQAX9yc6BJ&tn=8vjiMBCSITGGfB_z&_nc_ht=scontent-frt3-1.xx&oh=00_AT-Qwtm9r6f2R8sXbVxFowh9miRedBjnd6y4piglULTvBg&oe=63086C7F',
          excerpt:
    ...
    'helix-helix': {
      ...
      organisationEmail: 'mailto:fabio.cabrini@gethelix.org',
      linkedIn: 'https://www.linkedin.com/company/helixtecnologia/',
      twitter: '',
      productWebsite: 'https://gethelix.org',
      excerpt: 'A microservice platform based on FIWARE',
      yearOfValidation: 2021,
      description:
        "<p>The Helix Platform is an enabler system for managing  Smart Environments in a simple and agile way, whether you are in the cloud or on-premise.\nAn integrated platform that allows the monitoring of Smart Environments, the Helix platform was designed to serve not only large but also SMEs customers, allowing deployment in the most various infrastructures economically and flexibly. . In addition to the use of Generic Enables powered by FIWARE, the platform also provides an integration panel that allows an easy system setup, as well as monitoring the infrastructure where the platform is installed, facilitating the prediction and control of the system's scalability.</p>\n<p>Why Helix?</p>\n<p>By using ICT technologies, a Smart Environment can improve the services provided, whether these are public or private entities, and also experience the optimization of its production and operation costs. In this way, the Helix solution allows obtaining and integrating data from different sources, enabling the generation of reports and the triggering of alarms from the data obtained.</p>\n<p>Helix IoT</p>\n<p>And why not go for a fully integrated solution within the Helix ecosystem. The Helix IoT tracking cards allow data collection from various machines, equipment, or urban structures. As part of an ecosystem designed to be integrated, the boards have an easy setup within the Helix platform and following FIWARE communication standards is also compatible with other certified platforms</p>",
      challenge:
        "<p>We work as part of the FIWARE Lab São Paulo group, and through the years we feel the necessity of an easy deployment of FIWARE that could help startups and developers to  prove their concepts. FIWARE’s current modules ask the user to spend much time reading the documentation to make a module work and even more time to get different modules to work together.\nIntegration\nSince the development of a simple, friendly, and customizable User Interface to an IoT device, the entire Helix ecosystem was designed to have a simple integration. Allowing customers to spend their time on their business activities. The courses and workshops held by the Helix team also aim to facilitate the client's daily life and give their IT teams more freedom to think, develop and propose new solutions in partnership with Helix.</p>",
      references:
        '<p>Konitech, Anauger, Forum Brasileiro de Internet das Coisas, ABINC</p>',
      awards: '',
      technologies: ['Internet of Things'],
      domains: [
        'Cities',
      ...
      featuredImage:
        'https://opengraph.githubassets.com/3fd1b50beb78a3dd8424245ce559634b6f5654c8ab6a828cca5927329ccff03f/helix-iot/helix-sandbox',
      furtherImages: ''
    },
    'hopu-lowemissionzones': {
      ...
      productWebsite: 'https://atmosphere.hopu.eu/',
      excerpt:
      ...
      domains: ['Air Quality', 'Mobility', 'Sustainability'],
      docs: [],
      videos: [],
      materials: [],
      logo:
      ...
      featuredImage:
        'https://pbs.twimg.com/profile_banners/2572537560/1647898056/1500x500',
      furtherImages: '',
      related: [
        {
          category: 'FIWARE-Ready',
    ...
    'hostabee-bkeep': {
      ...
      organisationEmail: '',
      linkedIn: 'https://www.linkedin.com/company/hostabee/',
      twitter: 'https://twitter.com/hostabee',
      productWebsite: 'https://hostabee.com/en/eng-homepage/',
      excerpt:
    ...
    'jig-smartappcity': {
      ...
      references:
        '<p>The SmartAppCity project covers the three pillars supporting a smart city: public administration, citizens and local business:\nThe local administration knows the impressions of citizens and the impact of their decisions by  analyzing the provided social information , and by opening a new communication channel.\nThe city shops and businesses use this technology as a geo-marketing tool to open a specific communication channel with References/Customers or prospective References/Customers.\nThe citizens  use a channel to provide updated information about life in the city sharing information about their culture, habits or infrastructures and road conditions.</p>',
      awards:
        '<p>Seal of Excellence by the European Commission for its successful in a highly competitive evaluation process as an innovative project.\nMost innovative App and Greatest Potential Application, at the world biggest app competition at the FIWARE Smart Cities Challenge in Brazil (among 423 apps for Smart Cities from 23 countries).\nCities Summit London 2014: LLGA Awards finalist: "Using technology to enhance commerce" category.\nBerlin’s EIT ICT Lab Challenge winners.\nBest App of the year at La Rioja Internet Awards 2013.\nSelected among the best TOP 10 projects at European Accelerator FINODEX 2015-2016 (among 297 proposals).\nFinalists at the Global City Teams Challenge 2016 in Austin (Texas, USA).\nFinalists at the Spanish Creative Cup 2016 in Malaga (Spain).\nWinners of the Madrid Smart Lab Program for the challenge: “Improving information access and quality of life for citizens”.\nBest App at the Smart Cities Awards 2015 by the Spanish Socinfo Foundation.\nSelected by the Spanish Institute for Foreign Trade as one of the 4 successful cases of PPP at the Smart City Expo World Congress 2013 (the only App selected) for their potential to Latin American markets.\n“Benidorm Smart City” awards finalist, inside the XVII International Forum: Strategies for Smart Destinations.\nFP7 Future Internet PPP partner inside the FIWARE consortium.\nIberoeka trilateral collaboration (Mexico-Spain-France) inside the Culturemobile consortium.\nSelected for the Open Innovation Marketplace 2013, 2014 and 2015 inside the Smart City Expo World Congress.\nCitizen Innovation App Awards finalist in Mar del Plata (Argentina).\nSmart City App Hack SCAH-FIWARE Competition 2015 finalists (just 18 apps worldwide were selected).\nSelected for the Cambridge Gateway Program 2015.\nSelected as a Best Practice by the RAMUD (Réseau d’action en matière de mobilité urbaine durable) Mediterranean Initiative inside the IEVP (Instrument Européen de Voisinage).</p>',
      technologies: ['Internet of Things', 'Data Analytics'],
      domains: ['Cities'],
      docs: [
        [
      ...
      featuredImage: 'https://pbs.twimg.com/media/EJcfLaEWsAcCr9j.jpg',
      furtherImages: ''
    },
    'lahakx-skyxpass': {
      category: 'Powered by FIWARE',
      ...
      organisationEmail: '',
      linkedIn: 'https://www.linkedin.com/company/lahakx/',
      twitter: 'https://twitter.com/lahakx',
      productWebsite: 'https://www.lahakx.com/',
      excerpt:
    ...
    'limmatgroup-imas': {
      ...
      organisationEmail: 'mailto:info@limmat-group.com',
      linkedIn: 'https://www.linkedin.com/company/limmat-group/',
      twitter: 'https://twitter.com/Limmat_Group',
      productWebsite: 'https://limmat-group.com/en_us/soluciones/#id_imas',
      excerpt:
      ...
      yearOfValidation: 2019,
      description:
        '<p>The IMAS+® is a FLEXIBLE maintenance platform that can be used for different infrastructures due to it being MODULAR and SCALABLE. The IMAS+® is based on 4.0 technology that combines the use of the Internet of Things, big data analysis, and machine learning to provide predictive maintenance applications to our References/Customers to reduce the maintenance cost between a 10 and 20% increase in  safety and improve the availability. IMAS+® has different modules of specialization according to the different technical areas and systems that we can find in an infrastructure or railway vehicle and different levels of functionalities in order to cover our clients’ needs and integrate the platform with the existing systems.</p>\n<p>LEVEL 1 – DIGITALIZATION: \nThis level on the platform digitizes all the maintenance activities and gives  the users access to the information that need to facilitate their work with a simple and intuitive multiplatform solution. Some of the functionalities are: </p>\n<ul>\n<li>GMAO </li>\n<li>Warehouse control </li>\n<li>Control of documentation </li>\n<li>Visualization of the CTC/SCADA </li>\n<li>Integration with BIM </li>\n<li>Geolocation elements - GIS </li>\n<li>RAMS and warranty control </li>\n<li>Reports and statistics </li>\n<li>Voice navigation </li>\n<li>Point cloud viewer </li>\n<li>Others</li>\n</ul>\n<p>LEVEL 2 – MONITORING: \nThis level provides real-time information on the infrastructure in a safe and non-intrusive manner, and personalized solutions adapted to the infrastructure, environment, and the conditions to monitor. To do this IMAS+® incorporates the functionalities of an IoT platform using the open-source platform FIWARE to be able to collect a huge amount of data with a wide range of different sensors and systems.</p>\n<p>DATA ACQUISITION STRATEGY </p>\n<ul>\n<li>Non-intrusive solutions </li>\n<li>Secure </li>\n<li>Cost-effective solutions </li>\n<li>Avoids current system modifications </li>\n<li>Uses open interfaces</li>\n</ul>\n<p>LEVEL 3 – PREDICTION: \nThis level includes specific predictive maintenance tools that help to schedule in advance all maintenance activities and to optimize maintenance costs. Automatic anomaly inspection and detection: The IMAS+® can detect hidden anomalies in data and explore factors that influence them using unsupervised machine learning applications.</p>\n<p>FORECAST AND PREPARATION FOR THE FUTURE</p>',
      challenge:
      ...
      references:
        '<ul>\n<li>Infrastructure Managers </li>\n<li>Railway Vehicle Owners and operators </li>\n<li>Rolling Stock Manufacturers </li>\n<li>Signalling &amp; Telecommunication Companies </li>\n<li>Construction Companies</li>\n</ul>',
      awards:
    ...
    'líneaciudadana-líneaciudadana': {
      ...
      organisationEmail: 'mailto:info@lineaciudadana.com',
      linkedIn:
        'https://www.linkedin.com/in/miguel-garcia-480003138/?originalSubdomain=es',
      twitter: 'https://twitter.com/linea_ciudadana',
      productWebsite: 'http://www.lineaciudadana.com',
      excerpt:
      ...
      yearOfValidation: 2018,
      description:
        "<p>Línea Ciudadana brings the public administration closer to the citizens with a simple and effective tool. The pillars of Línea Ciudadana's Smart City solution include facilitating governance through support for  constructive leadership and sustainability, facilitating citizen participation and democratizing cities, implementing technology with the functionalities that allow the interaction of people, and improving the quality of life of citizens.</p>\n<p>Today’s mobile devices allow us to create applications that are very useful for a municipality, offering participative, tourist, informative, management capacities, and more. These are some of the features and benefits we can offer via app + Cloud service Línea Ciudadana:</p>\n<ul>\n<li><p>Citizen participation: Get direct and bidirectional communication. </p></li>\n<li><p>Internal management: Streamlines and facilitates maintenance.</p></li>\n<li><p>Municipal Information: Keep the citizen informed of the latest developments in your municipality.</p></li>\n<li><p>Tourist information: Provides visitors with all tourist information.</p></li>\n<li><p>Reports and Statistics: Generates and studies results with statistics and performance KPIs. </p></li>\n<li><p>Citizen security: Notification service for real-time, geo-referenced alerts.</p></li>\n</ul>",
      challenge:
        '<p>We are an organization that, with the help of technology, collaborates with the cities supporting their authorities to develop strategies that give pragmatic answers to the voice of the citizens, allowing: "Participation and two-way communication with public managers".</p>',
      references:
        '<p>City Council of Lucena, City Council of Puertollano, City Council of Iznájar, City Council of Medina del Campo, City Council of Benavente, City Council of Moralzarzal, City Council of Orihuela, City Council of Pizarra, City Council of Torrelodones, City Council of Tres Cantos, City Council of Turre, City Council of Yecla, City Council of Zambrana</p>',
      awards: '',
      ...
      featuredImage: 'https://i.ytimg.com/vi/kWknPhT-xHc/maxresdefault.jpg',
      furtherImages: ''
    },
    'martelinnovate-orchestracities': {
      ...
      linkedIn:
        'https://www.linkedin.com/company/martel-gmbh/?trk=public_profile_experience-item_profile-section-card_image-click&originalSubdomain=ec',
      twitter: 'https://twitter.com/Martel_Innovate',
      productWebsite: 'https://www.orchestracities.com',
      excerpt:
      ...
      yearOfValidation: 2017,
      description:
        '<p>Orchestra Cities, Martel Lab’s new smart city data-management product is progressing at full speed!\nTo answer the need for a flexible data-management platform for smart cities, the team at Martel Lab developed Orchestra Cities, an integrated platform based on FIWARE and other cutting-edge Open Source solutions that allow to bring in a single place all the vertical data silos of cities.\nDesigned to facilitate the collaborative management of data and services by different cities and different stakeholders within the cities  allows the integration, analysis and visualization of a smart city’s data (from sensors, legacy system, citizen’s data, and more), Orchestra Cities plans to offer a powerful set of functionalities: Flexible dashboard co-creation, including map and graphs, and easy sharing Integrated management of Orchestra Cities APIs and third parties’ APIs, with flexible access policies and fault-tolerance mechanisms Data management based on open standards, supporting real-time data and historical data Support for centralized management of IoT allowing the integration of live data from IoT sensors, devices and other sources Advanced data privacy control mechanisms, ensuring that data owner is always in control of the data injected A visual data ingestion service that allows the design of data pipelines to populate the platform with data (from services, files, etc.)</p>\n<p>The above functionalities are ready to be used in the cloud, ensuring high-availability and scalability. Private deployments targeting single customers will be also possible in a few clicks!</p>\n<p>Taken as a whole, Orchestra Cities is a powerful tool for smart city managers across Europe and around the world. In recognition of its strength, it is one of the five contenders being selected for Phase 2 of the SELECT for Cities competition. The participation to the SELECT for Cities is driving the design of the platform with the collaboration of three cities (Antwerp, Copenhagen, and Helsinki) that allows  testing and validation of the Orchestra Cities platform in the following scenarios:</p>\n<p>Reducing traffic congestion in the city of Antwerp by intelligent decisions based on different data available from sensors and services. Supporting the monitoring of pre-diabetes patients in Helsinki through GDPR compliant management of Smart Homes.</p>',
      challenge: '',
      references: '<p>Antwerp\nHelsinki\nWolfsburg\nPOC in Switzerland</p>',
      awards:
        '<p>ORCHESTRA CITIES entered Phase II of the SELECT for Cities Pre-Commercial Procurement (PCP) process.\n5G Award at Smart City World Expo Congress in Barcelona</p>',
      technologies: [
        'Artificial Intelligence',
        'Big Data',
        'Data Analytics',
    ...
    'mermix-mermix': {
      ...
      yearOfValidation: 2018,
      description:
        '<p>Agri-Food Industries can now control the quality of the products through mermix Farm Management System for contract farming, while farmers can produce more and better crops with less capital investment.</p>\n<p>Mermix is an innovative web service that has multiple purposes and goals; the most important one is provinding the rural community, such as farmers (small, medium, or professionals), the opportunity to easily reach and access agricultural machinery and check their availability through the web. We believe that sharing agricultural machinery and tools can improve agricultural production and make it more sustainable. Through combining agricultural machinery and services sharing, farmers can save money and invest it in other areas of operations, such as efficient farm management methods, which will prove to  increase the quantity and quality of their products. Furthermore, mermix can give a solution to Agrifood industries, which are struggling with contract farming due to lack of supervision to the methods of cultivation. Combining both machinery sharings and farm management, it can take the agricultural sector a step further, through using modern and simple technology.</p>\n<p>Our services cover the following areas:</p>\n<ul>\n<li>Machinery sharing for all agricultural services </li>\n<li>Services sharing (rent a machine with the operator) </li>\n<li>Fleet and services advertisement </li>\n<li>Farm management system </li>\n<li>Contract farming supervision</li>\n</ul>',
      challenge:
    ...
    'movisat-ecosat': {
      ...
      productName: 'EcoSAT',
      organisationWebsite: '',
      organisationEmail: 'mailto:tecnomovilidad@movisat.com',
      linkedIn:
        'https://www.linkedin.com/company/movisat-tecnomovilidad/?originalSubdomain=es',
      twitter: 'https://twitter.com/movisat_es?lang=es',
      productWebsite: 'https://www.movisat.com/',
      excerpt:
      ...
      yearOfValidation: 2020,
      description:
        '<p>MOVISAT has developed a technological solution which integrates all the agents involved in the environmental services - Public Administration, Concessionaire Companies and Citizens - into a single platform, guaranteeing the optimization of the service.</p>\n<p>EcoSAT is an intelligent solution for planning, managing and controlling urban services, integrating specific modules to manage the organic waste collection, report incidents and audit service quality, optimize containerization and waste collection routes or facilitate participation in composting, recycling or reusing initiatives.</p>\n<p>In addition, we have all the necessary field solutions to integrate vehicles, machinery and urban furniture with the platform, guaranteeing perfect traceability through the installation of GPS, activity sensors that guarantee effective work, antennas and RFID readers, weighing scales, filling sensors for measuring the level information to plan the most efficient routes or IoT locks which recordes container opening and use information.</p>',
      challenge:
        '<p>Public Administration should implement a digital transformation of Public Environmental Services to convert them into a sustainable and participatory model, which reduces the waste generated and the cost of the service through the incorporation of new collecting fractions and more efficient control systems, enabling an optimal planning of the available resources.</p>',
      references:
        '<p>In the last 25 years, MOVISAT has developed and implemented more than 1.000 projects all over Spain.</p>\n<p>Some examples:\n TELEFÓNICA SMART CITIES BADAJOZ (Diputación Badajoz - Extremadura)\nTELEFÓNICA LA NUCÍA (Ayto La Nucía - Comunidad Valenciana)\nURBASER MADRID (Ayto Madrid - Madrid)\nUTE RM2 MADRID (Ayto Madrid - Madrid)\nLIPASAM (Ayto. Sevilla - Andalucía)\nLIMPIEZA DE MÁLAGA (Ayto. Málaga - Andalucía)\nUTE INDRA SATOCAN LAS PALMAS (Ayto. Las Palmas de Gran Canaria - Canarias)\nUTE ALICANTE (Ayto. Alicante - Comunidad Valenciana)\nCONSORCIO RSU CIUDAD REAL (Diputación Ciudad Real - Castilla La Mancha)\nVALORIZA ALBACETE (Ayto Albacete - Castilla La Mancha)\nCONSORCIO RSU MÁLAGA (Diputación Málaga - Andalucía)\nCONSORCIO PROVINCIAL DE MEDIO AMBIENTE DE VALLADOLID (Diputación Valladolid - Castilla y León)\nUTE ATLÁNTICA (Ayto. A Coruña - Galicia)\nVALORIZA SANTA CRUZ DE TENERIFE (Ayto. Santa Cruz de Tenerife - Canarias)\nARCGISA (Mancomunidad Campo de Gibraltar - Andalucía)\nUTE ALMANZORA (Consorcio Almanzora Levante Vélez - Andalucía) \nRIVAMADRID (Ayto. Rivas Vaciamadrid - Madrid)\nVALORIZA IBIZA (Ayto. Ibiza - Baleares)\nSTV Torrepacheco (Ayto. Torrepacheco - Murcia)\nMancomunidad de Residuos Domésticos de Cinco Villas Bortziriak (Navarra)</p>',
      awards: '',
      technologies: [
        'Artificial Intelligence',
        'Data Analytics',
    ...
    'nec-cloudcityoperationscenter': {
      ...
      organisationEmail: 'mailto:nec@nec.es',
      linkedIn: 'https://www.linkedin.com/company/nec-smart-cities/',
      twitter: 'https://twitter.com/NECSmartCities',
      productWebsite:
      ...
      yearOfValidation: 2017,
      description:
        '<p>NEC Cloud City Operations Centre (CCOC) platform acts as the brain of a smart city to enable service transformation with big data collected from diverse sources such as historical databases, IoT sensors and CCTV. City Operations Centre Predictive Analytics is a managed service that allows cities to manage, interpret and automate responses to the data collected across the city. \nCity Operations Centre Predictive Analytics service includes a set of CCOC modules which the client can use to create required data visualizations as defined by specific use cases.\nMain CCOC platform modules included with this service are:\nDashboard (Content Management System): Based on widgets, it can be configured to display a customizable subset of data in a variety of ways. It also includes the feature of generating alarms. Furthermore, it includes a public citizen site with contents to be managed by the client.\nBig Data Storage: This handles and processes large amounts of data from IoT devices, condensing them into useful aggregated results. Real-time analyses and historical data file.\nIoT Broker: Connects to any kind of IoT device, without any protocol or communication constraint.\nESB (Enterprise Service Bus): Connects to legacy systems, such as OSS/BSS and any application using existing API and interfaces\nStreaming Media Server: Brings and handles video streaming on the platform.\nReal-Time Processing Engine: Processes all events online, so fast actions can be taken based on them.\nAPI: Exposes all data to upper layers to get advantage of it.\nPublish / Subscription Notification Engine: For any system or interface to subscribe only to the information they are interested in.\nBPM &amp; BRE (Rules and workflows engines): Engines to create rules and workflows that automate all manual processes within the client.\nAnalytics and Prediction Engine: By the use of algorithms, through this engine the platform can analyze what has happened and why, then it can predict what is going to happen and prescribe actions to be taken.\nBI (Business Intelligence): Create KPI reports for the purposes of city analytics and export in multiple formats (HTML, PDF, Excel, etc.).</p>\n<p>All tools and data can be accessed via one consolidated and user friendly web-based interface.  NEC CCOC platform has been developed according to de facto standards in the industry, namely FIWARE, enabling the client to easily connect with their other or third-party systems.</p>',
      challenge: '',
      references: '',
      awards: '',
      technologies: ['Artificial Intelligence', 'Data Analytics', 'Open Data'],
      domains: ['Cities', 'Industry', 'Ports'],
      docs: [],
      videos: [],
      materials: [],
    ...
    'netzlink-flinknode': {
      ...
      organisationEmail: 'mailto:inside-sales@netzlink.com',
      linkedIn:
        'https://www.linkedin.com/company/netzlink-informationstechnik-gmbh/',
      twitter: 'https://twitter.com/netzlink',
      productWebsite: 'https://netzlink.com/flink-node-powered-by-netzlink/',
      excerpt: 'We provide the FIWARE platform with all Generic Enablers',
      yearOfValidation: 2017,
      description:
        '<p>OpenStack and open data are part of Netzlink’s bread and butter business. As a seasoned expert in these fields, Netzlink is not only one of the most experienced IT and managed service providers in the European FIWARE community, but also the German provider of the FIWARE environment! Netzlink’s own IT service Helplink offers professional 24/7 support. IT systems, applications, and data are all stored in German data centers. Netzlink is ISO-certified and guarantees data protection according to the German Federal Data Protection Act (BDSG) as well as processes that are in line with ITIL practices.</p>\n<p>The first German FIWARE node was set up by Netzlink in 2016 for EU-funded start-up companies. In 2017, the node became available to all customers – now companies from the areas of health, energy, and agriculture can benefit from FIWARE just as well as towns and cities of all sizes, communities and developers. So far, more than 100 applications worldwide have been implemented based on FIWARE, and they are an ideal starting point. We provide the FIWARE platform with all Generic Enablers.</p>',
      challenge: '',
      references: '',
      awards: '',
      technologies: ['Industrial Technology', 'Internet of Things', 'Big Data'],
      domains: ['Smart Industry'],
      docs: [],
      videos: [],
      materials: [],
      logo:
    ...
    'nixi1-nixi1': {
      ...
      organisationEmail: 'mailto:info@nixi1.com',
      linkedIn: 'https://www.linkedin.com/company/nixi1/',
      twitter: 'https://twitter.com/nixi1_bot',
      productWebsite: 'https://www.nixi1.com',
      excerpt:
      ...
      yearOfValidation: 2018,
      description:
        '<p>After multiple iterations and evolutions, nixi1 has become the most advanced Travel chatbot (or AITA; Artificial Intelligence Travel Agency) of the world. Since August 2016, it has acquired more than 80,000 users.</p>\n<p>Currently, the company has two products that correspond to two business lines. The first is AITA, focused on offering all Travel services to the end-user. The second is the white label Chatbot SaaS (Software as a Service), focused on Travel Service Suppliers, so that they can boost their direct sales channels through the CHAT.</p>\n<p>The Travel chatbot, AITA, has been developed with the following fundamental values:</p>\n<ul>\n<li><p>Transactional and assistance: 100% automated, it doesn’t require any human assistance. This is a particularly important milestone to allow its scalability. </p></li>\n<li><p>Omnichannel: Currently works in Telegram, WhatsApp, Facebook Messenger, SMS, App, and Web. nixi1’s team has developed a deep know-how to integrate any new messaging quickly. In addition, it can be integrated into mail and in the future, it will do the same in Voice Assistants such as Siri, Alexa, or Google when their respective marketplaces are enabled. </p></li>\n<li><p>Multi-language: Currently the chatbot is available natively in English, Spanish, French, and German and available in 95 other languages ​​through automatic translation protocols (non-native). The linguistic corpus architecture based on a contextualized sales funnel and several layers of neural networks allow the easy native translation of the chatbot into different languages.</p></li>\n<li><p>Voice notes: We have added the functionality of voice notes to the text and we have provided the forms with predictive capabilities.</p></li>\n</ul>\n<p>Currently, nixi1 is integrated with a broad universe of travel suppliers that gives access to a massive range of tourism services at the best price. 92% of our users say they have found the cheapest option with our solution.</p>\n<p>The solution for B2B helps to avoid intermediates by promoting a new direct sales channel, which also helps to acquire users at a low price, improve loyalty rates and reduce operational costs thanks to the AI. For the final consumer, it is a more economical and convenient solution.</p>',
      challenge:
        '<p>nixi1 has two customer segments. On one hand, the main problems for Travel Service Suppliers (B2B) like hotels and airlines are:</p>\n<ul>\n<li><p>DISINTERMEDIATION. There’s an excessive dependence on indirect sales channels such as OTAs (Online Travel Agencies), which charge high commissions, 15-35%. </p></li>\n<li><p>OPERATIONAL COSTS. Expensive and numerous call-centers. It is estimated that between 10% and 15% of all reservations of Travel Service Suppliers is via phone call and 100% of the services of customer services are operated by humans, with a high operational cost. It is a constant priority to search for mechanisms to reduce these costs. </p></li>\n<li><p>LOYALTY. Most travelers are price-oriented, which generates a dependence on OTAs, a channel in which the user can compare the wide range of services. The only two channels of direct communication (email and phone calls) handled by Travel Service Suppliers, beyond the web and the App, have a very low acceptance rate. </p></li>\n<li><p>CUSTOMER ACQUISITION COSTS (CAC). CACs are very high due to the duopoly of Booking Holdings and Expedia in Google SEM. Besides, it’s an oligopolistic sector, a few GDSs, Consolidators, TA (Travel Agencies), OTA, and Metasearchers have more than 80% share in their respective categories).</p></li>\n</ul>\n<p>On the other hand, if we consider the traveler (B2C), the two biggest challenges in the industry are:</p>\n<ul>\n<li><p>PRICE. In general terms, the traveler is sensitive to the price, the cheaper the better, as long as a quality threshold is maintained. This is even more relevant in the FLIGHT reservation, which is the first purchase of a trip. In addition, the user wants to know the final price from the beginning and not be tricked by unexpected charges at the end of the process. </p></li>\n<li><p>CONVENIENCE. The more comfortable the solution, the better. The traveler aims to access the biggest and most competitive offer in the market on  a single site, without unwanted redirects and without having to consult several websites or apps.</p></li>\n</ul>',
      references: '',
      awards: '',
      technologies: ['Data Analytics', 'Open Data'],
      domains: ['Cities'],
    ...
    'openmove-openmove': {
      ...
      organisationEmail: '',
      linkedIn:
        'https://www.linkedin.com/company/openmove/?originalSubdomain=it',
      twitter: 'https://twitter.com/openmove?lang=en',
      productWebsite: 'https://openmove.com',
      excerpt:
      ...
      description:
        '<p>OpenMove is an end-to-end mobility platform with 24/7 cloud provision which features multiple ITS (Intelligent Transport Systems) modules.\nAFC (Automated Fare Collection) system which allows sales capabilities across multiple channels as well as a comprehensive set of tools for the personnel of the transport service provider.\nAccount-Based Ticketing\nOmnichannel digital sales (e-commerce, white-label app, sales tools for field personnel and ticket shops, on-board validators and gates)\nFast and reliable activation of tickets\nAnti-fraud detection\nDRT (Demand-Responsive Transit). A system able to feature on-demand services and reservations on fixed-line services, including interfaces for final users, management tool, and dynamic vehicle routing engine capable of optimizing trip dispatchment.\nFlexible on-call services based on demand\nBoarding lists in real-time\nImproved accessibility to services for various user categories\nAutomated trip management\nOptimization of seat reservations\nRTPI (Real-Time Passenger Information). A system providing travelers with accurate real-time information for moving seamlessly.\nRoute calculation with intermodal trip planning\nReal-time vehicle location \nCalculation of ETA (Estimated Time of Arrival)\nDynamic timetables\nReal-time changes and alerts for the planned itinerary\nMaaS (Mobility as a Service). MaaS Integration layer to provide real answers to users’ freedom of movement and enable governance over the mobility scheme.\nIntermodal integration of multiple transport services\nAccess and booking services to the mobility options of a region\nCommunication channel with users\nFull interoperability of data and services\nEnabling a new transportation marketplace able to increase user base and revenues</p>',
      challenge:
        "<p>OpenMove's mission is to make travelers free to move and at the same time promote the environmental and economic sustainability of transport services. People travel twice: the first time when planning a trip, the second time when making it; OpenMove responds to this double need with its solutions featuring multi-channel ticketing, real-time passenger information, on-demand transport, and intermodal MaaS integration.</p>\n<p>OpenMove provides its References/Customers with a turnkey mobility platform as-a-Service. This enables them to rely on state-of-the-art technology with the guarantee of 24/7 high availability, incremental updates, and maintenance.</p>\n<p>Transit providers benefit from improved mobility governance and seamless day-by-day operation, including fare collection, real-time service monitoring, and passenger information.</p>\n<p>OpenMove platform helps to increase customer satisfaction and revenues, by easily and safely extending the sales channels, leveraging  anti-fraud technologies, and enabling real-time journey planning.</p>\n<p>OpenMove paves the way for new mobility able to keep up with the times, by favoring digitization, dematerialization, and sustainability of transport services from a MaaS perspective.</p>",
      references:
        '<p>OpenMove software products are addressed to Public Transport Operators (PTO), shuttle and long-distance service providers, Public Transport Authorities (PTA), municipalities, large companies operating corporate mobility services, tourism service providers, and system integrators.</p>\n<p>OpenMove solutions have been adopted in multiple countries in Europe, USA, and Middle East and now manage 10M passengers per year and $50M of transport tickets per year.</p>',
      awards: '',
      technologies: [
        'Data Spaces',
        'Mobility and Location',
    ...
    'phoops-muvapp': {
      ...
      organisationEmail: '',
      linkedIn:
        'https://www.linkedin.com/company/muv-app/?originalSubdomain=ch',
      twitter: 'https://twitter.com/muv_app',
      productWebsite: 'https://muv-app.city/',
      excerpt:
    ...
    'projectray-ray': {
      ...
      organisationEmail: 'mailto:admin@project-ray.com',
      linkedIn: 'https://www.linkedin.com/company/project-ray/about/',
      twitter: 'https://twitter.com/ProjRAY',
      productWebsite: 'http://www.project-ray.com',
      excerpt:
    ...
    'purpleblob-baret': {
      ...
      organisationEmail: 'mailto:contacto@purpleblob.net',
      linkedIn: 'https://www.linkedin.com/company/purple-blob/',
      twitter: 'https://twitter.com/PurpleBlobSL',
      productWebsite: 'https://baret.es',
      excerpt:
      ...
      featuredImage:
        'https://pbs.twimg.com/profile_banners/934861944661606407/1516186486/1500x500',
      furtherImages: '',
      related: [
        {
          category: 'Powered by FIWARE',
    ...
    'purpleblob-sara': {
      ...
      linkedIn: 'https://www.linkedin.com/company/purple-blob/',
      twitter: 'https://twitter.com/PurpleBlobSL',
      productWebsite: 'https://purpleblob.net/en/sara-en/',
      excerpt:
        'SARA is an IoT platform that can integrate almost any  solution, data source or actuator into a powered by FIWARE system that centralizes all the user and device management, enables the use of different analytical intelligence tools and allows the aggregation of the data generated by each solution',
      yearOfValidation: 2020,
      description:
        '<p>SARA is a FIWARE-based IoT platform designed to fit in industrial environments and operate with maximum efficiency. The main goal of SARA is to offer a centralized system in which many IIoT solutions can coexist, minimizing the effort to integrate devices and digital tools from different suppliers allowing an organized user and device management and enabling the use of shared analytical tools. This centralized system can thus maximize the value of each solution by aggregating the information of the other systems.</p>\n<p>Moreover, SARA follows a modular architecture that can implement one or several components depending on customer needs. This allows the implementation of a step-by-step strategy that can prove to the client that a digital approach can actually improve their company.</p>\n<p>In addition, SARA offers industrial-grade security and availability that covers both users and information throughout the entire data life cycle. Additionally, the platform is based on Kubernetes, which allows for complete scalability and efficient resource management. Lastly, the FIWARE architecture grants maximum interoperability to use other digital tools along with SARA or to integrate the platform in greater projects.</p>\n<p>All these benefits are provided to the users through a web interface that can be accessed via a computer or mobile phone showing all the information that SARA stores on interactive dashboards from which the users can:</p>\n<p>Visualize the reports or the results of the analytical processes that have been applied to the information. They can also filter most visualizations with time lapses, variable filtering, and even query configuration;\nGet alerted under certain circumstances, like the depletion of an oil tank, a smoke detection event, and similar situations;\nManage the devices, adding, modifying, deleting, and debugging these from the reports and from information messages that components generate along the way when a new report is received;\nManage the channels and interfaces in which SARA is interconnected with devices and other external systems;\nManage the users and their permissions.</p>\n<p>It is important to notice that SARA allows a comprehensive permission management based on user groups and organizations, so that the administrator can tailor them to suit any kind of environment, for example, different departments in the same company.</p>',
      challenge:
        '<p>The rapid growth of the Internet of things  paradigm has changed every aspect of how connectivity is perceived but it has led to an ecosystem where most IoT solutions are based on individual proprietary platforms. Developing functional IoT ecosystems with these solutions has proved to be challenging and uncomfortable for the user, even more if we take into account that new devices are used as a data source to obtain relevant magnitudes from the environment coexisting with hand-made taken notes and cabled systems. Rapid advances in microelectronics and communications as well as in distributed software architecture have made possible the appearance of applications that reduce the costs of collecting data and acting with the different systems but they require a maximum quality and interoperability that is hardly obtainable by implementing different solutions working on their own.</p>\n<p>Thus, the implemented technology has to pursue some clear goals on its implementation:\nFinancial benefits\n● Return on investment through cost reduction\n● Cost optimization\nOperative benefits\n● Unified data gathering\n● Process optimization in based on data\n● Implementation of preventive and predictive maintenance \n● Real-time alerts\n● Maximizing security in all environments\nCompliance\n● Reports for audits and inspections.\n● Validations\n● Reduction of the carbon footprint</p>\n<p>In this context, SARA was born to fulfill the needs of the public and industrial sectors as a unified and adaptable platform capable of providing a set of data treatment, action and visualization tools in a homogeneous manner, regardless of its origin or provider, in response to the high costs of custom developments.</p>',
      references:
        '<p>Ayuntamiento de Galdakao\nGrupo Amper\nSarenet\nAutoridad Portuaria de Bilbao\nTerres del Maestrat\nVaillant\nMideos\nAyuntamiento de La Nucía\nConsorcio de transportes de Bizkaia (CTB)</p>',
      awards: '',
      technologies: [
        'Artificial Intelligence',
        'Blockchain',
    ...
    'pycno-pycno': {
      ...
      organisationEmail: 'mailto:contact@pycno.co',
      linkedIn: 'https://www.linkedin.com/company/pycno/',
      twitter: 'https://twitter.com/pycno',
      productWebsite: 'https://www.pycno.co',
      excerpt:
      ...
      yearOfValidation: 2018,
      description:
        '<p>Pycno helps tackle one of the biggest challenges of this century: Food Security by building a network of wireless sensors for growers to help them make better informed decisions on how to grow food more efficiently.</p>\n<p>These sensors measure key parameters of the soil and the air such as Soil moisture, Soil temperature, Temperature and Humidity of the Air, Solar radiation and Rain intensity that are later on mixed with other regional data to provide their users with best practices on how to be more efficient at producing food.</p>\n<p>Current users have shown an improvement in the quality and quantity of their harvest while also reducing the amount of resources such as water, pesticides, fertilizers, fungicides, and electricity that they use.</p>\n<p>The ability to make  better-informed decisions while monitoring the condition of their fields from remote locations in real-time from anywhere they are in the world makes this tool a must for every decision-maker in the agriculture market.</p>',
      challenge:
        '<p>Agriculture is one of the most critical and important yet less technified markets. This is due to how much we depend on food to sustain life and how little information we have to act upon growing food in the most efficient way possible. We have all already heard  that farming is the single most powerful driver of deforestation and loss of biodiversity, that 70% of the global water consumption is used for farming, that 42% of the Earth’s land surface area is already been used for farmland and that, with the growth of population, the demand for food is only going to increase, calling for smarter and more resilient solutions to feed the world.</p>',
      references: '',
      awards: '',
      technologies: ['Artificial Intelligence', 'Data Analytics'],
      domains: ['AgriFood'],
      docs: [],
      videos: [],
      materials: [],
    ...
    'saintquentin-connectedcanteens': {
      ...
      yearOfValidation: 2021,
      description:
        '<p>ASSESSMENT\nBetween 30 and 40% of food is wasted in school canteens</p>\n<p>SOLUTION\nUsing weight sensors underneath the bins, pupils can be told how much waste there is on the day and how it changes over the days and months. Results are presented on a web platform or an application.</p>\n<p>ROI \nThis solution allows: *improvement of menu quality by refining meal proposals and quantities *gamification between schools in a town to be the one that produces the least waste *possibility of using bio-waste to make compost *awareness-raising actions with pupils based on concrete data</p>',
      challenge:
    ...
    'sammy-smartmarinaplatform': {
      ...
      organisationEmail: 'mailto:info@sammyacht.com',
      linkedIn: 'https://www.linkedin.com/company/sammyacht/',
      twitter: 'https://twitter.com/sammyacht?lang=en',
      productWebsite: 'https://www.sammyacht.com/sammy/website/',
      excerpt:
      ...
      domains: ['Cities', 'Mobility', 'Tourism', 'Transport'],
      docs: [],
      videos: [],
      materials: [],
      logo:
    ...
    'scuter-scuter': {
      ...
      organisationEmail: 'mailto:info@scuter.co',
      linkedIn: 'https://www.linkedin.com/company/scuter/',
      twitter: 'https://twitter.com/joinScuter',
      productWebsite: 'http://scuter.co',
      excerpt:
      ...
      yearOfValidation: 2018,
      description:
        '<p>Scuter has developed a vertically integrated service to overcome and satisfy widespread fast and clean urban commuting demand. We designed a 3-wheels electric scooter that can be driven without wearing a helmet. This blinks at car drivers that are not used to motorcycle driving experience and are looking for an alternative to their cars. Our service will be a free-floating pay per use vehicle sharing, with  dynamic pricing based on an AI algorithm that will allow References/Customers to earn money if they help us with logistics and battery swap, thus reducing the opex for us. We are enabling a crypto token service to leverage  the cleantech economy.\nOur design inputs were:</p>\n<ul>\n<li><p>A fast and light scooter: cars in any form (proprietary or shared) are too traffic affected in urban environments. </p></li>\n<li><p>The safest and the cleanest scooter. </p></li>\n<li><p>Everyone must feel comfortable in using SCUTER, not only the experienced riders.</p></li>\n</ul>\n<p>In addition, Scuter is:</p>\n<ul>\n<li><p>Clean: Zero-emissions, 100% electric vehicle. </p></li>\n<li><p>Easy: You just need your smartphone to pick Scuter up. </p></li>\n<li><p>Safe: 3-wheels, safety belts, no helmet, just ride and save your time. </p></li>\n<li><p>Smart: Use the smart platform onboard to connect to your friends and have fun.</p></li>\n</ul>',
      challenge:
        '<p>Scuter aims to attack the issue of traffic jams in urban commuting, parking problems, and inefficient ways to move</p>',
      references:
        '<p>Car drivers (especially professionals), students, commuters and tourists moving downtown.</p>',
      awards: '',
      technologies: ['Internet of Things', 'Data Analytics'],
      domains: ['Cities'],
      docs: [],
    ...
    'secondnature-ourpath': {
      ...
      organisationEmail: 'mailto:hello@secondnature.io',
      linkedIn: 'https://www.linkedin.com/company/besecondnature/',
      twitter: 'https://twitter.com/snhealth_uk',
      productWebsite: 'https://www.secondnature.io/',
      excerpt:
      ...
      references:
        '<p>We sell OurPath to both national healthcare systems and insurers, as well as privately direct-to-consumer.</p>',
      awards: '',
      technologies: ['Data Analytics'],
      domains: ['Health'],
      docs: [],
    ...
    'sensative-yggioplatform': {
      ...
      organisationEmail: 'mailto:sales@sensative.com',
      linkedIn: 'https://www.linkedin.com/company/sensative/',
      twitter: 'https://twitter.com/sensative',
      productWebsite: 'https://sensative.com/product/yggio/',
      excerpt:
      ...
      yearOfValidation: 2019,
      description:
        '<p>Yggio acts as a real-time integration layer between services and connected assets, sensors, and networks, enabling multiple users and services to use data generated by both shared and private IoT devices.\nEnterprises, cities, municipalities, property owners, service partners, and more use the Yggio capabilities to rapidly deliver new services and applications.</p>',
      challenge: '',
      references:
        '<p>The city of Lund, City of Malmö, Municipality of Sundbyberg, VaSyd, C4 Energi, Kraftringen, HFAB, Akelius, Castellum</p>',
      awards:
        '<p>https://www.hfab.se/sv/pressmeddelande/2019/hfab-samarbete-prisas-for-smarta-lagenheter/</p>',
      technologies: [
        'Artificial Intelligence',
      ...
      materials: [
        ...
        [
          'Reference 4',
          'http://futurebylund.se/blog/connecting-the-electricity-cabinets'
        ]
      ],
      logo:
    ...
    'sensei-sensei': {
      ...
      organisationEmail: '',
      linkedIn:
        'https://www.linkedin.com/company/sensei-tech/?original_referer=https%3A%2F%2Fwww.sensei.tech%2F',
      twitter: 'https://twitter.com/Sensei_tech',
      productWebsite: 'https://www.sensei.tech',
      excerpt:
      ...
      yearOfValidation: 2018,
      description:
        '<p>Sensei is an AI-powered, real-time video recognition solution that helps retailers understand the in-store activity. Sensei leverages streams from existing store cameras to provide analysis on traffic, customer flow, and product interaction as well as to detect empty shelves.</p>\n<p>At Sensei we developed algorithms that turn any installed camera into a powerful sensor, which allows it to digitize  brick and mortar stores, digitize its products (SKUs) and measure real-time customer experience. Sensei provides retailers with accurate in-store analytics and insights ranging from traffic flow, store benchmarking, products’ performance, out-of-shelf detection and allows for optimized operations and drive more sales.</p>',
      challenge:
        "<p>Despite e-commerce growth, brick and mortar stores still generate 89% of the total volume of sales in Europe. Furthermore, sales conversion is on average 20% for fashion stores, and on-shelf availability of products in supermarkets can be as low as 85%. Both these issues represent lost sales opportunities leading to an overall of 3.3 trillion dollars lost annually due to these inefficiencies.\nTo date, unlike online stores, there is no systematic way of tracking which products elicit interest from References/Customers but are not converted (lost sales) and to automatically digitize a store space, and its products. The current state-of-the-art technologies for tracking can only determine (inaccurately) how many people enter and leave the store and do not provide any information of the client's engagement in store, which creates a significant blind spot leading to over/understaffing stores, stocking the wrong inventory and missing sales opportunities.</p>",
      references: '',
      awards: '',
      technologies: [
        'Artificial Intelligence',
    ...
    'sensohivetechnologiesaps-maturix': {
      ...
      organisationEmail: 'mailto:contact@maturix.com',
      linkedIn: 'https://www.linkedin.com/company/maturix/',
      twitter: 'https://mobile.twitter.com/sensohive',
      productWebsite: 'https://maturix.com/software/in-situ/',
      excerpt:
      ...
      yearOfValidation: 2018,
      description:
        '<p>We have designed and built an end-2-end solution from hardware to software and connectivity thus providing  novel solutions enabling our clients to improve production time, decrease resource consumption (energy) and eliminate time for products’ documentation. We call the system - Maturix - please visit www.maturix.com\nFeatures:\nThe Maturix software is a concrete monitoring center, which contains all needed functionalities to set up, monitor, document, and share the end results between colleagues. All raw data is accessible and also in reports. All maturity calculations are made in real-time and predictions are updated.\nKey features:</p>\n<ul>\n<li><p>Real-time maturity data dashboards </p></li>\n<li><p>Automatic maturity PDF reports </p></li>\n<li><p>3-year data backup </p></li>\n<li><p>Concrete mix database</p></li>\n<li><p>Unlimited number of locations </p></li>\n<li><p>Data export </p></li>\n<li><p>EPR Integrations (SAP etc.) </p></li>\n<li><p>Predictions on when target-maturity is reached</p></li>\n</ul>\n<p>As previously mentioned the benefits are multiple - among others:</p>\n<ul>\n<li><p>Save time and save salaries </p></li>\n<li><p>Heat only when needed (savings up to 75%) </p></li>\n<li><p>Insight into production </p></li>\n<li><p>Save time with automatic documentation reports </p></li>\n<li><p>Service and maintenance of equipment </p></li>\n<li><p>Reduce the risk of failure (dropping elements etc.)</p></li>\n<li><p>Reduce product waste by limited wire traction and damaging elements </p></li>\n<li><p>Optimize climate to increase production speed </p></li>\n<li><p>Recept optimization: use the right concrete recept (time vs. performance)</p></li>\n</ul>',
      challenge:
        '<p>The construction industry - both in-situ and precast - is very old school in terms of production methods and analytics. At Sensohive we have developed Maturix to help the precast industry make better production decisions and as a result, improved production output by 20-40% and minimize waste by 20-30% - only by using data from our IoT devices.</p>',
      references: '',
      awards: '',
      technologies: ['Internet of Things', 'Sensory Systems', 'Data Analytics'],
      domains: ['Industry'],
      ...
      featuredImage:
        'https://scontent-frx5-1.xx.fbcdn.net/v/t39.30808-6/274551834_4603602143084764_4909558036212081928_n.png?_nc_cat=111&ccb=1-7&_nc_sid=e3f864&_nc_ohc=5ASrJfmLaHoAX8Veemm&_nc_ht=scontent-frx5-1.xx&oh=00_AT_ulDVBtiyosDxPyFzCOvKOnYj6ztaryUWai5mNMeQhxw&oe=62E6BABF',
      furtherImages: ''
    },
    'sensowave-digitanimal': {
      ...
      yearOfValidation: 2018,
      description:
        '<p>Digitanimal is an integrated service platform composed of our own monitoring IoT wearables and a cloud platform devoted to helping livestock farmers, breeders and fatteners, to increase their profitability and animals’ welfare. Besides that, we provide traceability tools from calving in order to guarantee transparency in the meat chain. Wearables monitor animals’ conditions and send them  to the cloud through IoT networks where our own designed Big Data and AI algorithms generate insights and notifications for farmers. In addition, our management software is integrated with data coming from wearables in order to save paperwork time and ensure traceability data.</p>',
      challenge:
        '<p>Livestock farmers (breeders and fatteners) have a very low gross margin and currently, their benefits depend on subsidies. Electronic tagging of cattle is going to be mandatory in the EU. Current GPS/RFID-based solutions are suboptimal (cost, functionality) in feedlots. Software management apps for cattle farms are available, but they require human data entry, which are not backed by real data. In UE-28 there are more than 272k livestock fatteners that need a cost affordable solution that monitors the status of the animals and helps them with paperwork. Livestock breeders  lack  tools to monitor and locate their cattle, assuming  10% of animal losses. Just in UE, there are more than 452k (60M of cattle) with this problem.</p>',
      references: '',
      awards:
        '<p>Digitanimal (former STEPLA) participated in SmartAgriFood accelerator where it reached the last stage of the acceleration program and  was selected at the top 3 best performance projects and the best technological project.\nDigitanimal project was selected in 2016 to be part of the GSMA Innovation City of the Mobile World Congress (https://youtu.be/vmMPpvw3SSQ, https://youtu.be/9dmH1WcLT18).</p>',
      technologies: ['Internet of Things', 'Data Analytics'],
      domains: ['AgriFood'],
      docs: [],
      videos: [
      ...
      materials: [
        [
          'Reference 1',
          'http://www.4d4f.eu/content/case-study-gps-location-system-goats'
        ]
      ],
      logo:
    ...
    'sentio-vistra': {
      ...
      organisationEmail: 'mailto:sen@sentio.net',
      linkedIn: 'https://www.linkedin.com/company/sentio-simulations/',
      twitter: '',
      productWebsite: 'https://www.sentio.net/vistra-solutions/',
      excerpt:
      ...
      yearOfValidation: 2018,
      description:
        '<p>VISTRA offers a unique approach to resolving the major barriers preventing virtual operator training and support from reaching its potential in the manufacturing sector. The key innovation is to generate the content directly from the manufacturing PLM system of the enterprise. Over the last decade, many companies have invested in digitization initiatives including representing the manufacturing and service processes in the digital domain using solutions such as Siemens Teamcenter, Dassault 3DExperience, and PTC Windchill. The VISTRA solution offers the capability to import data from these systems to an automation engine thatis capable to build ready-for-use simulation components of these manufacturing and service processes which can be served up to a range of applications and interfaces which present the simulation to consumers according to their specific use case. In the described architecture this simulation data derived from the PLM system is called the ‘Enhanced Digital Twin’ (EDT) and includes data such as geometry assemblies, technical procedures and enhancements such as automatically-generated animations, critical knowledge components, and more. The EDT is stored in the VISTRA backed application VISTRA Management System (VMS) and is made available to client applications as a ‘simulation flow’ of 3d components.</p>\n<p>Following this automation approach solves the major barriers described in the previous section:</p>\n<ul>\n<li><p>Cost of content production: creating and deploying simulation content requires no particular technical skillset, and relies on CPU/GPU-time rather than human hours, speeding up the production time by several orders of magnitude. </p></li>\n<li><p>Easy content maintenance: as the manufacturing engineering and service specialists revise processes the updated simulation can be generated in just minutes. Furthermore, there is no vendor reliance to manage the updating process and deliver the results in a timely fashion. </p></li>\n<li><p>Data security: as a tool used inside the enterprise the most sensitive data never needs to leave the organizations’ corporate network.</p></li>\n</ul>\n<p>In addition, the data can be used to support multiple use cases, creating a significant multiplier effect.</p>',
      challenge:
        '<p>Manufacturing companies have long been aware of the potential for virtual training to contribute to operator training and technician support systems, but the expected impact has never been reached, primarily due to the following factors:</p>\n<ul>\n<li>Cost of content production: building the simulation training by a manual process is technically complex and time-consuming, hence the cost of bespoke solutions is high and in many cases cannot meet the required RoI. </li>\n<li>Impractical content maintenance: in many manufacturing companies the assembly process is constantly updated to achieve more efficient production, as often as multiple times in a single day during ramp-up phases. Changes to assembly processes also impact service and installation procedures, which are further complicated by being branched workflows with context-sensitive decision making. It is impossible to maintain the bespoke content in a relevant state when the updating process is time consuming and relies on an external resource to create the changes and return them to the customer. </li>\n<li>Data security: data relating to geometry, manufacturing, and service processes are amongst the most sensitive information held by OEMs. The exchange of this information with external vendors is both unwieldy and represents a significant security risk.\nFurthermore, most manufacturing companies face a complexity challenge, with product variants and customer options creating highly diverse product portfolios. Such complexity further increases the pressure to prepare the operators and technicians correctly as the number of operations expected to be performed by the operators increases dramatically, while in many cases they will only be performed infrequently, both of which contribute to many challenges in relation to quality.</li>\n</ul>',
      references: '',
      awards: '',
      technologies: ['Internet of Things', 'Additive Manufacturing'],
      domains: ['Industry'],
      docs: [],
      videos: [],
      materials: [],
    ...
    'sirusnv-siruscitystore': {
      ...
      organisationEmail: '',
      linkedIn: 'https://www.linkedin.com/company/sirus-nv/',
      twitter: 'https://twitter.com/Sirus_be',
      productWebsite: 'https://sirus.be/smart-cities/',
      excerpt:
      ...
      yearOfValidation: 2020,
      description:
        "<p>The Sirus Smart City store helps cities to harmonize all the data gathered by different sensors and platforms in the city. The data is then delivered in an open standard way to Citizens, Government, Companies, and Research institutes. This allows cities to closely collaborate with different parties to create innovative solutions that tackle the today and future challenges of the city.\nThe platform implements the OASC MIM's making the city OASC compliant in rapide manner. This allows the city to access the vast amount of solutions that are built on top of these agreed standards.</p>",
      challenge: '',
      references: "<p>Antwerp Luxembourg Ville D'Esch</p>",
      awards: '',
      technologies: [
        'Data Spaces',
        'Digital Twins',
      ...
      domains: ['Cities', 'Green Deal', 'Mobility', 'Water', 'Weather'],
      docs: [],
      videos: [],
      materials: [],
      logo:
    ...
    'snap4city-km4city': {
      ...
      productName: 'Km4City',
      organisationWebsite:
        'https://www.snap4city.org/dashboardSmartCity/management/iframeApp.php?linkUrl=https://www.snap4city.org/drupal&linkId=snap4cityPortalLink&pageTitle=www.snap4city.org&fromSubmenu=false',
      organisationEmail: 'mailto:paolo.nesi@unifi.it',
      linkedIn: 'https://www.linkedin.com/in/paolo-nesi-849ba51/',
      twitter: 'https://twitter.com/Snap4City',
      productWebsite:
        'https://www.snap4city.org/dashboardSmartCity/management/iframeApp.php?linkUrl=https%3A%2F%2Fwww.km4city.org&pageTitle=www.km4city.org&linkId=km4cityPortalLink&fromSubmenu=false',
      excerpt:
      ...
      awards:
        '<p>Winner of the ENEL-X Challenge on Open Data: https://openinnovability.enel.com/projects/New-smart-city-solutions-enabled-by-open-data \nWinner of the Select4Cities PCP for the design of the IoT/IoE solution and Living Lab for Helsinki and Antwerp (https://www.select4cities.eu/phase-3-winners) \nSnap4City is certified to offer FIWARE Training Services\nSnap4City is certified to offer FIWARE Consultancy Services\nSnap4City is a platform proposed on the Marketplace of EOSC\nSnap4city is on BeeSmart marketplace\nSnap4City is compliant with OBD2 Devices for vehicles and fleets monitoring\nSnap4City is fully compliant with GIS, ArcGIS, QGIS, etc., interoperating with WMS and WFS services, see the examples of Snap4City in connection with ArcGIS or OpenGIS provided and made available\nKm4City: Km4City of Snap4City is an official API of E015 suite\nLoraWAN: Snap4City is compliant with LoraWan\nSigFOX: Snap4City is a partner of SigFOX\nNode-RED, JSFoundation: Snap4City is an official library of Node-RED\nCKAN: Km4City/Snap4City are Powered by CKAN, since they provide DataGate CKAN module for shortening the ingestion and publication of Data Sets, and the eventual connection with other CKAN tools and installations in the world.\nGold Member of the FIWARE Foundation\nOfficial Powered by FIWARE Solution\nGAIA-X member</p>',
      technologies: [
        'Advanced or High Performance Computing',
        'Artificial Intelligence',
        'Data Analytics',
      ...
      materials: [
        ...
        [
          'Reference 4',
          'http://www.arpat.toscana.it/notizie/arpatnews/2020/183-20/traffico-meteo-e-qualita-dellaria-limportanza-dei-dati-per-gestire-e-vivere-le-citta'
        ],
        [
          'Reference 5',
          'https://www.codemotion.com/magazine/dev-hub/big-data-analyst/snap4city-dashboards-overlook-your-city/'
        ]
      ],
      logo:
    ...
    'snap4city-snap4city': {
      ...
      organisationEmail: 'mailto:paolo.nesi@unifi.it',
      linkedIn:
        'https://www.linkedin.com/in/nicola-mitolo-b13342b/?originalSubdomain=it',
      twitter: 'https://twitter.com/snap4city',
      ...
      materials: [
        ...
        ['Reference 3', 'https://www.snap4city.org/426'],
        [
          'Reference 4',
          'https://www.codemotion.com/magazine/dev-hub/big-data-analyst/snap4city-dashboards-overlook-your-city/'
        ],
        [
          'Reference 5',
          'https://www.codemotion.com/magazine/how-snap4city-can-bring-your-vision-of-a-smart-city-to-reality-3194'
        ]
      ],
      logo:
    ...
    'srmconsulting-capacitycontrolsystem': {
      ...
      challenge:
        '<p>Public spaces are known as areas or places generally open and/or accessible to people. These spaces are also well known as Urban Soft Targets, which means that they are vulnerable to terroristm attacks or could be converted into COVID sources of infection. Having a capacity and location control of the people inside of one area is a priority in current circumstances. Video Cameras associated with IA algorithms are good solutions, but they need a complex processing systems to track (and therefore count and localize) people inside an area. Currently, more than 85% of people in developed countries, such as in Spain in 2018, have a smartphone with Bluetooth or Wi-Fi sensor, the signal emitted by these devices can be scanned by sensors to identify and localize them.</p>',
      references: '',
      awards: '',
      technologies: [
        'Artificial Intelligence',
    ...
    'stoneone-smartorchestra': {
      ...
      productWebsite:
        'https://stoneone.de/news/smart-orchestra-plattform-auf-fiware-marketplace/',
      excerpt:
      ...
      yearOfValidation: 2018,
      description:
        '<p>Currently, the Internet of Things (IoT) is missing a universal operating system for multiple diverse use cases, which contains all necessary functionalities for the setup of marketplaces including the connection and integration with encapsulated cyber-physical systems (CPS) and technologies (sensors and actuators) as SmartServices. Data management and memory for sensors and actuators are implemented on the basis of FIWARE technology, e.g. FIWARE Context Broker. \nSmartOrchestra enables a uniform service description and secure &amp; safe internet-based composition and integration of heterogeneous cyber-physical Systems and services based on the standardized cloud- and orchestration technologies.</p>\n<p>The open SmartOrchestra Platform allows the safe combination and orchestration of smart services for cyber-physical applications as well as their effective marketing. The aim of SmartOrchestra is the creation of/ creating  an open and standardized service platform for the utilization of public administrative and business-related services.\nSmartOrchestra takes the trustworthy marketplace as a paradigm to design, provide, and  market these services. The integration of existing stand-alone CPS solutions, as well as aggregated sensor data together with actuator/control functionalities are to be offered as component services to third-parties.</p>\n<p>The conceptualized cloud-based service platform paves the way for  combining smart commercial and public services to provide innovative solutions. E.g., smart waste containers which send their filling level data to the municipal waste collection service to allow for  flexible disposal. Thus,  waste management will be more efficient and economical than following a fixed schedule. An open and safe marketplace is to be created to provide, flexibly utilize and combine Smart Services.</p>\n<p>Smart Orchestra serves both as a transparent catalog to evaluate suitable services and also as an operational platform and Interface between control devices and sensor units with their applications. In this way, Smart Orchestra will be an open, secure, and standardized Smart Service Platform. It combines the features of an operational platform, of a marketplace, of a broker, and a notary for a cloud based operation. Thus, the user of cyber-physical systems is free to choose his/her control applications, No matter what is used (smartphone, tablet, or personal computer), the manufacturer’s software is no longer mandatory but optional.</p>\n<p>The marketplace provides suitable general user interfaces on the basis of generic APIs to allow the usage of the software across multiple devices. The open SmartOrchestra platform allows for the secure connection/combination of cyber-physical applications as Smart Services, their orchestration, and effective marketing. Hence, new and smart business models can be facilitated</p>',
      challenge: '',
      references:
        '<p>SmartOrchestra is used on the basis of StoneOne´s S1 IoT Platform in other IoT scenarios and can be adapted or expanded as part of piloting and projects</p>',
      awards: '',
      technologies: ['Internet of Things', 'Cyber Physical Systems'],
      domains: ['Cities'],
      docs: [],
      videos: [
        [
      ...
      featuredImage:
        'https://stoneone.de/wp-content/uploads/2021/02/SmartOrchestra_Pad.png',
      furtherImages: '',
      related: [
        {
          category: 'Services',
    ...
    'stratio-stratioautomotive': {
      ...
      organisationEmail: 'mailto:innovation@stratioautomotive.com',
      linkedIn: 'https://www.linkedin.com/company/stratioautomotive/',
      twitter: 'https://twitter.com/stratio_?lang=en',
      productWebsite: 'https://stratioautomotive.com',
      excerpt:
        'Stratio Automotive turns vehicle data into an exact science, making the unpredictable predictable.',
      yearOfValidation: 2017,
      description:
        "<p>Stratio has a product for in-vehicle data collection in real-time (Stratio Plug) and a software product for Artificial Intelligence analysis over vehicle data, which allows both engineering problems and malfunctions to be identified and predicted. Stratio's proprietary algorithms work the vehicle sensor data, and extract predictions - measuring components' performance, and detecting wear and faults before they happen: \nImproved Reliability: Proprietary artificial intelligence algorithms predict wear and faults in the vehicle systems.\nBetter operations: Real-time information for operational predictability and superior vehicle uptime.</p>",
      challenge: '',
      references: '',
      awards: '',
      technologies: ['Internet of Things', 'Data Analytics', 'Open Data'],
    ...
    'tablegrabber-rezguru': {
      ...
      organisationEmail: 'mailto:info@tablegrabber.com',
      linkedIn: '',
      twitter: 'https://twitter.com/rezguru',
      productWebsite: 'http://www.rezguru.com',
      excerpt:
      ...
      yearOfValidation: 2018,
      description:
        '<p>We have created a product that will help you to manage your restaurant efficiently, allowing restaurants to optimize their capacity utilization and maximize their revenues.</p>\n<p>RezGuru digitizes  restaurants with a Global Distribution System and open APIs. It offers automated pricing based on demand and supply for revenue maximization. The solution eliminates the need for pagers and buzzers with IVR and SMS paging systems. Lastly, it can help users transform their data into meaningful and useful information.</p>',
      challenge:
        '<p>The main goal of RezGuru is to adjust things such as reservation availability and pricing in a way that maximizes the revenue of a restaurant.</p>',
      references: '<p>B2B Restaurants</p>',
      awards: '',
      ...
      materials: [
        [
          'Reference 1',
          'https://techcrunch.com/2014/09/09/tablegrabber-resguru-disrupt-launch'
        ]
      ],
      logo:
    ...
    'teamdev-wisetown': {
      ...
      productWebsite: 'https://wise.town/en/',
      excerpt:
      ...
      yearOfValidation: 2014,
      description:
        '<p>WiseTown is a middleware solution that processes and analyzes a large amount of data, giving then back to the operators only the information useful to solve a specific issue, in order to avoid time, money, and waste of resources. It is an infrastructure that is highly modular, interoperable, cloud open-source, that uses the most advanced FIWARE technologies, with the aim of facilitating the transition of cities into smart cities, so that they can adhere to the most innovative European standards, other than increasing their safety, inclusivity, sustainability.</p>\n<p>The smart city tools provided by WiseTown are customizable modules that make up the platform:</p>\n<p>·        WiseTown Geoanalytics: a Decision Support System available to city administrators and public administration professionals. Maps, graphs, infographics, and statistics highlight valuable information and provide an extrapolation of complex information useful for more informed urban planning.\n·        WiseTown Issue Manager: a digital system that enables citizens to support the city government by reporting city issues; at the same time it simplifies the internal workflow of the public administration by automating processes and improving the work of the operators.\n·        WiseTown Open Data Manager: searches and aggregates data on customizable criteria to produce Open Data catalogs for the Smart City. WiseTown software makes Public Administration data a common good, anonymous, and GDPR compliant.\n·        WiseTown Situation Room: a platform for the management of events and emergencies in an urban context. The tool collects the data produced by the city and displays it through a dashboard that ensures immediate analysis and response.\n·        WiseTown Crowd Planning: the platform that allows Public Administration to activate communication with citizens regarding planning objectives, with the ultimate goal of generating active involvement. A tool developed for participatory urban planning.\n·      WiseTown Thematic Dashboard: an application that allows you to create custom visualizations to compare map information with statistical data and real-time data from satellite systems. The dashboards can manage economic, demographic, social, environmental, and many other data.</p>',
      challenge:
        '<p>Every municipality is usually already equipped with a wide range of devices and sensors, but the results of all these technologies are almost wasted so far, as they become a huge amount of unrelated data, too complicated to process, which turns out to be a significant waste of time, money, and resources.\nTherefore, what they require is a technological system that guarantees an efficient collection and management of city data, with the integration of IoT services and technologies, a decision support system, and other tools to promote the active participation of citizens. Most importantly, the goal is to have a digital infrastructure capable of integrating the technologies already implemented in the municipality, making them more efficient and useful for all the stakeholders involved in the public sector (professionals, workers, and citizens).</p>',
      references:
        '<p>Public administration, cities, energy utilities, smart water, public safety industries, natural resource management</p>',
      awards:
        '<p>2020:· Best Civic Tech Startup at South Europe Startup Awards\n2019:·  WiseTown Situation Room top platform finalist of Smart City – Smart Idea Award at Gitex Award – Dubai 2nd place in Enhanced Data at IoMOBILITY Awards\n2018:  WiseTown Virtual Situation Room awarded at Government Innovation Award\n·        Member of the month Assintel (Associazione Nazionale Imprese ICT)\n·        Best startup for Intermodal Mobility at Connected City – Torino\n2017: Top project of 2nd call EIT Digital scale-up project </p>',
      technologies: [
        'Artificial Intelligence',
        'Big Data',
        'Cloud Computing',
      ...
      materials: [
        [
          'Reference 1',
          'https://www.fiware.org/2021/11/15/perugias-digital-transition-to-smart-city-powered-by-fiware-technology/ Press Release;'
        ],
        [
          'Reference 2',
          'https://www.linkedin.com/company/wisetown/posts/?feedView=articles&viewAsMember=true'
        ],
        ['Reference 3', 'https://www.fiware.org/success-stories/wise-town/'],
        [
          'Reference 4',
          'https://www.fiware.org/2018/09/06/wisetown-situation-room-platform-based-on-fiware-tech-used-to-monitor-the-4th-of-july-celebration/'
        ]
      ],
      logo:
    ...
    'teamdev-wisetowncrowdplanning': {
      ...
      linkedIn: 'https://www.linkedin.com/company/wisetown',
      twitter: 'https://twitter.com/WiseTownProject',
      productWebsite: 'https://wise.town/en/cities/participatory-planning/',
      excerpt:
        'WiseTown Crowd Planning is the platform that allows Public Administration to activate communication with citizens regarding planning objectives, with the ultimate goal of generating active involvement. A tool developed for a participatory urban planning.',
      yearOfValidation: 2014,
      description:
        '<p>WiseTown Crowd Planning is the platform that allows the Public Administration to activate communication with citizens regarding planning objectives, with the aim of generating active involvement.\nThe tool allows to publish, in specific thematic areas, urban development plans accompanied by illustrative cartographic data, information sheets and multimedia content. Citizens will be able to use the platform to interact with the Public Administration by proposing their own views on the proposal and animating a real participatory planning process. Administrative action is considerably more effective if it is shared.\nThe implementation of territorial improvement policies must be accompanied by a process of gathering needs and sharing strategies so that all citizens feel like protagonists of the city in which they live.</p>',
      challenge:
        '<p>Collaboration between citizens and government institutions begins with the adoption of a platform that encourages social initiative and participation by the population. Local governments benefit greatly as they welcome citizen input and increase trust in administrative action.</p>',
      references:
        '<p>Public administration, cities, energy utilities, smart water, natural resource management</p>',
      awards: '',
      technologies: [
        'Cloud Computing',
        'Communication Networks',
      ...
      materials: [
        [
          'Reference 1',
          'https://www.fiware.org/2021/11/15/perugias-digital-transition-to-smart-city-powered-by-fiware-technology/'
        ]
      ],
      logo:
    ...
    'teamdev-wisetowngeoanalytics': {
      ...
      linkedIn: 'https://www.linkedin.com/company/wisetown',
      twitter: 'https://twitter.com/WiseTownProject',
      productWebsite: 'https://wise.town/en/cities/decision-support-system/',
      excerpt:
        'WiseTown GeoAnalytics is a Decision Support System available to city administrators and public administration professionals. Maps, graphs, infographics and statistics highlight valuable information and provide an extrapolation of complex information useful for more informed urban planning.',
      yearOfValidation: 2014,
      description:
        '<p>WiseTown GeoAnalytics is a digital platform based on customized dashboards and integrates data collected by IoT sensors, GIS (Geographical Information System) data, information from city portals and various applications to create a tool to support city intervention strategies.\nThe DSS platform (Decision Support System) is able to analyze city data and show correlations between different phenomena, thanks to the use of included cartographic maps and the possibility of superimposing information from different information streams.\nMaps, graphs, infographics and statistics highlight valuable information and provide an extrapolation of complex information useful for more informed urban planning.</p>',
      challenge:
      ...
      materials: [
        [
          'Reference 1',
          'https://wise.town/en/portfolio-items/water-point-mapping/'
        ],
        [
          'Reference 2',
          'https://www.fiware.org/2021/11/15/perugias-digital-transition-to-smart-city-powered-by-fiware-technology/'
    ...
    'teamdev-wisetownissuemanager': {
      ...
      yearOfValidation: 2014,
      description:
        '<p>WiseTown Issue Manager is the digital system that creates a direct link between the municipal administration and citizens. The module consists of two main elements: a reporting tool for citizens and a workflow management software for reporting by the public administration.\nOn the citizen’s side, WiseTown Issue Manager is a smartphone app – available for both IOS and Android – through which they can report problems in the city to their administration: breakdowns, malfunctions, damaged goods and so on. The report of the criticality generates a task to be assigned to the right department of the administration.\nOn the Public Administration side, WiseTown Issue Manager is a report management software that simplifies collection and automates internal management by improving staff workflow. Each issue generated by the report is converted into a task and assigned. The fully automated process avoids the use of additional resources for sorting reports, optimizes response times to critical issues, facilitates the planning of interventions and provides immediate feedback to the citizen.</p>',
      challenge:
        '<p>The lack of resources and staff means that the administration is unable to monitor every place at all times and then to act quickly in case of critical issues: this breaks the relationship of trust with citizens. Moreover, reports from citizens, if not optimally managed, represent an obstacle to the ordinary work of the operators.</p>',
      references:
        '<p>Public administration, cities, energy utilities, smart water, public safety industries, natural resource management</p>',
      awards: '',
      technologies: [
    ...
    'teamdev-wisetownsituationroom': {
      ...
      linkedIn: 'https://www.linkedin.com/company/wisetown',
      twitter: 'https://twitter.com/WiseTownProject',
      productWebsite: 'https://wise.town/en/cities/city-monitoring/',
      excerpt:
        'WiseTown Situation Room is a platform for the management of events and emergencies in an urban context. The tool collects the data produced by the city and displays it through a dashboard that ensures immediate analysis and response.',
      yearOfValidation: 2014,
      description:
        '<p>WiseTown Situation Room responds to the need for administrations to monitor city events, mobility flows and emergency situations in real-time, with the aim of safely managing urban dynamics.\nThe basis of the WiseTown platform is the huge amount of data produced by the monitored phenomena. The data collected comes from various sources: video surveillance systems, dedicated apps, IoT sensor data, video cameras, the web, geo-referenced social data and more. The control room collects and aggregates the “situation” data and uses them as tools to make and implement operational decisions in a short time.\nThe data is then displayed in a single dashboard in which the central element is the map of the area, complemented by information boxes, media streams and customized statistics. The dashboard provides a visualization of the data that ensures immediate analysis and response.</p>',
      challenge:
        '<p>The control of an event or an emergency situation in a city requires a great deal of energy and resources for a public administration. It requires a large amount of field staff, adequate tools, and a budget; a control room for Smart City allows an effective and sustainable remote monitoring.</p>',
      references:
        '<p>Public administration, cities, energy utilities, smart water, public safety industries, natural resource management</p>',
      awards: '',
      technologies: [
      ...
      materials: [
        ...
        [
          'Reference 2',
          'https://www.fiware.org/news/eurochocolate-2018-visitors-flow-will-be-monitored-with-situation-room/'
        ],
        [
          'Reference 3',
          'https://www.fiware.org/2021/11/15/perugias-digital-transition-to-smart-city-powered-by-fiware-technology/'
        ...
        [
          'Reference 4',
          'https://wise.town/en/portfolio-items/smart-security-app/'
        ]
      ],
      logo:
        'https://www.fiware.org/style/imgs/Marketplace/product/powered-by-fiware/solution/logo_WiseTown.svg',
    ...
    'teamdev-wisetownthematicdashboard': {
      ...
      linkedIn: 'https://www.linkedin.com/company/wisetown',
      twitter: 'https://twitter.com/WiseTownProject',
      productWebsite: 'https://wise.town/en/cities/city-dashboard/',
      excerpt:
        'WiseTown Thematic Dashboard is an application that allows you to create custom visualizations to compare map information with statistical data and real-time data from satellite systems. The dashboards can manage economic, demographic, social, environmental and many other data.',
      yearOfValidation: 2014,
      description:
        '<p>WiseTown Thematic Dashboard is an application that creates customized views to compare cartographic information with statistical data and real-time data from satellite systems. All dashboards offer the highest degree of configurability and allow effective analysis of urban phenomena. Among the many possibilities, there are time-lapse satellite dashboards for comparing the evolution of the phenomenon over time; dashboards for analyzing public parks and gardens for reports on health of plants and vegetation; dashboards on the degree of urban land consumption; dashboards with social and economic data on the population; dashboards on quality of life indicators; dashboards on the analysis of mobility flows; dashboards for monitoring the safety of the city and the territory.\nOur interactive dashboards are map-based and contain statistical data analysis boxes with the ability to activate filters and selections to differentiate the display of information.</p>',
      challenge:
        "<p>Awareness of the city's needs starts with a correct understanding of what is happening. Visualizing data on a map, facilitated by selected graphs and statistics, is essential to get inside the complexity of reality.</p>",
      references:
        '<p>Public administration, cities, energy utilities, smart water, public safety industries, natural resource management</p>',
      awards: '',
      technologies: [
    ...
    'telefónica-thinkingcities': {
      ...
      organisationWebsite:
        'https://www.thinkingcities.com/thinking-cities-platform/home/',
      organisationEmail: 'mailto:info@h3bm.com',
      linkedIn: 'https://www.linkedin.com/company/thinking-cities/about/',
      twitter: 'https://twitter.com/ThinkingCities',
      productWebsite:
      ...
      yearOfValidation: 2016,
      description:
        '<p>The Thinking Cities platform is an integral solution to support City services. It includes a series of modules that allow the acquisition, processing, storage, and distribution of data, on which several City Services, vertical IoT solutions,and Data Analytics can be implemented easily. This platform is based on the standards, and interfaces developed within the framework of the European FIWARE initiative\nThe functionality of  Telefonica’s Thinking Cities platform focuses on the lifecycle of the data related to the service and aspects related to the client’s part. In this sense, four main groups of the case of use can be distinguished:\nData insertion in the platform: acquisition of data from sensors and external systems to be stored on the platform.\nData transformation in the platform: operations carried out in the platform with the data available to generate new data.\nQuery of data of the platform - Visualization and extraction of data stored on the platform, either by end-users or by other modules.\nSending data from the platform - Sending notifications or commands as a consequence of data entry on the platform or administrative tasks.\nThe main modules of this platform are:</p>\n<p>1) IoT Agents. This component collects all the observations that come from the devices and transforms them into NGSi events available in the Context Broker. In this way, applications can consume information from observations from the devices and send commands (in the case of devices that support this functionality).\n2) Context Broker (Orion) The Context Broker is a module that retrieves, maintains, and introduces context information within the platform. It is an implementation of the Generic Enabler Publish / Subscribe Context Broker defined in FIWARE, providing NGSI interfaces.\n3) NGSI Data Adapter (Cygnus) Cygnus is the component that is responsible for processing the data sent by the Context Broker in its notification format and adapting them to the different sinks of the platform, such as MySQL, CKAN, Hadoop, or Mongo.\n4) Open Data Portal (CKAN) CKAN is a tool for open data web portals. Facilitates the management and publication of data collections. It is widely used by national, regional and local governments, research centers and other organizations that accumulate large amounts of data.\n5) Short-term historic (STH) Allows the storage of data processed by the Context Broker and allows its subsequent recovery both in the form of raw data and aggregated data.\n6) Analytical database (ADB) Makes the data stored internally on the platform available to the presentation layer.\n7) Business Intelligence (BI) Main part of the presentation layer.\n8) Extract, Transform and Load information tools (ETL, ESB) Because there is data stored in external sources that have to be loaded in the platform, there are two modules in charge of obtaining information from these sources, transforming it into a format compatible with the platform and storing it in the different data sinks.\n9) Complex Event Processor (CEP) Analyzes data coming from events in real-time, infers insights immediately and makes possible an instantaneous response to changing conditions.\n10) Bid Data Analysis (Hadoop) Free code framework for the storage and large-scale processing of datasets in consumer hardware clusters.\n11) Identity Manager, Policy Enforcement, Policy Administration (IDM&amp;AUTH) Identity management, authentication and authorization scheme based on three main elements (IDM, PEP, and PAP/PDP).\n12) Administration portal. The administration portal provides a user interface to facilitate certain operations of the platform such as the creation of services, sub services, and users as well as the administration of entities, devices, subscriptions, and rules of each one of the services discharged.</p>',
      challenge:
        '<p>Smart Valencia VLCi - Ajuntament de Valencia\nSmart Santander STDRi - Ayuntamiento de Santander\nSmart Guadalajara - Ayuntamiento de Guadalajara\nSmart Región Andalucía - Junta de Andalucía\nSmart ALBA - Ayuntamiento de Almendralejo y Badajoz\nSmart Toledo - Ayuntamiento de Toledo\nAjuntament de Calvià (Mallorca)\nMálaga Smart City - Ayuntamiento de Málaga\nTechnoport 2025 - Puerto de Sevilla\nBadajoz Es Más - Diputación de Badajoz\nTerritorio Rural Inteligente - Junta de Castilla y León\nAyuntamiento de Cartagena\nSmart Vigo Ciudad Inteligente VCI+ - Ayuntamiento de Vigo\nLanzarote Smart Island Reserva Inteligente de la Biosfera – Cabildo de Lanzarote\nSmart Island Mallorca - Consell de Mallorca\nMi Murcia - Ayuntamiento de Murcia\nAyuntamiento de Benidorm\nUniversidad de Málaga\nUniversidad de Cádiz\nAyuntamiento de Rota\nLa Nucía Smart Sport\nSalamanca Tormes+\nDiputación de Castellón – Smart Villages\nFuerteventura Open Island\nSmart La Palma\nDTI Diputación de Cádiz\nAlcoi Smart City\nDTI Diputación Ourense\nAyuntamiento de Calpe\nSmart Destination Puerto de la Cruz\nSmart Región Murcia\nLa Manga 365 (DUSI - Smart Region)</p>',
      references:
        '<p>Awards associated with some of the projects developed like "VLCi" project (Ajuntament de Valencia), "Territorio Rural Inteligente" project (Junta de Castilla y León) and "Badajoz Es Más" project (Diputación de Badajoz):</p>\n<p>2021\nEnerTIC Awards 2021 - Categoria Smart Mobility: EDUSI LA MANGA 365\n2020\nEnerTIC Awards 2020 - Categoria Intelligent Territories: Smart Island Mallorca\nEnerTIC Awards 2020 - Categoria Smart Cities: Castellon Smart Villages</p>\n<p>2019\nEnerTIC Awards 2019 - Lanzarote Smart Island Reserva Inteligente de la Biosfera\nEnerTIC Awards 2019 - Categoria Smart IT Infrastructure: Sistema unificado de supervisión de infraestructura (SUSI)\nEnerTIC Awards 2019 - Vertical Green en Sector Agro 2.0\nEnerTIC Awards 2019 - Categroia Smart Lighting: XPERIOT\n2018:\nComunicación elegida para el IV Congreso de Ciudades Inteligentes “Impulso VLCi: Despliegue IoT y Extensión del proyecto Valencia SmartCity”\nPremios IDC 2018 – Candidatura: “VLCi Project”\nEnerTIC Awards 2018 - Categoría Smart eGovernment: Territorio Rural Inteligente\nEnerTIC Awards 2018 - Categoría Smart Cities: Badajoz Es Más\n2017:\nIX Premios Aslan, Servicios al Ciudadano (VLCi)\nComunicación elegida para el III Congreso de Ciudades Inteligentes “Consolidación Proyecto VLCi en el marco de Valencia Ciudad Inteligente”\n2016:\nIV Edición Premios EnerTIC, mejor proyecto (VLCi)\nIV Edición Premios EnerTIC, mejor proyecto SmartCities (VLCi)\nIV Edición Premios EnerTIC, mejor proyecto SmartSustainability (VLCi)\nComunicación elegida para el II Congreso de Ciudades Inteligentes “Plataforma Valencia Ciudad Inteligente (Plataforma VLCi): primeros resultados”\n2014-2015:\nFinalista premios CNIS, mejor proyecto Smart Cities (VLCi)\nPremio Noche de las Telecomunicaciones (Valencia), mejor proyecto innovador (VLCi)\nComunicación elegida para el I Congreso de Ciudades Inteligentes “Estrategia Valencia Ciudad Inteligente (VLCi) y Plataforma VLCi basada en Fi-Ware”\nPremios SOCINFO Comunidad Valenciana, Mejor proyecto SmartCities (VLCi)</p>',
      awards: '',
      technologies: [
        'Artificial Intelligence',
        'Big Data',
      ...
      videos: [
        ['Media 1', 'https://www.youtube.com/watch?v=KGzaEAOt1Q0'],
        ['Media 2', 'https://www.youtube.com/watch?v=mZ8KqoCTIZY'],
        ['Media 3', 'https://www.youtube.com/watch?v=3xUDPeRx0t8'],
        ['Media 4', 'https://www.youtube.com/watch?v=ct-2Ya_oE6M'],
        ['Media 5', 'https://www.youtube.com/watch?v=mbBkWl1d0x8']
      ],
      materials: [
        [
          'Reference 1',
          'https://aunclicdelastic.blogthinkbig.com/seccion/sociedad-digital/ciudades-inteligentes/'
        ],
        ['Reference 2', 'https://blogthinkbig.com/onlife/santander-smart-city'],
        [
          'Reference 3',
          'https://www.telefonica.com/en/web/public-policy/crecimiento-economico/smart-cities'
        ],
        [
          'Reference 4',
        ...
        [
          'Reference 5',
          'https://www.masquenegocio.com/2016/11/15/telefonica-smart-city/'
        ]
      ],
      logo:
    ...
    'telenetgroup-telenettinx': {
      ...
      organisationEmail: '',
      linkedIn:
        'https://www.linkedin.com/company/telenet/?originalSubdomain=be',
      twitter: '',
      productWebsite: 'https://investors.telenet.be/',
      excerpt:
    ...
    'tera-beeta': {
      ...
      organisationEmail: 'mailto:info@beeta.it',
      linkedIn: 'https://www.linkedin.com/company/tera-srl/',
      twitter: 'https://twitter.com/terasrl',
      productWebsite: 'https://www.beeta.it/en/',
      excerpt:
      ...
      materials: [
        [
          'Reference 2',
          'http://www.terasrl.it/it/2016/12/20/122016-stile-sezione-innovazione-tecnologie-meccanica-puglia'
        ],
        ['Reference 3', 'http://www.terasrl.it/it/2017/06/08/08062017-tgcom24'],
        ['Reference 4', 'http://www.terasrl.it/it/2016/11/02/29102016-fax'],
        [
          'Reference 5',
          'http://www.terasrl.it/it/2016/07/04/wp-contentuploads201607engie-tera-jpg'
        ]
      ],
      logo:
    ...
    'tracelabs-tracelabs': {
      ...
      organisationEmail: '',
      linkedIn: 'https://www.linkedin.com/company/trace-labs/',
      twitter: 'https://twitter.com/TraceLabsHQ',
      productWebsite: 'https://tracelabs.io/',
      excerpt:
      ...
      challenge:
        '<p>Trace Labs is a core technology builder of the open source OriginTrail protocol for inter-organizational data exchange. The Network Operating System (nOS) powered by OriginTrail empowers you to quickly set up data sharing focused blockchain use cases by performing quick network and node provisioning, setting up  consortia and their interactions with the various networks, public or private. Powered by OriginTrail protocol, nOS allows you to rapidly build solutions for the common good of the entire value chain end-to-end, by utilizing globally utilized data standards (GS1, Web of Things…), existing IT infrastructure and state of the art DLT/ blockchain technologies such as Hyperledger Fabric and Ethereum. nOS integrates with Oracle Blockchain Cloud Service, IaaS and ERP systems, as well as interoperates with all other major ERP and cloud providers. Core features of the nOS include network deployment, ERP integrations, consensus check, and supply chain mapping.</p>',
      references:
        '<p>Perutnina Ptuj: www.perutnina.com\nOneAgrix www.oneagrix.com\nDairy Celeia: www.zelenedoline.si\nNatureta: www.natureta.si</p>',
      awards:
        "<p>Texas (Austin) Food + City Challenge Prize Event 2017: People's Choice Winner https://www.foodandcity.org/2017-prize-summary/\nFinish Fiware Accelerator 2016 Winner (top 3 accelerated companies)\nWalmart Food Safety Collaboration Center: Food Safety Innovation Spark Award 2017 (+ accepted to its Innovation Pipeline)</p>",
      technologies: ['Internet of Things', 'Data Analytics'],
      domains: ['Logistics'],
      docs: [
      ...
      materials: [
        ...
        [
          'Reference 2',
          'https://www.theguardian.com/odine-partner-zone/2016/nov/24/winners-of-eighth-odine-call-announced'
        ],
        [
          'Reference 3',
          'http://www.foodnavigator.com/Market-Trends/Turn-traceability-into-a-marketing-tool-say-creators-of-farm-to-fork-smartphone-app?utm_content=buffer9a74e&utm_medium=social&utm_source=twitter.com&utm_campaign=buffer'
        ],
        [
          'Reference 4',
          'https://www.forbes.com/sites/tannermark/2018/08/01/blockchain-china-misunderstandings/#16315b5813c8'
        ],
        [
          'Reference 5',
          'https://cointelegraph.com/news/uk-standards-institution-partners-with-blockchain-startup-for-supply-chain-compliance'
        ]
      ],
      logo:
        'https://www.fiware.org/style/imgs/Marketplace/product/powered-by-fiware/solution/logo_TraceLabs.svg',
      featuredImage:
        'https://pbs.twimg.com/profile_banners/1110096896549376000/1642074819/1500x500',
      furtherImages: ''
    },
    'tsenso-freshindex': {
      category: 'Powered by FIWARE',
      ...
      organisationEmail: 'mailto:info@tsenso.com',
      linkedIn: 'https://www.linkedin.com/company/tsenso/?originalSubdomain=de',
      twitter: '',
      productWebsite: 'https://freshindex.eu/',
      excerpt:
      ...
      yearOfValidation: 2018,
      description:
        '<p>Most foods have a longer shelf-life than we think and with tsenso, you will learn how long this shelf life exactly is – depending on the temperatures at which the product was stored and transported along the entire supply chain. We call it the “Fresh Index”, the new real-time shelf-life indicator for food. With the tsenso cloud, all temperature data along the supply chain are linked centrally. This creates a complete temperature history of the products – from the producer to the distribution and in long-term also to refrigerators at home. We develop the fresh index in collaboration with specialists: We have initiated cooperations with researching universities and experienced software experts. For field tests, we reach out to commerce and logistics businesses. With the help of the Fresh Index, you can always assess whether a food is safe and suitable for sale and consumption. In online grocery stores, it offers a quick overview of the freshness of perishable products.</p>\n<p>The Fresh Index is the new “expiry” date for food in place of the static best before date. It is not printed but can be read out via an app and displayed digitally, e.g. on digital price tags and in online grocery stores. This keeps it dynamic: As long as the product is temperature-monitored, the index is updated automatically. The fresh index indicates how fresh the product is. The higher the number, the fresher the food is, and the longer its shelf life is. The freshness data of the product is stored in the tsenso cloud and can be retrieved at any time. Along the food supply chain, this means that on arrival it can be checked immediately in what condition the goods are. For this application, we develop an app. Especially in online food stores,  proof of the quality of perishable products is important. The Fresh Index increases transparency and strengthens customer confidence.</p>\n<p>For retailers and their References/Customers, the Fresh Index offers the advantage of being able to read the actual shelf life of products. The “first expired, first-out” principle is optimized: what is going to expire first is sold first. Particularly fresh products can be promoted via the Fresh Index. And food which should be consumed soon can be easily identified and saved, e.g. with special offers.</p>\n<p>We all know this case: sometimes we find an old, expired product in the refrigerator and are not sure – can I still eat it? The answer is usually: yes. But often this is not visible and we rarely rely on our eyes and nose. Who wants to take a risk? In the long term, we at tsenso want to bring the Fresh Index to the refrigerators at home. By app or the smart fridge, the index will then show the true freshness and safety of food.</p>\n<p>The temperature has a significant impact on food safety and shelf life. The tsenso cloud solution reliably monitors the cold chain. Special feature: the solution can be integrated into existing processes without additional infrastructure. tsenso offers two options:</p>\n<p>1.) Complete solution: Temperature cloud as well as the tsenso Bluetooth sensors to read out temperature data within seconds. \n2.) Cloud solution: Temperature cloud for a detailed evaluation of existing temperature data. Increase transparency and security while reducing food loss along your supply chain.\nWe link the temperature data of the individual sections, such as production, logistics, storage, retail, and delivery service. This results in an individual temperature history for each product.</p>\n<p>Based on the complete temperature history and the characteristics of the individual product, we can calculate the food safety respectively the expected shelf life. This is used to check whether the safety has actually been influenced by temperature fluctuations and whether the food is still suitable for sale and consumption. For this complex analysis, we have initiated cooperations with several universities, researching food safety for years. The complex data from the simulation is combined and translated into a simple number: the Fresh Index. This index shows at a glance how fresh and safe a product is. It is calculated in real-time and updated as the temperature conditions change.</p>',
      challenge:
      ...
      materials: [
        [
          'Reference 1',
          'https://katanareward.opencircleproject.com/campaign/118/longer-shelf-life-and-less-food-waste-with-livingfoods'
        ],
        [
          'Reference 2',
          'https://www.baden-wuerttemberg.de/de/service/presse/pressemitteilung/pid/kretschmann-empfaengt-ausgezeichnete-orte-2017-aus-baden-wuerttemberg/'
        ],
        [
          'Reference 3',
          'https://www.baden-wuerttemberg.de/de/service/presse/pressemitteilung/pid/kretschmann-empfaengt-ausgezeichnete-orte-2017-aus-baden-wuerttemberg/'
        ...
        [
          'Reference 4',
          'https://inform.tmforum.org/data-analytics-and-ai/2017/03/get-rid-food-wastage-data-analytics/'
        ]
      ],
      logo:
        'https://www.fiware.org/style/imgs/Marketplace/product/powered-by-fiware/solution/logo_Tsenso.svg',
      featuredImage:
        'https://scontent-frx5-1.xx.fbcdn.net/v/t1.6435-9/67787561_2327469557369192_7880893769841639424_n.jpg?_nc_cat=110&ccb=1-7&_nc_sid=730e14&_nc_ohc=auP7Pe1BpkkAX9FDicn&_nc_ht=scontent-frx5-1.xx&oh=00_AT--nnof34fItRU3fb-IdEgVcduwmHL-3fHJ-Fp4hkWwsA&oe=630508FF',
      furtherImages: ''
    },
    'ubikwa-insylo': {
      category: 'Powered by FIWARE',
      ...
      productWebsite: 'http://www.insylo.com/',
      excerpt:
      ...
      materials: [
        [
          'Reference 1',
          'http://www.rtve.es/alacarta/videos/fabrica-de-ideas/fdiinvierte-ubikwa/3835464/'
        ],
        [
          'Reference 2',
          'http://www.ara.cat/tecnologia/Insylo-grangers-controlar-sitges-MWC_3_1527477242.html'
        ],
        [
          'Reference 3',
          'http://www.irishexaminer.com/farming/news/tech-device-places-order-when-feed-bin-needs-refilling-387906.html'
        ],
        ['Reference 4', 'https://www.youtube.com/watch?v=ck6VKKisHb8'],
        [
          'Reference 5',
          'http://ebn.be/index.php?lnk=K2tiZmlkaWp5MVZzVWF6SzFUWkpHK0k1VW50bEQyc2hOaE53MEFwUFBOTT0='
        ]
      ],
      logo:
    ...
    'ubiwhere-smartlamppost': {
      ...
      productWebsite:
        'https://www.ubiwhere.com/en/products/smart-cities/smart-lamppost',
      excerpt:
    ...
    'ubiwhere-urbanplatform': {
      ...
      linkedIn: 'https://www.linkedin.com/company/ubiwhere/',
      twitter: 'https://twitter.com/ubiwhere',
      productWebsite: 'https://urbanplatform.city/',
      excerpt:
        'Our Urban Platform allows data collection from multiple domains and provides city managers and decision-makers with a holistic view of their cities, presenting cross-domain data in a unified way.',
      yearOfValidation: 2018,
      description:
        "<p>Our Urban Platform allows data collection from multiple domains such as traffic, air quality, and waste collection, displaying it in a unified way. Having information from different fields combined in a single, customizable dashboard, enables municipalities to get the information they need to create informed, data-driven policies. This way, decision-makers can ensure that the decisions they take are well-founded and get empirical reports on their impact.\nOur end-users can set their customized dashboards, choosing the information from any source available and combining it through different domains such as mobility, environment and public policies, with the ultimate purpose of reducing operational costs, reducing greenhouse gasses emissions, and improving their citizens' overall quality of life.</p>",
      challenge: '',
      references:
        '<p>City of Porto\nCity of Guimarães\nCity of Évora \nCity of Helsinki \nCity of Granada</p>',
      awards: '<p>Best practice Award by the European Commission ,WSA 2021</p>',
      technologies: ['Internet of Things', 'Open Data', 'Data Analytics'],
      domains: ['Cities'],
      docs: [
        [
      ...
      materials: [
        ...
        [
          'Reference 2',
          'https://ec.europa.eu/digital-single-market/blog/fiware-making-cities-smarter'
        ],
        [
          'Reference 3',
          'http://smart-cities.pt/pt/noticia/75-cidades-partilham-dados-no-fiware9/'
        ]
      ],
      logo:
    ...
    'universityofdeusto-waste4think': {
      ...
      organisationEmail: 'mailto:ainhoa.alonso@deusto.es',
      linkedIn: 'https://www.linkedin.com/groups/8462545/',
      twitter: 'https://twitter.com/waste4think',
      productWebsite: 'http://waste4think.eu',
      excerpt:
      ...
      yearOfValidation: 2017,
      description:
        '<p>The main objective of Waste4Think is to move forward the current waste management practices into a circular economy motto demonstrating the value of integrating and validating 20 eco-innovative solutions that cover all the waste value chain. The benefits of these solutions will be enhanced by a holistic waste data management methodology and will be demonstrated in 4 complementary urban areas in Europe.\n Attached to this main objective a set of specific ones have been defined to indicate what the project will be focused into:</p>\n<ul>\n<li><p>To reduce generation of waste thanks to prevention campaigns and cooperative activities to promote reuse and eco-design solutions.</p></li>\n<li><p>To promote behavioural changes in the waste generators by awareness campaigns and new educational tools in order to foster more sustainable consumption and production habits and to increase the rate of waste sorting. </p></li>\n<li><p>To improve the integral waste management services reducing their management costs and the GHG (greenhouse gas) emissions. </p></li>\n<li><p>To reduce the amount of primary waste deposited in landfill to zero and to the maximum in case of secondary waste.</p></li>\n<li><p>To identify the waste products with a low potential for recycling and to propose eco-innovative valorisation and production solutions.</p></li>\n<li><p>To assess the transferability to the market of the new proposed eco-innovative solutions.\nExpected impacts Integrating all these solutions we will be able to construct a virtual smart city laying the foundations of the circular economy maximizing the expected results up to:</p></li>\n<li><p>A 8% reduction of waste generation </p></li>\n<li><p>A 10% reduction of GHG emissions </p></li>\n<li><p>20% increment of waste sorting </p></li>\n<li><p>10% savings in the management costs</p></li>\n</ul>',
      challenge:
    ...
    'viur-viur': {
      ...
      organisationEmail: 'mailto:info@viurdata.com',
      linkedIn: 'https://www.linkedin.com/company/viur/about/',
      twitter: 'https://twitter.com/viurdata',
      productWebsite: 'https://www.viurdata.com',
      excerpt:
      ...
      yearOfValidation: 2017,
      description:
        '<p>Viur connects all your databases, cloud services, and files and in seconds you can start exploring your data using drag &amp; drop or writing your own SQL queries. Share your most important metrics with your team or with the whole world.</p>',
      challenge:
        '<p>Whether you are the CEO, manager, or developer, there are always questions that need answering. Viur enables you to answer these questions quickly and easily through visualization and data exploration. Leverage analytics to promote information sharing and transparency on the fly.</p>',
      references: '',
      awards: '',
      technologies: ['Data Analytics', 'Open Data'],
      domains: ['Cities'],
      ...
      featuredImage:
        'https://scontent-frt3-1.xx.fbcdn.net/v/t31.18172-8/13173342_1731367883743538_5735969383535102782_o.png?_nc_cat=107&ccb=1-7&_nc_sid=19026a&_nc_ohc=KQMY05uooy8AX-c5UCy&_nc_oc=AQmT3HXBQAQI6HIZzdtUPgDL0zSCI47TdEfOzI8HRWWYL3OSybhyo1L-gmAaDHXY-CU&tn=8vjiMBCSITGGfB_z&_nc_ht=scontent-frt3-1.xx&oh=00_AT8Bl6YF7_o1a7a-BDPn2iCzBoM2KBLAU-wtygpGvreHhA&oe=63086BB3',
      furtherImages: ''
    },
    'vm9-we4city': {
      category: 'Powered by FIWARE',
      ...
      organisationEmail: 'mailto:contact@we4city.com',
      linkedIn: 'https://www.linkedin.com/showcase/we4city/about/',
      twitter: 'https://twitter.com/we4city',
      productWebsite: 'http://www.vm9it.com/#solutions',
      excerpt:
      ...
      yearOfValidation: 2019,
      description:
        '<p>We4City is a powered by FIWARE platform developed by VM9, a Gold Member of the FIWARE Foundation. It is based on open standards and artificial intelligence, which provides integrated support for the Internet of Things (IoT), Real-Time Cameras, Geographic Information Systems, Virtual Assistants, Big Data, and Open Data, among others. From the Smart Data Lakes concept and supported by FIWARE Technologies, the solution allows cities to integrate data silos and produce the most important fuel for Smart Cities: Urban Intelligence. All this means more practicality and dynamism for society and more efficiency for public institutions.</p>',
      challenge: '',
      references:
      ...
      awards:
        '<p>Smart City Expo World Congress SCEWC 2016 in Barcelona, Spain, event where the platform was chosen as top 5 at CALL FOR SOLUTIONS on the governance and economy category.</p>\n<p>Smart City Expo World Congress SCEWC 2016 in Barcelona, Spain, event where the platform was chosen as top 5 at World Smart City Award 2016 - INNOVATIVE GLOBAL SOUTH AWARD category.</p>\n<p>Winners of FIWARE Excellence Challenge on the island of Gran Canaria, Spain. The challenge brought together more than 1,800 projects from 23 countries. VM9 FI-Guardian was presented in the context of smart cities, gathering characteristics related to Internet of Things, Big Data analytics, complex event processing, multimedia services and real time geo-referenced communication.</p>\n<p>Winners of FIWARE Smart Cities Challenge at Campus Party Brazil 2014. The solution consolidates tracking system data, centralizing information from different sources, and carrying out customisable and intelligent remote sensor analysis, communicating risk events to citizens before they occur.</p>',
      technologies: ['Internet of Things', 'Open Data', 'Data Analytics'],
      domains: ['Cities'],
      docs: [],
      videos: [],
      materials: [
        [
          'Reference 1',
          'https://www.fiware.org/2019/04/24/we4city-urban-intelligence-on-top-of-smart-date-lakes-in-brazil/'
        ],
        [
          'Reference 2',
          'https://www.fiware.org/2016/07/28/reimagining-the-city-as-platform-how-vm9-are-reimagining-what-cities-can-do/'
        ],
        ['Reference 3', 'http://novafriburgo.cityasplatform.info/'],
        [
          'Reference 4',
          'https://www.smarter-together.eu/news/gathering-outputs-smart-data-vienna'
        ],
        [
          'Reference 5',
          'https://ec.europa.eu/digital-single-market/en/news/finals-fi-ware-challenges-campus-party-2014-brazil'
        ]
      ],
      logo:
    ...
    'witrac-witrac': {
      ...
      organisationEmail: 'mailto:info@witrac.es',
      linkedIn: 'https://www.linkedin.com/company/witracrtls/',
      twitter: 'https://twitter.com/witracrtls?lang=en',
      productWebsite: 'https://witrac.io/en/critical-assets/',
      excerpt:
      ...
      yearOfValidation: 2018,
      description:
        '<p>WiTraC has created a wireless real-time location system (RTLS) for Industry 4.0 and smart cities based on the Internet of Things and Low-Cost Smart Sensors.\nWiTraC provides a B2B advanced solution for the manufacturing industry and smart cities. We have tested and/or sold our solution to Ford, Volkswagen, IBM, Navantia suppliers, Global Steel, etc.\nWith WiTraC, Industries have control of their critical elements (people, assets, materials) and are able to track and measure them with the following advantages: in a secure way (encrypted and bidirectional communication way), in real-time, with multiple applications (location, metering, tracking), with  really low energy consumption, in a cost-competitive way and scalable.</p>\n<p>For instance, in Ford, we tracked cars solving a problem that  our competitors could not achieve with a solution 10 times more expensive than ours. Another company, a Tier 1, saved 20M$ in one-off inventory reduction and 5M$ per year thanks to a solution that combines smart stock and warehouse management.</p>',
      challenge:
        '<p>Increased complexity and uncertainty of the industrial environment make control of assets and resources challenging for industrial companies. Moreover, new VUCA (volatility, uncertainty, complexity and ambiguity) environments have plenty of relevant data to be gathered and controlled in real-time. Thus, companies spend a lot of time, resources, and money to answer  both prior challenges, while increasing productivity and avoiding risks and losses.\nCurrent market solutions have not found an answer to that problem in an optimized way. They require intense investments, very often use a single protocol or technology not able to face the whole requirements of the client, and most of the time are very difficult to implement in industrial environments (wired and plugged into an energy source).</p>',
      references: '',
      awards: '',
      technologies: [
        'Internet of Things',
    ...
    'yerbabuenavr-ybvr': {
      ...
      organisationEmail: 'mailto:ybvr@ybvr.com',
      linkedIn: 'https://www.linkedin.com/company/ybvr/',
      twitter: 'https://twitter.com/YBVR360',
      ...
      yearOfValidation: 2018,
      description:
        '<p>YBVR is a solution designed to optimize the distribution of quality VR video streaming for every device on any network. ​We are creating VR 360 video streaming technology optimized for any available bandwidth condition. We envision to become the pioneers of real-time VR video platforms supporting massive live events such as sports and concerts.</p>',
      challenge:
        '<p>Among all the different techniques to achieve Virtual Reality immersion, 360 video has a unique value to it: unlike 3D model-based VR, it has the potential of giving a closer sense of “reality” to VR (since the source if it is normally a real camera capture as opposed to a 3-D model) and is also in many technical senses more affordable to render (since it relies on several existing technologies already in people’s hands and imposes lesser requirements to the rendering device). However, the effect of immersion is easily broken if the image perceived by the user is blurred. Unfortunately, this undesired effect is all too common today, mainly due to the inadequate distribution format being used. Optimizing 360 video delivery is the prime focus of the technologies that we at YBVR are creating.</p>',
      references: '',
      awards: '',
      technologies: ['Internet of Things'],
      domains: ['Cities', 'Home'],
  ...
  ready: {
    'agricolus-agricolusecosystem': {
      ...
      yearOfValidation: 2017,
      description:
        '<p>AGRICOLUS DECISION SUPPORT SYSTEM is a composition of several vertical products that leverage  a common architecture, that covers up to 70% of functionalities common to all the crops, and dedicated professional algorithms for disease forecasting and agricultural optimizations. Data are collected through satellites, drones, IoT, dedicated apps, and soon with our own plug&amp;play AgriPlug device that connects tractors and other Precision Farming Devices to AGRICOLUS SaaS cloud. We also provide AGRITRACK: an end-to-end tracking service that can bring information on good agronomic practices directly to the end-users to raise their awareness of the real value of the goods they are buying.</p>\n<p>AGRICOLUS is already on the market and multinational agroholding companies, medium-big farms, association of farmers and government are using it successfully.</p>',
      challenge:
        '<p>Today farmers face several challenges, we are mostly working on:</p>\n<p>International market competition with products coming from unruled countries that produce at a very low cost. The effect is a reduction of the profit due to the need of reducing final selling prices. For this reason, they have to reduce costs and increase quality at the same time.\nClimate change requires continuous adaptation of the best time to proceed with any agricultural operation (seeding, fertilizing, manuring, irrigating, harvesting, …). They need  real-time support to understand the right timing for these operations.\nAgriTech adoption is not an option but average usage in the EU is far below 10% versus 80% of North America and Australia: farmers need a way to integrate these technologies into daily tasks.</p>',
      references:
        '<p>Agro holding companies that want to standardize with AGRICOLUS good practices among their suppliers (farmers)\nAssociation of farmers that want to support their associates with better tools providing high value technologies\nMedium big farms that can reduce costs and have  better control, and an end-to-end traceability of the production\nGovernment in agricultural department that uses our product to raise farmers awareness on diseases and other agricultural treats</p>',
      awards:
    ...
    'axion-traxion': {
      ...
      yearOfValidation: 2020,
      description:
        "<p>Traxión controls entry and occupancy levels through non-intrusive sensors. It integrates with IP cameras with integrated video analysis and has an alarm system and generation of statistics on maximum, minimum, and average values ​​of the capacity in real-time. The alarms can interact with elements from other verticals such as lighting and sound, and even with the private emergency networks of the security forces.</p>\n<p>At the current moment generated by the Covid-19 crisis, the value that this Spanish platform can bring is high: its ability to contribute to monitoring people and movements is a key aspect of the measures to be adopted in the future  in the face of the progressive lack of understanding  the population and the organization and maintenance of social distance.</p>\n<ul>\n<li>Count: number of people crossing a virtual line defined in the system. </li>\n<li>Flow control: detection of a specific direction of movement and its speed, even in a crowd. </li>\n<li>Detection of safety distance (social distancing) </li>\n<li>Occupancy levels: detection of a level of agglomeration in a given area, both in open and closed areas. </li>\n<li>Thermal detection (fever for access) </li>\n<li>Identification of use of protection elements (masks) </li>\n<li>Real-time data: transmitted to the system's administration platform at the moment.</li>\n</ul>\n<p>Customizable presentation interface: Storage, processing, and presentation in customizable</p>",
      challenge:
    ...
    'breezetechnologies-breezeairqualitysensors': {
      ...
      yearOfValidation: 2019,
      description:
        "<p>Breeze Technologies' air quality sensors measure the most common air pollutants and climate indicators every 30 seconds (Temperature, Humidity, CO, CO2, PM2.5, PM10, NO, NO2, SO2, NH3, VOCs, O3). Data can be transmitted to the Breeze Environmental Analytics Cloud through various wireless standards, including WiFi, LTE, and LoRa. The data is calibrated through the ground-breaking Adaptive Cloud Calibration Engine, increasing data quality and accuracy.</p>",
      challenge:
      ...
      references:
        '<p>City of Hamburg, city of Moers, city of Hennef, city of Neckarsulm, city of Vilnius, city of Siegburg, among others</p>',
      awards:
    ...
    'datakorumsolutions-beat': {
      ...
      yearOfValidation: 2018,
      description:
        '<p>This system allows real-time monitoring of the sound level environment using the built-in sound level meter.</p>\n<p>The device behaves like an IoT sensor, establishing between it and the cloud a permanent connection. In addition to showing the noise level on the display, it also allows you to send instantaneous measurements in real-time, being able to set events, alerts, and associated alarms.</p>\n<p>Our controller implements policies that allow a minimum data transfer using LTE-NB communication (NB-IoT).</p>\n<p>Its connection to Datakorum CLOUD is via LTE-NB (NB-IoT) and user applications are available for PC, Android, and IOS.</p>\n<p>Datakorum platform allows our devices to establish point-to-point connections with both our cloud and user applications developed by us or third parties. The implementation of MQTTcommunication and MySQL databases allows fast and easy integration with other platforms.</p>',
      challenge: '',
      references: '',
      awards: '',
    ...
    'datakorumsolutions-cs40': {
      ...
      yearOfValidation: 2017,
      description:
        '<p>The facility manager can switch between local management through the existing thermostat, automatic operation by sensors (temperature, humidity, presence, and lightness), or smart remote management by scheduling, energy-saving policies, and programmable events.</p>\n<p>The air-conditioned facility control can be performed by MODBUS or directly by activating relays. Its connection to E3TGlobal CLOUD is via WiFi and user applications are available for PC, Android, and IOS.</p>',
      challenge: '',
      references: '',
      awards: '',
      technologies: ['Internet of Things', 'Cloud Computing'],
    ...
    'datakorumsolutions-lane': {
      ...
      yearOfValidation: 2018,
      description:
        '<p>Our system allows remote control and monitoring of any new or existing streetlight network. This control is achieved by installing one LANE device just before the lights section we want to command. With one unique device, we can master from one point of light to whole streets.</p>\n<p>LANE controller allows to monitor all electrical parameters of a street lighting electric board. Real-time measures can generate warnings and alarms, fail and theft detection and can be used by any other  energy rate management or facility maintenance applications.</p>\n<p>It also provides 230VAC (NO/NC) relay output and six 12VDC control signals to activate external relays. It can be activated remotely to control board lines on/off switching or electrical board auto-reset.</p>\n<p>Its connection to Datakorum CLOUD is via LTE-NB (NB-IoT) and user applications are available for PC, Android, and IOS.</p>\n<p>Datakorum platform allows our devices to establish point to point connections with both our cloud and user applications developed by us or third parties. The implementation of MQTTcommunication and MySQL databases allows fast and easy integration with other platforms.</p>',
      challenge: '',
      references: '',
      awards: '',
      technologies: ['Internet of Things', 'Cloud Computing'],
    ...
    'datakorumsolutions-lb40': {
      ...
      yearOfValidation: 2017,
      description:
        '<p>Box control is the best choice for installations where lighting must be controlled by groups, where all luminaires behave the same way.</p>\n<p>LB40 controller enables MODBUS communication with three-phase network analyzers and lighting board flow regulators. It also enables communication with any individual streetlight through WiFi.\nLB40 controller allows monitoring all electrical parameters of a street lighting electric board. Real-time measures can generate warnings and alarms, fail and theft detection, and can be used by other  energy rate management or facility maintenance applications.</p>',
      challenge: '',
      references: '',
      awards: '',
      technologies: ['Internet of Things', 'Cloud Computing'],
    ...
    'datakorumsolutions-lc40': {
      ...
      yearOfValidation: 2017,
      description:
        '<p>Individual point-to-point control is the best option for installations where each point of light should behave differently in on/off switching, dimming, energy, and any problem in real-time.</p>\n<p>LC40 line is the easiest element for controlling and monitoring light points. It can switch on/off and dim lighting.</p>\n<p>The equipment allows main electric parameters measuring, fail detection, and on/off switching scheduled programming.</p>\n<p>Optionally, to control the switching you can install a presence or luminosity sensor.</p>\n<p>Its connection to E3TGlobal CLOUD is via WiFi and user applications are available for PC, Android, and IOS.</p>',
      challenge: '',
      references: '',
      awards: '',
      technologies: ['Internet of Things'],
    ...
    'datakorumsolutions-ls40': {
      ...
      yearOfValidation: 2017,
      description:
        '<p>With one unique device, we can master from one point/location of light to whole streets. Its connection to E3TGlobal CLOUD is via WiFi and user applications are available for PC, Android and IOS.</p>\n<p>Individual point to point control is the best option for installations where each point of light should behave differently in on/off switching, dimming, energy, and any problem in real-time.</p>\n<p>The Smart version LS40 also allows setting behavior, alarms and sensors associated events. LS40 line has been thought to transform one point of light into a smart element of the Smart City. With this device in its different configurations we can control on/off switching, dimming, power consumption measuring, air quality measuring, pollution, noise level, temperature, humidity…</p>\n<p>In addition to its point of light main electric parameters measuring, the equipment allows fail, blinking and stealing detection and on/off switching scheduled programming.</p>',
      challenge: '',
      references: '',
      awards: '',
      technologies: ['Internet of Things', 'Cloud Computing'],
    ...
    'datakorumsolutions-mb43': {
      ...
      yearOfValidation: 2017,
      description:
        '<p>MB43 controller allows to monitorize all electrical parameters of an electric board, either monophasic or triphasic. Real time measures can generate warnings and alarms, and can be used by  any othwe energy rate management or facility maintenance applications. It also provides 230VAC (NO/NC) relay output and six 12VDC control signals to activate external relays. It can be activated remotely to control board lines on/off switching or electrical board autoreset.\nReal-time measures can generate warnings and alarms, and can be used by other energy rate management or facility maintenance applications. It also provides connection for 4 external sensors.</p>\n<p>Its connection to e3tglobal CLOUD is via WiFi and user applications are available for PC, Andriod, and IOS.</p>',
      challenge: '',
      references: '',
      awards: '',
      technologies: ['Internet of Things', 'Cloud Computing'],
    ...
    'datakorumsolutions-ms41': {
      ...
      yearOfValidation: 2017,
      description:
        '<p>Real-time measures can generate warnings and alarms, and can be used by any other energy rate management or facility maintenance applications.</p>\n<p>MS41 controller allows monitoring of all electrical parameters of an electric board, either monophasic or triphasic. Real-time measures can generate warnings and alarms and can be used by any other energy rate management or facility maintenance applications.</p>\n<p>It also provides relay outputs and can be activated remotely to control board lines on/off switching or electrical board auto-reset. Its connection to E3TGlobal CLOUD is via WiFi and user applications are available for PC, Android, and IOS.</p>',
      challenge: '',
      references: '',
      awards: '',
      technologies: ['Internet of Things', 'Cloud Computing'],
    ...
    'datakorumsolutions-peak': {
      ...
      yearOfValidation: 2018,
      description:
        '<p>Our system allows remote control and monitoring of any new or existing streetlight network. This control is achieved by installing one PEAK device just before the lights section we want to command. With one unique device, we can master from one point of light to whole streets.</p>\n<p>PEAK line has been thought to transform one point of light into a smart element of the Smart City. With this device in its different configurations, we can control on/off switching, dimming, power consumption measuring, air quality measuring, pollution, noise level, temperature, humidity.</p>\n<p>In addition to its point of light main electric parameters measuring, the equipment allows failing, blinking, and stealing detection and on/off switching scheduled programming.</p>\n<p>Datakorum platform allows our devices to establish point-to-point connections with both our cloud and user applications developed by us or third parties. The implementation of MQTTcommunication and MySQL databases allows fast and easy integration with other platforms.</p>',
      challenge: '',
      references: '',
      awards: '',
      technologies: ['Internet of Things', 'Cloud Computing'],
    ...
    'datakorumsolutions-plug': {
      ...
      yearOfValidation: 2018,
      description:
        '<p>The smart lighting solution consists of a wireless programmable communication device for each light fixture, connecting to the cloud without intermediate points.</p>\n<p>The controller allows the light fitting to be easily turned on and off or adjusted; the main electrical parameters can be monitored, sending warnings if faults are detected. Control is possible by time programming, using motion and/or luminosity sensors, and by manual commands executed from the user application.</p>\n<p>Best Suited for Street Lamps that Meet ANSI C136.41:</p>\n<p>ANSI C136.41 compliant dimming receptacle.\nIP65 waterproof rating.\n230VAC power supply.\nPower consumption measuring.\n1-10V and/or DALI regulation.\nSupports up to 1 external sensor.\nNodes or gateways are not required.\nFull control of data flow.\nConfigurable data storage.\nConfigurable alerts and alarms.\nRemote firmware updates.</p>',
      challenge: '',
      references: '',
      awards: '',
      technologies: ['Internet of Things', 'Cloud Computing'],
    ...
    'datakorumsolutions-pole': {
      ...
      yearOfValidation: 2018,
      description:
        '<p>The smart lighting solution consists of a wireless programmable communication device for each light fixture, connecting to the cloud without intermediate points.</p>\n<p>The controller allows the light fitting to be easily turned on and off or adjusted; the main electrical parameters can be monitored, sending warnings if faults are detected. Control is possible by time programming, using motion and/or luminosity sensors, and by manual commands executed from the user application.</p>\n<p>Best Suited for Smart Lighting Projects:</p>\n<p>IP65 waterproof rating.\n230VAC power supply.\nPower consumption measuring.\n1-10V and/or DALI regulation.\nSupports 1 external sensor.\nFull control of data flow.\nNodes or gateways are not required.\nConfigurable data storage.\nConfigurable alerts and alarms.\nRemote firmware updates.</p>',
      challenge: '',
      references: '',
      awards: '',
      technologies: ['Internet of Things', 'Cloud Computing'],
    ...
    'datakorumsolutions-sc40': {
      ...
      yearOfValidation: 2017,
      description:
        "<p>IoT sensor monitoring system allows any analog or digital sensor to behave as if it were an IoT sensor, and establishes a real-time connection between the cloud and sensors. The measures taken by sensors can be sent instantaneously, and enable events, alerts and alarms associated with them.</p>\n<p>Our controller implements policies that allow minimum data transfer using very low cost M2M lines.</p>\n<p>SC40 controllers let you connect up to four different sensors to the same controller. It's the cheapest way to implement a sensor network worldwide.</p>\n<p>Its connection to E3TGlobal CLOUD is via WiFi and user applications are available for PC, Android, and IOS.</p>",
      challenge: '',
      references: '',
      awards: '',
      technologies: ['Internet of Things', 'Cloud Computing'],
    ...
    'datakorumsolutions-ss47': {
      ...
      yearOfValidation: 2017,
      description:
        '<p>IoT sensor monitoring system allows any analog or digital sensor to behave as if it were an IoT sensor, and establishes a real-time connection between the cloud and sensors. The measures taken by sensors can be sent instantaneously, and enable events, alerts and alarms associated with them.</p>\n<p>Our controller implements policies that allow minimum data transfer using very low cost M2M lines.</p>\n<p>SS47 controller has four built-in internal sensors; Temperature, humidity, luminosity, and presence.</p>\n<p>The RS485 port lets you connect any standard modbus sensor to the internet. Its connection to E3TGlobal CLOUD is via WiFi and user applications are available for PC, Android, and IOS.</p>',
      challenge: '',
      references: '',
      awards: '',
      technologies: ['Internet of Things', 'Cloud Computing'],
    ...
    'datakorumsolutions-tiny': {
      ...
      yearOfValidation: 2018,
      description:
        '<p>The smart lighting solution consists of a wireless programmable communication device for each light fixture, connecting to the cloud without intermediate points.</p>\n<p>The controller allows the light fitting to be easily turned on and off or adjusted; the main electrical parameters can be monitored, sending warnings if faults are detected. Control is possible by time programming, using motion and/or luminosity sensors, and by manual commands executed from the user application.</p>\n<p>Best Suited for Lighting Manufacturers:</p>\n<p>12 to 48 VDC supply (through driver).\nPower consumption measuring.\n1-10V and/or DALI regulation.\nSupports up to 1 external sensor.\nNodes or gateways are not required.\nFull control of data flow.\nConfigurable data storage.\nConfigurable alerts and alarms.\nRemote firmware updates.</p>',
      challenge: '',
      references: '',
      awards: '',
      technologies: ['Internet of Things', 'Cloud Computing'],
    ...
    'devicegateway-udg': {
      ...
      yearOfValidation: 2017,
      description:
        '<p>Value Proposition:\nInteroperability, legacy integration and increased reliability</p>\n<p>By enabling  wide interoperability with over 40 standards and communication protocols, UDG enables  smooth integration of legacy systems and transition towards new technologies.\nCross systems integration and simplification</p>\n<p>UDG enables the integration of heterogeneous systems and IoT technologies into a common data plane that enables it to bring together all sorts of data in real-time. It enables the development of cross-domain applications and  centralized control and monitoring of your deployed IoT systems. This leads to  simplified maintenance with substantial cost savings, and increased reliability.\nCost-saving</p>\n<p>By giving access to a larger offer in terms of solutions and suppliers, UDG enables a more open competition with reduced cost and a richer offer in terms of functionalities. It also enables smart cities to adapt and reuse a large set of applications and solutions developed by other smart cities at a very low cost. UDG is a source of both capital and operating expenditure savings.</p>\n<p>Increased reliability</p>\n<p>By enabling extensive interoperability, UDG enables smart cities to avoid vendors lock-in. It increases  reliability by easing the adoption of alternative solutions and technology providers. It is more reliable and cost saving through competition.</p>\n<p>Compliance with present and future solutions for smart cities</p>\n<p>UDG is a certified FIWARE solution, fully interoperable with OASC API, oneM2M, LWM2M, CoAP, MQTT, and other protocols. UDG Alliance is a partner of the European Large Scale Pilot on Internet of Things for Smart Cities (Synchronicity), where it will lead the development of the European marketplace for smart cities IoT solutions. It is also in the core group developing the Urban Platform of the European Innovation Partnership for Smart Cities and Communities (EIP-SCC). A guarantee that UDG technology will be compliant with emerging technologies, applications, and platforms for smart cities.</p>\n<p>Real-Time Data Monitoring</p>\n<p>UDG enables smart cities to benefit from customized graphical user interfaces and applications with real time monitoring of their environment and better services for their citizens.</p>\n<p>Data sharing and comparison</p>\n<p>Thanks to  close integration with the mainstream European smart cities frameworks and platforms for IoT management, UDG eases  data sharing, data comparison, and benchmarking among cities.</p>\n<p>Privacy by Design</p>\n<p>UDG has been designed to fully comply with the European General Data Protection Regulation (GDPR) and benefits from several research projects in this domain. It is also working on close collaboration with top European experts to deliver fully privacy by design solutions</p>',
      challenge: '',
      references: '',
      awards: '',
      technologies: ['Internet of Things'],
      ...
      featuredImage:
        'https://pbs.twimg.com/profile_banners/2433287336/1454830240/1500x500',
      furtherImages: ''
    },
    'digitalilusion-outbeacon': {
      ...
      yearOfValidation: 2017,
      description:
        "<p>Outbeacon is a Bluetooth Low Energy device that works as a beacon, and it's the key part of the Outbarriers System. This device is autonomous and is powered by button cells. For this reason, it's very important for efficient maintenance, a simple monitoring process using FIWARE IoT technologies.</p>\n<p>Make your company visible to everybody by placing an Outbarriers beacon at the entrance. The beacon is autonomic, discrete, and does not require any internet connection. If the beacon is placed by the door, it will notify all the people that have the app, that your company supports Outbarriers.</p>",
      challenge:
    ...
    'distromel-sigeus': {
      ...
      yearOfValidation: 2020,
      description:
        '<p>Distromel designs and develops different hardware and software systems for the control and measurement of processes. Distromel is a company specialized in the implementation of control systems for the industrial, logistics, agricultural and environmental sectors. Distromel produces different hardware modules to collect data from the environment. Distromel installs devices track the route of the vehicles in Waste trucks, RFID readers to identify the containers picked up or weight systems to know how much kg of waste has been loaded. Also, it installs a filling level sensor on the containers to know the percentage of waste they have. With all of this data, Distromel can apply processes to optimize waste management such as optimize routes, predictive analysis, or business intelligence.</p>\n<p>This technology can be used in other sectors like the industry to know the weight loaded, GPS routes or RFID traceability.</p>',
      challenge:
        '<p>In the Smart Cities sector, we provide different solutions that have been designed in order to simplify and optimize waste collection and treatment processes.</p>\n<p>In the Industry sector, we offer Load control or dynamic weighing systems in industrial vehicles. We provide solutions that have been designed to make work processes easier for this type of machinery.</p>',
      references:
      ...
      awards:
        '<p>Access4SMEs - Seal of Excellence\nR&amp;D&amp;I Projects «Collaboration Challenges» 2019 - Government of Spain\nAid program for industry and SMEs in Aragon (PAIP)\nINNOVATIVE SME - Ministry of Science and Innovation, Government of Spain</p>',
      technologies: [
        'Artificial Intelligence',
        'Internet of Things',
        'Mobility and Location',
    ...
    'egm-edgespot': {
      ...
      yearOfValidation: 2021,
      description:
        '<p>The EdgeSpot allows the connection of sensors and actuators through all types of telecommunication networks for a wide variety of use cases.</p>\n<p>Its capabilities allow remote intelligent processing and control algorithms in the field (edge processing) while maintaining a low energy footprint. Powered by a battery, solar charge, or electrical network, it adapts to all situations.</p>\n<p>Once the use case is clarified, the card can be adjusted to meet the need at an optimized cost while reusing the software already developed.</p>',
      challenge:
    ...
    'elmitel-evineyard': {
      ...
      yearOfValidation: 2017,
      description:
        "<p>eVineyard is a complete solution for winegrowers which includes FIWARE-compatible sensor devices that can be placed in the vineyard to measure micro-climate parameters such as air temperature, humidity, leaf wetness, and so on. This data is then processed in the Cloud to give growers actionable information, such as when to spray or irrigate.</p>\n<p>eVineyard's sensor devices collect the data on the field, and process it with algorithms to provide growers with actionable information, helping them decide when to do what in order to save time, resources, and nature - while producing more healthy and higher quality grapes.</p>",
      challenge:
    ...
    'engineering-dashram': {
      ...
      yearOfValidation: 2021,
      description:
        '<p>Dashram provides all the tools necessary to display data through numerous charts and to compose and share dashboards. To do this, Dashram implements a layered architecture composed of different components that allow: \nto connect to heterogeneous data sources through the Digital Enabler (powered by FIWARE Platform), including the Orion Context Broker ;\nto create and manage different types of graphs, including 3D urban and timeline graphs;\nto create, manage and share dashboards made up of multiple charts and other graphic and text components.</p>',
      challenge:
      ...
      references:
        '<p>*Lisaqua https://www.ledepar tement66.fr/<br />\n*Drompy https://www.drompy.life/<br />\n*CD66 https://www.ledepartement66.fr/</p>',
      awards: '',
    ...
    'engineering-knowage': {
      ...
      yearOfValidation: 2014,
      description:
        '<p>KNOWAGE is the professional open-source suite for analytics and business intelligence over traditional sources and cloud/big data systems. KNOWAGE is developed according to the NGSI standards and implements the GE reference for data visualization. KNOWAGE provides two main modules and four plug-ins focused on specific domains, allowing to settle a tailored product for every analytical scope.</p>\n<p>The modules of the suite are: </p>\n<ul>\n<li>SI (smart intelligence) carries out the “usual” business intelligence on structured data, focused on self-service and ad-hoc reporting\nER (enterprise reporting) produces and distributes static reports with a pixel-perfect and ready- to-print layout in a secure way</li>\n</ul>\n<p>The plug-ins for the SI module are:</p>\n<p>SD (smart data) allows to combine Solr index with other data sources and provides faceted views and full-text search.\nLI (location intelligence) combines business data with spatial or geographical information through mashup techniques.\nPM (performance management) manages KPIs with thresholds and organizes scorecards with real-time alerts.\nCA (custom analytics) allows to add what-if capabilities and take full advantage of R/python embedding possibilities.</p>\n<p>KNOWAGE complies the criteria of modern BI, giving high customization capabilities and high autonomy to the end-user, ow able to build his own analysis and explore his own data space, always in a secure and well-managed environment, fully supporting the bi-modal approach where fast development meets enterprise requirements such as data consistency and reliability.</p>\n<p>Thanks to the open-source model and adoption of open standards, KNOWAGE can be used as-is or easily included in a third-part application giving it new value with embedded analytics.</p>',
      challenge:
    ...
    'gecorsystem-gecor': {
      ...
      yearOfValidation: 2021,
      description:
        "<p>To solve that, GECOR establishes a multidirectional communication channel that facilitates a transparent and positive relationship between a municipality and its citizens, for those who are committed to becoming a Smart City.</p>\n<p>GECOR helps save response times up to 80% with immediate actions. Financial savings by eliminating bureaucracy and facilitating communication. It is amortized in the same year.</p>\n<p>GECOR allows us to know the real status of incidents. Control incidents detected by technicians, clients, or companies in real-time. The historical status and the information necessary for its management are controlled.</p>\n<p>GECOR involves citizens in the maintenance of the city, facilitates citizens' behavior change, and evaluates the perceived quality. Create a reliable channel with the citizens.</p>\n<p>GECOR provides information on the status of the actions: the cost and the effort made by the municipality. Improve decision-making and efficiency of future hires.</p>",
      challenge:
        '<p>Cities’ public spaces are used every hour and every day, for this reason, there is a continuous need of repairing some elements. Some questions appear during this process: How much money did the city spend fixing it?, How much time did it take to fix it?,What issue has been fixed properly?, What does the citizen think about the solution?, What does the citizen think about the city maintenance in general?</p>',
      references:
        '<p>Ayuntamientos de Málaga, Granada, La Línea de la Concepción, Vélez Málaga, Torremolinos, Hialeah Gardens, Getafe, Fuengirola, Petrer, Chiclana, etc.\nSercomosa, Cueva de Nerja, LIMASA, EMASA, SMASSA, URBASER, etc.</p>\n<p>These and more References/Customers are using GECOR right now in production.</p>',
      awards:
    ...
    'greenglobesypa-nighteyeskysensor': {
      ...
      yearOfValidation: 2017,
      description:
        '<p>Night Eye is the final solution for measuring the background of night sky brightness and evaluating light pollution. Through our device, you can obtain real-time data and sky quality record data wherever our Night Eye devices are installed.</p>\n<p>The device is able to measure the brightness background of the sky in different spectral bands of the Johnson photometric system: filters B, V, R, and I.</p>\n<p>Night Eye allows the detection of clouds so that the measurements can be validated.\nThrough its interconnectivity you can consult the data in real-time which allows the download and visualization of data in the cloud.</p>\n<p>It is a cheap solution that provides scientific and technical data. In short, Night Eye allows you to distribute a network of measurements where you want to control the light pollution.</p>',
      challenge:
        '<p>Light pollution in cities is a global problem that has not been solved. Public lighting systems are not designed on the basis of light pollution data. Much work has been done on the efficiency of outdoor lighting but very little on how these systems affect light pollution. The Night Eye makes it easy to establish a network for measuring light pollution in cities in order to design more sustainable, efficient and environmentally friendly lighting systems.</p>\n<p>In addition, in territories with high sky quality, it allows them to boost their economy through the enhancement of their sky quality with real-time measurements of the brightness of the night sky.</p>',
      references:
        '<p>Telefónica.\nCitelum. Edf Group.\nJunta de Andalucía.\nAyuntamiento de Algeciras.\nCabildo de Tenerife.</p>',
      awards: '',
      technologies: [
        'Internet of Things',
        'Modelling',
      ...
      featuredImage:
        'https://www.fiware.org/wp-content/uploads/ImpactStories_Algeciras_Fig-5.jpg',
      furtherImages: ''
    },
    ...
    'hopu-smartspot': {
      ...
      yearOfValidation: 2016,
      description:
        '<p>Smart Spot is a data-powered solution covering IoT devices (sensors) and digital services with dashboard and decision support tools based on AI algorithms. In order to monitor air pollution, Smart Spot measures NO2, CO, SO2, NO, and O3 at specific points in real-time.</p>',
      challenge:
    ...
    'itudemobile-babbler': {
      ...
      yearOfValidation: 2017,
      description:
        '<p>Babblers are small reusable wireless devices. You stick them on the inside of a container or trailer door just before locking it. During a shipment, it logs the temperature and can be used as an electronic seal. The Babbler continuously broadcasts the current status of its electronic seal and other information, while the temperature log and all information about the seal during the shipment are stored internally.</p>\n<p>You start and inspect them wirelessly: With a smartphone, or through a long-range radio option. Attaching and removing a Babbler is easy. It can be fixed with a magnetic holder or double-sided tape.</p>\n<p>Download an app on your smartphone or in-cab device and you are ready to go. All inspections made during the shipment are visible on a dashboard.</p>',
      challenge: '',
      references: '',
      awards: '',
      technologies: ['Internet of Things'],
    ...
    'kmblab-kissmybike': {
      ...
      yearOfValidation: 2019,
      description:
        "<p>Kissmybike is a complex IoT system that includes an electronic device, a cloud-based infrastructure, and a dedicated mobile app. It detects theft and tracks the bicycle's location until its successful recovery. The system features an ultra-compact robust design that allows installing it into a bicycle construction and hiding it from hand and eye. The combination of smart adaptive algorithms and energy efficient electronics enables 1 year of operation on a single charge. Moreover, we assist bicycle owners in a legal retrieval process by providing them with emergency numbers, locations of the nearest police stations, and necessary bicycle identification information for police reports. Kissmybike system is customizable for other tracking applications. Each of these features is innovative by itself, but their combination in Kissmybike gives it an outstanding advantage over competitors.</p>",
      challenge:
        "<p>More than a billion  bicycles are present in the world. Over 4 million bicycles are stolen yearly in Europe alone, it is about 7 bicycles a minute. Only a few of them - 4-5%- are  recovered. While the majority of victims choose a new bicycle of inferior price, up to 23% of victims do not replace their bicycle at all. Thus, bicycle thefts provoke significant economic damage to both bicycle owners and the entire industry. Moreover, bicycle thefts are emotionally stressful for those who experience them. Chains and U-locks are the two most widely used bicycle theft preventive measures. Millions of chains and U-locks are sold every year. Nevertheless, according to an experiment carried out by the Cyclists' Touring Club, even the most expensive 'Sold Secure Golden' standard locks can be broken in less than 42 seconds . A bicycle lock does not guarantee security but foil the opportunist thief and slow down the professional. With Kissmybike we are building a reliable integrated solution that will enable quick bike recovery in case of theft. Our ambition is to make bike theft futile by both technical innovation and creating new collaborations with bicycle industry players.</p>",
      references:
        '<p>Kissmybike adopts a business model that bridges Reference Material/Customers and end-users and follows B2B2C marketing orientation. Our main target Reference Material/Customers are bicycle manufacturers, bicycle dealers, renting and insurance companies.</p>\n<p>We have signed a contract with Fantic Motor srl for a pilot project for 100 devices .\nCurrently, we have scheduled trials with 6 companies (BikeeBike from Italy, SUNN and Douze Cycles from France, DIAVELO from the Netherlands, and MA NGSI Ready Devices and Corratec from Germany).</p>',
      awards:
        '<ul>\n<li><p>In October 2015, Kissmybike was awarded the first prize at the D2T Start Cup (Trento, Italy) in the field of Mechatronics. The team received €5K and 12 months of incubation at the Pole of Mechatronics (Rovereto, Italy). </p></li>\n<li><p>In July 2016, Kissmybike was selected to be in the Top-10 projects (out of 297) in the 2nd call of Finodex. We received a total of €100K, business coaching and business networking services. </p></li>\n<li><p>In October 2016, KMB Lab received €40K funding for business development from the Province of Trento (Italy). </p></li>\n<li><p>In March 2018, KMB Lab was selected for SME Instruments Phase 1 funding of €50K. </p></li>\n<li><p>In May 2018, Kissmybike was admitted to the MAG2 FrontierCities2 acceleration programme with €75K total funding and business acceleration services.</p></li>\n</ul>',
      technologies: ['Internet of Things', 'Open Data', 'Data Analytics'],
      domains: ['Cities'],
      docs: [],
      videos: [],
      ...
      related: [
        {
          category: 'FIWARE-Ready',
          featuredImage:
            'https://2318222212-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-M9XNfQJE1Dmx-VhQyDl%2F-MA5o9ZGKSAeCSR911SM%2F-MA5y9KvWU3L8H6HghXr%2Fexternal_battery.png?alt=media&token=ac617ac8-61e9-4537-874f-8615a959ce85',
          excerpt:
    ...
    'libelium-plugsense': {
      ...
      yearOfValidation: 2017,
      description:
        '<p>Plug&amp;Sense! offers its users several benefits.</p>\n<ul>\n<li><p>Sensor probes can be attached easily by just screwing them into the bottom sockets. This allows you to add new sensing capabilities to existing networks in just minutes. In the same way, sensor probes may be easily replaced in order to ensure the lowest maintenance cost of the sensor network. Libelium offers different models for different vertical applications such as Smart Cities, Smart Agriculture, Industry 4.0, Asset tracking, etc, with more than 100 sensors in total.</p></li>\n<li><p>Battery can be recharged using the internal or external solar panel options (common USBrecharging is of course another option). The external solar panel is mounted on a 45º holder which ensures the maximum performance of each outdoor installation. For the internal option, the solar panel is embedded on the front of the enclosure, perfect for use where space is a major challenge. The rechargeable battery has a load of 6600 mAh, which ensures non-stop working time during the weeks when the sunlight is lower.</p></li>\n<li><p>Waspmote Plug &amp; Sense! counts with holders specially designed for outdoor installations in streetlights and building fronts. Metal cable ties are provided to easily adjust the node to street light posts. Installation can be done in minutes as you only need to tie the cables on the enclosure holders and then to the post. Once the node is secured just press the on button and the node will start automatically to send the data gathered from the sensors to the Gateway.</p></li>\n<li><p>There are multiple radio options in order to communicate the sensor nodes with the Gateway. 802.15.4, 868, and 900 are used commonly to create local, start topologies. WiFi can be used to connect with any WiFi AP while the 4G radio can be used to send the sensor data directly to the Cloud without using an intermediate Gateway. Sigfox and LoRaWAN modules are special for IoT applications and get very long-range links.</p></li>\n<li><p>The 4G module features a GPS receiver which allows to easily perform real-time tracking applications.</p></li>\n<li><p>Plug &amp; Sense! units are able to connect with the most common industrial communication \nprotocols: RS-232, RS-485, Modbus, 4-20 mA (current loop) and CAN Bus. This feature opens a wide variety of applications for industrial sensing, and automation, military, automobile, vehicle tracking, or remote factory management.</p></li>\n<li><p>Lastly, Plug &amp; Sense! models with 4G radio have an External SIM socket which allows developers to easily add and change a carrier SIM card in order to connect the devices to any 4G / 3G / GPRS / GSM cellular network</p></li>\n</ul>',
      challenge: '',
      references:
    ...
    'libelium-waspmote': {
      ...
      yearOfValidation: 2017,
      description:
        '<p>Waspmote hardware architecture has been specially designed to work with extremely low consumption. Digital switches allow  turning on and off any of the sensor interfaces as well as the radio modules. Three different sleep modes make Waspmote the lowest consumption IoT platform in the market (7 µA).\nThere are more than 110 sensors available to connect to Waspmote: CO, CO2, soil moisture, wind, IR presence, humidity, temperature, pH, radiation, liquid, luminosity, etc. Our Sensor Boards allow developers to easily use sensors in Waspmote.</p>\n<p>There are 16 different wireless interfaces for Waspmote including long range (4G / 3G / GPRS / GPRS+GPS / LoRaWAN / LoRa / Sigfox / 868 MHz / 900 MHz), medium range (ZigBee / 802.15.4 / DigiMesh / WiFi) and short range (RFID/NFC / Bluetooth 2.1 / Bluetooth Low Energy). They can be used solely or in combination of two by using the Expansion Radio Board.</p>\n<p>Users can connect any sensor in industrial environments. Compatible with: RS-232, RS-485, Modbus, CAN Bus, 4-20mA.</p>\n<p>Over the Air programming (OTAP) enables software upgrades of the motes without the need of physical access. Software upgrades can be made in minutes and it is possible to choose between updating single nodes (unicast) or an entire network (broadcast).</p>\n<p>The encryption libraries for Waspmote ensure the authentication, confidentiality (privacy) and integrity of the information gathered by the sensors. To do so, different cryptography algorithms including AES 256, RSA 1024 and MD5 have been implemented.</p>',
      challenge: '',
      references:
    ...
    'odinsolutions-ipex04datalogger': {
      ...
      yearOfValidation: 2018,
      description:
        '<p>Datalogger and controller in DIN rail for electrical panel with 4 inputs/outputs. Compatible with various accessories to increase functionality and communications. Configuration with an embedded web server.</p>',
      challenge:
    ...
    'odinsolutions-mex06datalogger': {
      ...
      yearOfValidation: 2018,
      description:
        '<p>Datalogger and controller for outdoor environments for monitoring and remote control. Extra-low consumption to operate with batteries and solar panels. Radio communications and configuration by configuration website.</p>',
      challenge:
        '<p>Integration of legacy systems (sensors and actuators) to IoT World.</p>',
      references: '',
      awards: '',
    ...
    'seaconeurope-intellifood': {
      ...
      yearOfValidation: 2017,
      description:
        '<p>Certain materials (commodities) and their mixes delivered or produced by business partners are fastidious about temperature, light and humidity. For example:\nVegetable cream, vegetable foams: temperature, sun protection\nFruit fillings: humidity, temperature (have to store in a dry and cool place)\nPowder shaped emulsifier: humidity, temperature, light\nMargarines: temperature (both the too high and the too low temperature are unfavorable)\nSweetening mix (sugar alcohol): humidity</p>\n<p>The storage of these materials needs specific parameters, otherwise waste products will be generated, which must be removed or destroyed. In case of mixtures containing sensitive material the storage is really important as well, because the waste material has an impact on the product, however the monitoring of the mixture making is essential.</p>\n<p>The prepared solution is a system based on a wireless sensor network, which is made up of temperature and humidity measurement units (approximately 12-15 sensor points) that are able to communicate with each other. The wiring is not required, the easy  deploy mobile sensors measure the values of the parameters scheduled and communicate the results to a central data store.</p>\n<p>The processing application operating in the same place evaluates the measurements and sends alerts for the responsible people according to the rules are set. If the rate of temperature or humidity comes near  a lower or upper limit, an email or an SMS can start a manual intervention.\nThe regular measurements allow the precise storage of the storage and mixing parameters along with the given particular materials and mixes, and in this way, the quality management becomes verifiable besides the identification of the product. The customer can get information about the ordered product right from the delivery date.</p>\n<p>The mixing of materials depends on the temperature. The usage  and monitoring of the relevant rules can ensure that all material will be mixed between the corresponding temperature ranges based on objective measurements.</p>\n<p>Besides the simple statements based on binding of basic substance/mixture and measured temperature/humidity values, complex information can be prepared as well, which takes account of other factors such as seasonality, storage time, suppliers, etc.</p>',
      challenge: '',
      references: '',
      awards: '',
      technologies: ['Internet of Things', 'Open Data', 'Data Analytics'],
    ...
    'secmotic-lockart': {
      ...
      yearOfValidation: 2017,
      description:
        '<p>The operation of LockArt is totally intuitive. Once the lock is installed you will only have to identify your mobile as the allowed device to start using it, and this makes the process  fast and simple.</p>\n<p>The great thing about LockArt is that it installs in the blink of an eye. It is compatible with all types of lock thanks to its adjustable back piece, meaning that in just a few minutes you will have configured your lock and you will be opening your door without keys! In turn, it is safe. The electronic keys generated are for single-use and communications are always encrypted. </p>\n<p>Lastly, you have total control. LockArt allows you to view statistics in your control panel. You will know who, how and when someone has access.</p>',
      challenge:
      ...
      related: [
        {
          category: 'FIWARE-Ready',
          featuredImage:
            'https://www.muvone.com/wp-content/uploads/2016/06/modelo-muvone-04.jpg',
          excerpt:
    ...
    'senecoas-citygrid': {
      ...
      references:
        '<p>Bornholm Municipality (DK) Viborg Municipality (DK) Haderslev Municipality (DK) Hillerød Municipality (DK) PrismaTibro Fagerhult Teamtronic Focus Lighting ateljé Lyktan We-ef</p>',
      awards: '',
      technologies: [
        'Communication Networks',
        'Internet of Things',
      ...
      featuredImage:
        'https://static.wixstatic.com/media/5a3321_3afee6ba23fc41fb82e90a16b89d5e11~mv2.png/v1/fill/w_1531,h_674,al_c,q_90,enc_auto/5a3321_3afee6ba23fc41fb82e90a16b89d5e11~mv2.png',
      furtherImages: ''
    },
    'sensowave-digitanimal': {
      category: 'FIWARE-Ready',
      ...
      references:
        '<p>Digitanimal (former STEPLA) participated in SmartAgriFood accelerator where it reached the last stage of the acceleration programme and  was selected at the top 3 best performance projects and the best technological project.</p>\n<p>Digitanimal project was selected in 2016 to be part of the GSMA Innovation City of the Mobile World Congress (https://youtu.be/vmMPpvw3SSQ, https://youtu.be/9dmH1WcLT18).</p>',
      awards: '',
      ...
      featuredImage:
        'https://scontent-frt3-2.xx.fbcdn.net/v/t39.30808-6/274598420_4651837208276977_1156141110197799661_n.jpg?_nc_cat=101&ccb=1-7&_nc_sid=e3f864&_nc_ohc=KB92ulPzDPAAX-hXC3x&tn=8vjiMBCSITGGfB_z&_nc_ht=scontent-frt3-2.xx&oh=00_AT9jJrPA4Kj5bRBIdoX6LLpbyy0ygpkunl7yzz67vfg_bA&oe=62E5BB1A',
      furtherImages: '',
      related: [
        {
          category: 'FIWARE-Ready',
    ...
    'situmindoorpositioning-situmindoornavigation': {
      ...
      materials: [
        ...
        [
          'Reference 2',
          'https://www.telefonica.com/en/web/press-office/-/telefonica-multi-sensory-geolocation-solution-will-provide-users-with-the-best-indoor-location'
        ],
        [
          'Reference 3',
    ...
    'srmconsulting-mavdrone': {
      ...
      yearOfValidation: 2021,
      description:
        '<p>MavDrone is an extensión of the already existing solution called Ipsilum Aerial Solution. IAS is a platform developed by SRM Consulting for the Command and Control of Drone Fleets.\nMavDrone extends the capabilities of IAS by publishing the telemetry in a public API. The API can be consumed by thirdparties through FIWARE. This API allows also sending control messages such us takeoff, landing, flight mode, arm/disarm, and connect/disconnect.</p>',
      challenge:
    ...
    'tstsistemas-tscontrolindustrialcontrol': {
      ...
      yearOfValidation: 2017,
      description:
        '<p>The TSconTroL is a multi-purpose and multi-interface device for IoT and M2M applications in industrial, agricultural, and smart cities. It supports connectivity to the Sigfox network and has 4-20mA analog inputs, relay outputs, RS485-MODBUS interface, digital inputs, 7-36V power supply, and encapsulated DIN rail.</p>\n<p>By means of simple programming, the client can create the desired application among a range of possibilities depending on the sensor to be connected. The device has been installed in different scenarios for irrigation control, monitoring of crops and large plantations, water quality management, and control of industrial machines.</p>\n<p>There is also the option of adapting the encapsulation to meet the required levels of tightness in each specific installation environment.</p>',
      challenge:
    ...
    'tstsistemas-tswaste': {
      ...
      materials: [
        ...
        ['Reference 2', 'https://partners.sigfox.com/products/tswaste'],
    ...
    'ventuminnovacion-gaviláncontrol': {
      ...
      yearOfValidation: 2020,
      description:
        '<p>We want to offer solutions that improve working conditions, increase productivity, reduce costs, store information, and make work easier. We want to automate most of the daily tasks in your work.</p>\n<p>About our software: - Save information collected from a multitude of sensors installed in livestock farms - Use that information to monitor livestock farms - Save events occurred - Notify users of said events and act - Data analysis - Report generation</p>\n<p>Our app can run in browser or mobile app</p>',
      challenge:
    ...
    'viralstudios-virtualart': {
      ...
      yearOfValidation: 2019,
      description:
        '<p>As a response to this problem arises virtualARt: a model of solutions based on mobile applications that allows users to obtain information about pieces of art just by pointing with your smartphone camera. virtualARt is a flexible tool, which can be adapted to different art galleries or museums, implementing a specific solution for each case. In addition, it allows gathering information about each visit, such as the sequence of visited pieces of art, time of the visit or viewing time of each piece of art. Thus, users can find out which pieces are most popular, and museum management personnel can configure the location of each work according to the pReference Material of the users, in order to achieve the best possible user experience. As you can guess, virtualARt is not a solution that is limited to art galleries and museums, but it can be adapted to any commercial, industrial or civil environment that requires gathering information from the medium and, if required, obtaining information about visits, in order to improve the user experience.</p>',
      challenge:
    ...
    'wellnesstechgroup-quamtra': {
      ...
      yearOfValidation: 2017,
      description:
        '<p>The Quamtra system optimizes collection routes by constantly monitoring the content level of waste containers. By installing sensors in the containers it is possible to receive real-time alerts for collection based on container content level, temperature variation (fires), or movement (shaking) enabling a reduction in damage liability and response time.\n Municipalities:\nOperational costs reduction by up to 35%.\nReduce collection costs by optimizing routes and fuel.\nReal-time filing status of containers.\nReal-time fire alarms to reduce response time and damage compensations and liability.\nContainer location monitoring (optional GPS module).\nROI &lt; 2 years.\nEmissions reduction through optimization of routes.\nBetter quality of service and street cleaning.\nCivic awareness (App.)</p>\n<p>Waste management companies / Utilities:\nEasy installation and deployment.\nRemote configuration of dispositives.\nRoutes and fuel optimization.\nIntegrable with client waste management solutions.\nROI &lt; 2 years.\nInstallable in a wide range of existing containers in the market.</p>\n<p>Citizens:\nImproved perception about the quality of service.\nCitizen participation (App).\nTraffic descongestion.\nGHG emissions reduction.</p>\n<p>Use Cases:\nCollection planning\nFire detection\nTipping detection\nIdentifying displaced containers\nAnalysis to optimize the placement, quantity, and use of containers throughout the city\nService audits</p>',
      challenge:
        '<p>A city’s waste management is ultimately tied to its level of development. A city that is capable of being environmentally sustainable will, in turn, increase growth and well-being for its residents.</p>\n<p>What’s more, in a globalized world where people are increasingly mobile and a community’s demographics can vary significantly throughout the year, public agencies and municipalities must incorporate the necessary tools to adapt. These technologies increase efficiency, improve public services and adapt to residents, providing a clean, comfortable, and attractive living environment.</p>\n<p>Currently, planning the collection of solid urban waste is based on predefined routes and experience, causing unnecessary costs and underutilization of equipment. Often empty containers are collected and full containers overloaded causing an increase in cleaning costs. Knowing the content level of waste containers is critically important.</p>',
      references: '',
      awards: '',
      technologies: ['Internet of Things', 'Open Data', 'Data Analytics'],
      domains: ['Cities'],
    ...
    'wellnesstechgroup-welight': {
      ...
      yearOfValidation: 2017,
      description:
        '<p>WeLight Smart Lighting system was developed to improve the quality and efficiency of public lighting for enhanced service and a better user experience. Integrating new technologies in the public lighting infrastructure has the potential to generate savings, optimize processes, and facilitate improved decision-making. It establishes a base for the implementation of a smart digital platform to manage other city services, a step towards becoming a Smart City.</p>\n<p>WeLight monitors and controls the public lighting infrastructure, detecting irregularities in consumption or operational malfunctions, as well as compiling consumption and savings reports. The system helps managers to prepare inventories and carry out both preventative and corrective maintenance. This solution not only guarantees energy efficiency but is also key for public and traffic safety.</p>\n<p>Remotely managed lighting, along with the integration of devices like artificial vision cameras and influx or noise sensors, form a smart security system for public safety and security agencies. Likewise, remote management of luminaires with color variations can be used for adaptive decorative lighting and tourism during public events, seasons, etc.</p>\n<p>Wellness TechGroup offers an end-to-end solution for optimal service, made up of IoT devices such as Unigate or Actis, as well as the complete WeLight software platform.</p>\n<p>With these components, the solution allows for several distribution models: remote management at the top of the electrical panel (control panel and circuits) and point-to-point remote management, both of which are compatible with conventional lamps (halide, sodium vapor, mercury vapor, etc.) and LED. Or, through wireless LPWA communications (LoRaWAN, Sigfox, cellular) or PLC (Power Line Communications). In addition, system distribution is made easy and agile using a mobile application. WeLight uses multi-operator SIMs, ensuring high-quality network connection and coverage. Security measures are implemented in both hardware and software (VPNs, SSL certificates, etc.) so that all information can be securely transferred online.</p>\n<p>WeLight is a flexible modular solution with multiple configurations and distribution options using a software as a service (SaaS) or licensing model.</p>\n<p>In short, WeLight Smart Lighting offers reliable alerts for critical real-time decision-making, allowing cities to react quickly to irregularities.\nImproved Management:</p>\n<p>Detects malfunctions in public lighting in real-time, improving response time and service.\nReduces operating costs.\nControls and reduces energy consumption.\nLighting comfort.</p>\n<p>Integration and Scalability:</p>\n<p>Compatible with multiple technologies and manufacturers, such as LEDs and conventional lamps.\nCustomizable modular platform.\nCompatible with existing information systems.\nCompatible with point-to-point systems and cable anti-theft systems.\nAdapts existing lighting infrastructure to the Smart City network.\nUses standard technologies like LoRaWAN.</p>\n<p>Versatility:</p>\n<p>Allows for changes in color profiles, intensity, and temperature.\nAdaptive lighting.\nEnsures public safety by integrating with other smart elements and indicating evacuation routes.\nEnhances both the resident and tourist experience.</p>\n<p>Use cases:</p>\n<p>Energy consumption management: profiles of point-to-point control\nPublic safety application: anti-panic lighting and guided evacuation\nApplications for decorative lighting\nLighting for large scale events</p>',
      challenge:
        '<p>Street lighting can be an ideal platform to support additional services due to its presence in remote areas, connectivity to the electricity grid, and proximity to people.</p>\n<p>Thanks to IoT technology, lighting can be equipped with intelligence and connectivity, converting each luminaire into a data server (data-enabled lighting). This converts the system into a service that goes beyond just lighting. Luminaries become nodes in the IoT ecosystem.</p>',
      references: '',
      awards: '',
      technologies: ['Internet of Things', 'Open Data', 'Data Analytics'],
      domains: ['Cities'],
  ...
  cities: {
    'cityofvienna-smartdatawien': {
      ...
      yearOfValidation: 2017,
      description:
        '<p>As part of the joint EU project "Smarter Together" of the cities of Lyon, Munich, and Vienna on the topic of Smart City, a lot of data - from sensors, on buildings, environmental data - was collected. This data will now be made available on the urban data platform smartdata.wien, which is based on open standards.</p>',
      challenge: '',
  ...
  services: {
    ...
    'ballistix-ballistix': {
      ...
      yearOfValidation: 2019,
      description:
        '<p>We build proof-of-concepts, prototypes, and MVPs of web-based applications and love working with emerging technologies like blockchain, 3D printing, and Artificial Intelligence.\nWe have extensive experience with FIWARE enablers and have -among other projects- built our first start-up on top of it. Through validation and iteration, our team of software engineers and product managers will build the right digital product together with you.</p>\n<p>Product / market fit is what we live and code for.</p>',
      challenge: '',
    ...
    'egm-designoffice': {
      ...
      yearOfValidation: 2021,
      description:
        '<p>EGM ensures the design of your solution taking into account your criteria of performance, price, quantities, standards, mechanical integration, optimization, the choice of technologies, and manufacturing methods with a user-centered creation process.</p>\n<p>FEASABILITY STUDY Our engineering design office offers you its expertise and know-how in electronics and embedded IoT to provide technical  expertise for your project. Based on your idea, EGM will identify the key development points and offer you the best solution to carry out your project.</p>\n<p>DESIGN We develop systems from scratch or  technological bricks. According to the technical specifications that we draft with you, we select the best  components taking into account the requirements of the project.</p>\n<p>PROTOTYPING The development involves the realization of an electronic prototype V1 which allows you  to validate together the functionalities and the concept of your product. Then, we proceed to the electronic prototype V2 which integrates the possible evolutions, or modifications seen previously.</p>\n<p>INDUSTRIALIZATION AND MANUFACTURING Thanks to our skills, we are able to calibrate, optimize costs and electronic card manufacturing processes. Whether for prototypes, small, medium, or large series, we offer production plans adapted to the objectives of our References/Customers.\nWe are supporting organizations in deploying FIWARE architectures, starting from data ingestion up to data processing, with new NGSI-LD data models.</p>',
      challenge: '',
      references: '',
      awards: '',
      technologies: ['Internet of Things', 'Sensory Systems'],
    ...
    'eprosima-eprosima': {
      ...
      yearOfValidation: 2021,
      description:
        '<p>eProsima is an SME company focused on networking middleware with special attention to the OMG (Object Management Group) standard called Data Distribution Service (DDS) for real-time systems. The company’s DDS middleware solutions find special interest in the robotic, IoT, and automotive sectors, being Fast DDS a middleware implementation for larger robotic systems like ROS 2, and Micro XRCE-DDS the default middleware for micro-ROS, a robot operating system for microcontrollers.</p>',
      challenge: '',
      references:
    ...
    'ficodes-coachingtrainingservices': {
      ...
      yearOfValidation: 2017,
      description:
        '<p>Ficodes is a startup that was born from a group of UPM research engineers and developers, passionate about developing smart solutions leveraging IoT and open data. Our focus lies on providing the necessary open platform technologies for developing smart solutions, such as smart cities, smart agrifood, smart industry, etc.</p>\n<p>We have huge and deep experience on the FIWARE platform, in which our team has been involved since its inception during their time in UPM. Indeed, our team developed and coordinated different Generic Enablers inside FIWARE for more than five years. Besides, we have expertise in the integration of TM Forum open APIs for services management in FIWARE-enabled solutions.</p>\n<p>This is why we can also deliver coaching and training services about the platform to boost your skills when using FIWARE technologies.</p>',
      challenge: '',
      references: '',
      awards: '',
      technologies: [],
    ...
    'fiihubcanaryisland-fiihubacademy': {
      ...
      yearOfValidation: 2020,
      description:
        '<p>The general objective of FiiHUB is to create and execute the first technological reference center for the development of the business and entrepreneurship ecosystem of Macaronesia, linked to the development of intelligent services based on Internet technologies of the Future and connected to the international network of FIWARE iHub.</p>\n<p>Please access the provided web page for further information.</p>',
      challenge: '<p>-</p>',
    ...
    'fiihubcanaryisland-innovationprojectdesignthroughfiware': {
      ...
      yearOfValidation: 2020,
      description:
        '<p>FiiHUB works to promote and disseminate FIWARE technology in the Macaronesia region, exactly in the Canary Islands, conducts various courses, and helps companies develop and integrate solutions to grow the ecosystem.</p>\n<p>We had developed a complete program about Innovation Project Design, with an internal and external analysis of the company, distinguishing users vs. clients, designing services and products, taking into account the user experience, and the process of prototype, valid, and pivot.</p>\n<p>Please access the provided web page for further information.</p>',
      challenge: '',
      references:
    ...
    'fiwareinnovaihub-coachingtrainingservices': {
      ...
      yearOfValidation: 2017,
      description:
        '<p>FIWARE Innova iHub is a non-profit association that supports the digital transformation process and promotes smart solutions in the Smart City and Smart Agri Food sectors, representing the reference FIWARE Hub in Italy. As of today, in fact, FIWARE Innova iHub is the first and only Italian FIWARE iHub, and the only FIWARE Certified Expert. </p>\n<p>Our association has among its objectives to facilitate the enhancement of cutting-edge technologies, successful entrepreneurial strategies, new business models and sustainable development. All this for the creation of solutions and infrastructures able to transform urban and rural areas into "Smart Lands" and encourage the development of a better quality of life.</p>\n<p>The mission of FIWARE Innova iHub is to promote the culture of innovation in realities such as: </p>\n<ul>\n<li>Municipalities, public administrations and local governments</li>\n<li>Organizations and institutions</li>\n<li>Startups, small and medium enterprises in the Smart City field</li>\n<li>Universities and other educational institutions</li>\n<li>Small and medium-sized farms, Smart Agri Food experts.</li>\n</ul>\n<p>Through the use of new technologies such as Internet of Things (IoT), Big Data, Open Data, Artificial Intelligence, Decision Support System and supported by FIWARE technology as a connector, the Association provides support to design and test technological solutions.\nIt supports its network in implementing dashboards and applications that leverage Artificial Intelligence and Decision Support System (DSS) to facilitate data collection, analysis, processing and visualization, to improve service management and prediction of frequent phenomena.</p>\n<p>What we offer\nOur team of certificate FIWARE experts provides purpose-designed consultancy and training to facilitate organizations and institutions, entrepreneurs and startups to pioneer in business processes, distribution, value chains, business models, and even the functions of management. Laboratory training programs, collaboration workshops, and coaching are also offered for sharing insights and inspiring innovation towards a smarter future for Italy.</p>',
      challenge: '',
      references:
    ...
    'fiwarespace-coachingtrainingservices': {
      ...
      yearOfValidation: 2019,
      description:
        '<p>FIWARE Space is an innovation center, part of a global project called "Badajoz Is More", which is in charge of the Badajoz Provincial Council (Diputación de Badajoz). This project seeks to incorporate the new information and communication technologies in Local Administrations, to transform rural areas, to improve the efficiency and effectiveness of public services, and to achieve a more agile and modern administration.</p>\n<p>The "Badajoz Is More" project has the clear objective of providing technological tools and services in order to develop municipalities with a better quality of life through sustainable development, based on IoT and Big Data technologies and with the aim of turning the province of Badajoz into a Smart Territory or Smart Province.</p>\n<p>To achieve this goal we work on different lines of actions:</p>\n<p>Bring these new technologies to the citizens, developing new services that interact with people in a much closer and intuitive way, and that in general facilitate their daily life as well as allow them to have a much greater knowledge and control of public services that are at their disposal.\nImprove the efficiency of all the public services that depend on the City Councils of the province and the Provincial Council of Badajoz, developing solutions that optimize the expenditure of resources and centralizing all services in a single smart management platform.\nCreate an innovation ecosystem around these technologies to promote innovation, entrepreneurship, and job creation in the region and promote the use of new technologies to develop new services and business opportunities, involving both local businesses and the different educational entities and entrepreneurs of the province.\nReduce the digital gap between the cities of the province and the rural area, providing the necessary tools and technologies to all the municipalities of the province and promoting local entrepreneurship based on these to avoid rural exodus and get the population to settle in the smaller municipalities.\nDevelop the project based on standards (both management standards and technology standards) to integrate  other projects related to the Smart Cities carried out or in the development phase within the province or region in the future.\nEnsure the initiative reaches citizens, companies, public entities, and other organizations, the Badajoz Provincial Council provides training and development of an innovation ecosystem that serves as a meeting point between citizens (who demand these services), entrepreneurs, and educational entities (that have an interest in these technologies), companies (that have the capacity to implement these solutions) and public entities (those that can implement this type of projects) and that provide and provide the necessary tools, knowl\nedge, and advice so that the projects that arise from this meeting can be carried out.</p>\n<p>This ecosystem is supported by a physical Innovation Center called FIWARE Space, which focuses on all the activities described above, and the following activities will be carried out:</p>\n<p>Organization of information events about the technologies used and the concepts of Smart Cities and Smart Province\nDemonstration and training workshops\nOrganization of Hackathons and call for challenges\nShowroom and exhibition of models of the different solutions\nConferences\nPresence in congresses, fairs, and national and international events</p>\n<p>This center is recognized with 2 stars by the FIWARE Foundation.</p>',
      challenge: '',
      references:
        '<p>Citizens, companies, entrepreneurs, educational entities, SMEs, public entities like city councils or other \nInstitutions.</p>',
      awards:
    ...
    'futureinternet-consultancyintegrationservices': {
      ...
      yearOfValidation: 2017,
      description:
        '<p>Ficodes is a startup that was born from a group of UPM research engineers and developers, passionate about  developing smart solutions leveraging IoT and open data. Our focus lies on providing the necessary open platform technologies for developing smart solutions, such as smart cities, smart agrifood, smart industry, etc.\nWe have huge and deep experience on the FIWARE platform, in which our team has been involved since its inception during their time in UPM. Indeed, our team developed and coordinated different Generic Enablers inside FIWARE for more than five years. Besides, we have expertise in the integration of TM Forum Open APIs for services management in FIWARE-enabled solutions and we can also deliver coaching and training services about the platform.</p>\n<p>All of these make us the perfect technological partner you need for your smart projects.</p>',
      challenge: '',
      references:
    ...
    'hearingsoftware-consultancyintegrationservices': {
      ...
      yearOfValidation: 2019,
      description:
        "<p>We're a team with wide experience in FIWARE projects, both our own and consulting and development for third companies.</p>\n<p>We've worked with FIWARE since its beginnings in 2012.\nhttps://fiware-developers.eu/</p>",
      challenge: '',
      references:
      ...
      awards:
        '<p>2019 - Founder Antonio Sánchez Pineda got the FIWARE Expert Certificate with distinction. (please find attached the picture).\n2018 - Finalists on the Challenge of Malaga Sky Quality Meter.\n2014 - Qualified for final Smart Society Fi-Ware Challenge, The final was in Sevilla in October. FiGlass aims to solve two major problems of hearing impaired people: Perceive acoustic events and communication, Finalists list link.\n2014 - Best Google Glass App Emertech, Best Google Glass App in the Emertech Hackaton organized by Zerintia Technologies.\n2014 - Finalist Fi-Ware 800k Challenge, The final was in Sâo Paulo from 27 January until 2 February. Our project was QuickParking.\n2013 - Third Prize Fi-Ware Hackaton, The project was Open Alerts, is based on the idea of IFTTT but with IoT.\n2013 - Best IoT application of Fi-Ware, Winner of this prize in Campus Party Europe\n2013 - celebrated in London. The project, Hotel Automation Management, lets guests manage their rooms.</p>',
      technologies: ['Artificial Intelligence', 'Internet of Things'],
      domains: [
        'Cities',
        'AgriFood',
    ...
    'hopu-fiwareexpertcertification': {
      ...
      yearOfValidation: 2021,
      description:
        '<p>The course is organized in 4 blocks for 8 weeks; this means 2 weeks per block; where we will have every week 2 sessions online; plus individual work/activities offline. This means an intensive programme of 180 hours; including 60 hours online and 120 hours of individual activities to become a FIWARE Expert!</p>\n<p>During every block, the organization planned is as follows: ● Day 1 (Monday) - Theoretical introduction to get key concepts. ● Day 2 (Thursday) - Discussion (Note that FIWARE Expert evaluation is based on discussion questions). ● Day 3 (Monday) - Hands-on practices ● Day 4 (Thursday) - Example of FIWARE expert questions/exercises and evaluation.</p>',
      challenge: '',
      references:
        '<p>Canarian companies selected in the framework of the FIMAC project (Spain)\nUniversity of Alicante summer Bootcamp (Spain)</p>',
      awards:
    ...
    'martelinnovate-martellab': {
      ...
      yearOfValidation: 2017,
      description:
        '<p>Martel’s team has a long history with FIWARE, and has been intimately involved with its creation since its birth in 2011. Dr. Federico Facca, CTO of Martel Innovate, is a member of the FIWARE Board of Directors and  the Technical Steering Committee. Martel has been a FIWARE Gold Member, taking part in the steering of the FIWARE Community.</p>\n<p>We’re now making our experience in FIWARE available to our References/Customers and partners!</p>\n<p>We are leading experts on production level configuration of FIWARE Data and IoT management services and we can help you to manage your infrastructure for production-ready requirements such as - Security - Resilience - Scalability - Availability</p>\n<p>We can help you in designing your FIWARE-based platform and into customizing FIWARE to your needs.</p>',
      challenge: '',
      references: '<p>Antwerp\nHelsinki\nWolfsburg\nEKZ</p>',
      awards:
        '<p>Selected for Phase I and Phase II of Select4Cities PCP.\nSelected for Phase I of AI4CITIES PCP.</p>',
      technologies: [
        'Artificial Intelligence',
        'Cloud Computing',
        'Data Spaces',
    ...
    'naevatec-fiwareconsultancy': {
      ...
      yearOfValidation: 2020,
      description:
        '<p>We have at your disposal a great team with wide experience in FIWARE especially, in the media processing Generic Enablers, and we can help you with a wide range of services around FIWARE: - One-time consultancy - Design of solutions and architectures "powered by FIWARE" or "FIWARE Ready". - Turnkey developments. - Technical support to developers. - 24/7 Support center.</p>\n<p>All of these make us the perfect technological partner you need for your smart projects.</p>',
      challenge: '',
      references: '',
      awards:
        '<p>"best of show" Award at the WebRTC Conference &amp; Expo in Paris,\nKurento is awarded "one among the most innovative technologies" by the WebRTC Pioneer Awards. "The WebRTC Pioneer Awards recognizes people who have been driving webification WebRTC and communications,"</p>',
      technologies: [
        'Communication Networks',
        'Internet of Things',
        'Photonics and Imaging',
    ...
    'snap4city-coachingtrainingservices': {
      ...
      yearOfValidation: 2021,
      description:
        '<p>Snap4City - Scalable Smart aNalytic APplication Builder for Sentient Cities, the powered by FIWARE solution proving flexible method and solution to quickly create a large range of smart city applications exploiting heterogeneous data and enabling services for stakeholders by IoT/IoE, data analytics, and big data technologies.</p>\n<p>Snap4City team organizes the course on "Smart City IoT Course from data gathering to smart applications and Control Rooms"</p>\n<p>The course includes frontal slides, full access to the Snap4City platform (officially powered by FIWARE solution) and development tools, and exercises during the courses. A final certificate is provided under request to certify the level of proficiency of participants. Courses organized by the Snap4City team are typically open to everybody and free of charge.</p>\n<p>Snap4City provides\nconsultancy on setting up the smart city, data discovering and aggregation, data identification, living lab set up, living lab management and workshops, data agreement establishing with your stakeholders, GDPR, etc.;\nconsultancy on technical aspects of smart city design, and of the infrastructure, technical integration with your legacy solutions and infrastructures, etc.;\ncustomization of the powered by FIWARE solution Snap4City platform (https://www.snap4city.org), design and development of new modules, tools, and plugins;\nsmart city as a service on the Snap4City.org infrastructure (see also EOSC https://www.snap4city.org/503 marketplace in which Snap4City is listed);\ninstallation of the platform on your premise, or on your indicated public cloud;\nmaintenance of an installed Snap4City solution, on our cloud, on any cloud, on your premise. As well as  second-level maintenance or support to your personnel that has taken  charge of the management of your installation of Snap4City tools;\norganizing and managing hackathons and coworking sections for your stakeholders;\ntraining your operative personnel for using the platform, creating dashboards, IoT Applications, installing the platform, etc. (this can be personalized or cumulated in training days and week with other References/Customers), it can be on our location or  your premise;\ndeveloping data analytics over those that are freely provided, and/or setting up data analytics that needs learning phases on your premise; For example, the development and/or the set up of traffic flow reconstruction solution in your city and/or area;\ndeveloping new mobile Apps, tools, and applications; or new modules in our Apps of the "FIWARE servicesx in a Snap" series;\ndeveloping customization of the SnapBot Telegram bot attached to your solution based on Snap4City technology;\ndeveloping new IoT Devices with requested sensors and actuators;\nhelp desk support on all the aspects over an exceeding amount of hours that are free of charge;</p>\n<p>Smart Cities/Industries companies need to set up a flexible Living Lab to cope with their evolution in terms of services and city users’ needs and sustainability. Snap4City is a 100% open-source platform used in many cities and areas. It is an official FIWARE Platform and Solution (https://www.snap4city.org/467, https://www.fiware.org/) developed under the coordination of DISIT Lab of the University of Florence, Italy. Snap4City is GDPR compliant, passed PENTest, and it is an EOSC platform, an official Node-RED Library, an official E015 API, etc. The platform is provided as a “ Service” basis or installed in your location (by yourself, as well as using a number of companies), no license fee is needed. The platform has at present a wide range of activities in the smart city and IoT/IoE (Internet of Things/Internet of Everything) integrated domains: defining city strategies, implementing control room, realizing ethics and explainable artificial intelligent solutions, and computing key performance indicators which are used daily in both city and industry management.\nSnap4City has incorporated Km4City (https://www.km4city.org) ontological and semantic model to guarantee the data interoperability with any kind of IoT Devices, device models, data entities, and physical structures ranging from the city, industry, and home. And thus, also with FIWARE Smart Data Models, providing a number of real-time open-source solutions to support decision-makers in cities and large industries to ground their daily operational actions on solid explainable artificial intelligence predictions, deductions, and assessments. It provides a complete understanding of the context and its trends, receiving an early warning, anomaly detections, and performing simulation and what-if analysis. This information is used to suggest strategic interventions to improve city services and general quality of life, in multiple domains (e.g., Smart Cities and Smart Industry).\nThe proposed solution is flexible enough to support extensions at different levels of granularity: data, analytics, tools, applications, MicroServices, and IoT brokers. In this regard, the solution uses FIWARE Orion Broker based on NGSI to connect with a large number of devices thanks to the IoT Directory and Km4City Knowledge base. The solution also developed NGSI compliant IoT Edge of several kinds. Snap4City is also compliant with other protocols and models such as MQTT, AMQP, OneM2M, SigFOX, LoraWAN, and many others.</p>',
      challenge: '',
      references:
        '<p>Snap4City is operative with services and data in more than 40 cities/areas in countries such as Firenze (IT), Helsinki (FI), Antwerp (BE), Lonato del Garda (IT), Lavagno (IT), Valencia (SP), Pont Du Gard (FR), WestGreece (GR), Mostar (BA), Dubrovnik (KR), Santiago di Compostela (SP), Pisa (IT), Prato (IT), Pistoia (IT), Lucca (IT), Arezzo (IT), Grosseto (IT), Livorno (IT), Siena (IT), Massa (IT), Modena (IT), Cagliari (IT), Venezia (IT), Roma (IT), etc.; and from regions as Tuscany (IT), Garda Lake (IT), Svealand Region (Sweden), Sardegna (IT), Belgium (BE), Finland (Fl), Emilia Romagna (IT), Spain (SP), WestGreece (GR), Occitanie (FR), Bosnia-Herzegovina (BA), Croatia (KR), and many industries.</p>',
      awards:
    ...
    'teamdev-fiwareprofessionalservices': {
      ...
      yearOfValidation: 2014,
      description:
        '<p>TeamDev is a software house founded in 2008 that designs and develops innovative solutions to make data actionable for industrial digitalization, sustainable development and urban management. Areas of action:\nSmart Industry: We design and develop Industry 4.0 solutions ranging from advanced analytics to human machine interfaces and AI powered manufacturing control systems.\nDigital PA: We deliver consulting services to international organizations and Public Administrations engaged in sustainable development and international cooperation projects.\nSmart City: We support local governments with a comprehensive suite of solutions that range from civic technologies to advanced decision support systems for local administrators.\nThanks to our wide range of skills and multisectorial projects, we can provide teaching, mentoring, and on-the-job training, as well as outsourced support related to the use of FIWARE technologies in multiple frameworks.\nTechnical expertise: AI, GIS, IoT, Data Visualization, BIG DATA, Remote Sensing, Predictive Maintenance, advanced HMI and UX design.</p>',
      challenge: '',
      references:
    ...
    'ubiwhere-fiwareubiwhere': {
      ...
      yearOfValidation: 2017,
      description:
        "<p>FIWARE plays a significant role in our Smart City strategy, playing the part of the standardization layer that brings all its Smart Cities’ solutions and data sources together.</p>\n<p>FIWARE has allowed Ubiwhere to set up a sophisticated Smart City infrastructure powered by standards and interoperable at its core. With pilots beginning to spread throughout Portugal, the first major challenge came with the set-up of Porto (Portugal's second-largest city and a member of OASC) Smart City Node.\nWith the support of Ubiwhere, Porto has been a pioneer city adopting FIWARE standards and together have developed the interfaces bringing access to real-time, contextual environmental data from 75 fixed and mobile units (monitoring stations) located across the city.</p>\n<p>Scanners installed on the City Council’s 200+ fleet of vehicles enhance the data, creating a large-scale mobile scanner. External providers like the city’s water supplier, transport data providers, social media data, and business startup statistics are all plugged into FIWARE's platform to allow the city itself to guide you as you explore, travel, and work.</p>",
      challenge: '',
      references:
      ...
      materials: [
        ...
        [
          'Reference 2',
          'https://ec.europa.eu/digital-agenda/en/blog/fiware-making-cities-smarter'
        ],
        [
          'Reference 3',
          'http://www.porto.pt/noticias/porto-fiware-e-sucesso-no-mundo'
        ],
        [
          'Reference 4',
          'http://smart-cities.pt/pt/noticia/75-cidades-partilham-dados-no-fiware9/'
  ...
  unknown: {
    'connectingeuropefacility-contextbrokerbdtiintegration': {
      ...
      yearOfValidation: 2020,
      description:
        '<p>The solution has the following capabilities:</p>\n<p>Manages Context Brokers subscriptions to Cygnus (create and delete)\nSets how and where the context data will be stored\nAutomatically deploys Cygnus each time a change in its configuration is done</p>\n<p>All this information is provided by a configuration file that establishes the parametric to do so.</p>\n<p>Get Started with Big Data Test Infrastructure and Context Broker. Public Administrations can apply to discover new ways to draw data-driven insight for strategic making decisions. For more information on how to get started to use BDTI please click on the following links: </p>\n<p>https://ec.europa.eu/cefdigital/wiki/display/CEFDIGITAL/Big+Data+Test+Infrastructure</p>\n<p>Are you interested in the Success Story of CEF Context Broker and BDTI? Would you like to know how the Context Broker and BDTI have contributed to improving the quality of life of European’s cities and regions? Do you know what the main benefits of using the Context Broker for Developers and Service Providers are?\nContext Broker: https://ec.europa.eu/cefdigital/wiki/display/CEFDIGITAL/Context+Broker\nBDTI: https://ec.europa.eu/cefdigital/wiki/display/CEFDIGITAL/Big+Data+Test+Infrastructure</p>',
      challenge:
    ...
    'connectingeuropefacility-contextbrokerdatavisualisation': {
      ...
      yearOfValidation: 2020,
      description:
        '<p>In order to ease the effort needed .for new stakeholders to start using the Context Broker, the Context Broker Data Visualisation was created. It consists of an enabler that provides a visualization layer over the Context Broker, intending to be used for playground purposes and as a means to experiment with the Context Broker in an easy manner. The enabler makes it easier for new users to become familiar with the Context Broker and provides a way to get to know its functionalities and advantages in a user-friendly way. It is a learning tool for data visualization, not a product.</p>\n<p>The Context Broker Data Visualization provides the following features: </p>\n<ul>\n<li>Real-time data visualization through geo-localized sensors on a map, based on the information from the Orion Context Broker. </li>\n<li>Historical data visualization for the sensors in table and graph format, taking advantage of historical data tools such as Cygnus and STH-Comet. </li>\n<li>Easy Configuration page for the integration with a Context Broker instance and the historical data tools. </li>\n<li>Integration with more than one Context Broker instance at the same time. </li>\n<li>Deployment in local environments or FIWARE lab (Sandbox). The enabler could also be adapted to the needs of each user by developing its own features and reusing the base of the enabler</li>\n</ul>',
      challenge:
