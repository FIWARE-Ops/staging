var pageData = {
    powered: {
        'uiurbansoftware-uiurbanpulse': {
            ...
            domains: ['Air Quality', 'Lighting', 'Measurement', 'Mobility', 'Sustainability'],
            docs: [],
            videos: [],
            materials: [],
            logo:
        ...
        'accelogresslimited-saveaspace': {
            ...
            awards: '',
            technologies: ['Data Analytics', 'Internet of Things', 'Mobility and Location', 'Software as a Service'],
        ...
        'agricolus-agricolus': {
            ...
            videos: [
                ['Making AgriTech Sustainable', 'https://www.youtube.com/watch?v=hVHW7QIJMd8'],
                ["Agricolus' features", 'https://www.youtube.com/watch?v=6_ZOFydADZQ']
            ],
            materials: [['Press & Media Gallery', 'https://www.agricolus.com/en/press-and-media-gallery/']],
        ...
        'amigo-indexdesignandanalysis': {
            ...
            videos: [
                ...
                ['One-Page Investor IDA', 'https://drive.google.com/file/d/15Py4axQsldErIMQ1v7BD3lZHfurZBgPM/view']
            ],
            materials: [['Interview-Marcello Petitta-YouTube', 'https://www.youtube.com/watch?v=nE7l0ZYivbo&t=13s']],
        ...
        'atos-masai': {
            ...
            awards: '',
            technologies: ['Internet of Things', 'Additive Manufacturing', 'Data Analytics'],
            domains: ['Industry'],
        ...
        'bettaircities-bettair': {
            ...
            awards: '',
            technologies: ['Internet of Things', 'Data Analytics', 'Open Data', 'Sensory Systems'],
        ...
        'bosonit-elliotcloud': {
            ...
            docs: [['Bosonit Technology', 'https://bosonit.com/en/category/technology/']],
            videos: [],
            materials: [],
        ...
        'cardioid-cardiowheel': {
            ...
            technologies: ['Internet of Things', 'Data Analytics'],
            domains: ['Health'],
            docs: [['CarioID Technologies', 'https://www.fiware.org/success_stories/cardioid-technologies']],
            videos: [],
            materials: [
                [
                ...
                ['CarioWheel - The Next Big Idea', 'https://thenextbigidea.pt/organizacoes/cardiowheel/']
            ],
        ...
        'ciclogreenmovewin-ciclogreen': {
            ...
            awards: '',
            technologies: ['Big Data', 'Gamification', 'Mobility and Location', 'Software as a Service'],
            domains: ['Cities', 'Green Deal', 'Mobility', 'Sustainability', 'Transport'],
            docs: [],
        ...
        'civity-snifferbike': {
            ...
            materials: [
                ['AD News', 'https://www.ad.nl/auto/snuffelfiets-speurt-naar-schone-routes~abce8ea7/'],
        ...
        'dksr-openurbandataplatform': {
            ...
            videos: [],
            materials: [
                ['Kommune21-News', 'https://www.kommune21.de/meldung_35791_Basis+f%C3%BCr+die+Stadt+der+Zukunft.html']
            ],
        ...
        'egm-carpoolparking': {
            ...
            awards: '',
            technologies: ['Advanced or High Performance Computing', 'Cloud Computing', 'Mobility and Location'],
        ...
        'egm-connectedcanteens': {
            ...
            awards: '',
            technologies: ['Data Analytics', 'Screens and Display', 'Sensory Systems'],
            domains: ['AgriFood', 'Measurement', 'Waste Management'],
            docs: [],
            videos: [
                ['Connected Canteens-YouTube', 'https://www.youtube.com/watch?v=QL6Oa2-swdA&t=13s'],
        ...
        'elmitel-evineyard': {
            ...
            yearOfValidation: 2017,
            description:
                '<p><strong>eVineyard</strong> matches the latest technology and science with the real needs of the winegrowers to help you grow grapes in the best way possible.</p>',
            challenge:
        ...
        'faubourgnumérique-ouranosws': {
            ...
            references: '',
            awards: '',
            technologies: ['Data Spaces', 'Digital Twins', 'Internet of Things', 'Modelling'],
            domains: ['Cities', 'Industry', 'Logistics'],
            docs: [],
            videos: [['Intro 2021-YouTube', 'https://www.youtube.com/watch?v=P5nwT_gE6Lg']],
            materials: [],
        ...
        'fiwoo-fiwoo': {
            ...
            awards: '',
            technologies: ['Artificial Intelligence', 'Big Data', 'Cloud Computing', 'Internet of Things', 'Open Data'],
            domains: ['Agriculture', 'Cities', 'Industry', 'Mobility', 'Tourism'],
            docs: [],
            videos: [
                ['IoT Editor-YouTube', 'https://www.youtube.com/watch?v=1NgHbPg5BkE&t=17s'],
                ['Functionalities-YouTube', 'https://www.youtube.com/watch?v=I4Py1EA86nY&t=210s'],
            ...
            materials: [
                ...
                ['Woover.', 'https://woover.es/fiwoo-punto-de-encuentro-entre-emergya-grupo-woover-y-secmotic/'],
                [
                    'Smart City Cluster',
        ...
        'floud-floud': {
            ...
            videos: [
                ['Magenta - SOUL-FI Testimonial', 'https://www.youtube.com/watch?v=6k5Jan1RNeg'],
                ['Traffic Flow Sensors Overview', 'https://trafficflowdemo.floud.eu/app/overview.php']
            ],
            materials: [],
        ...
        'fueloyal-fueloyal': {
            ...
            docs: [],
            videos: [['Vehicle GPS Tracking & Fuel Management-YouTube', 'https://www.youtube.com/watch?v=eaJP0B0N48c']],
            materials: [],
        ...
        'futureintelligence-quhoma': {
            ...
            domains: ['Agriculture', 'AgriFood', 'Cities', 'Green Deal', 'Parks &amp; Gardens'],
            docs: [],
            videos: [],
            materials: [
                ['TPorganics', 'http://tporganics.eu/?s=quhoma'],
                ['Quhoma-YouTube', 'https://www.youtube.com/watch?v=BYNb_QXQy1c&t=1811s'],
                [
                    'naftemporiki-YouTube',
                    'https://www.youtube.com/watch?v=rKRAkOXN2wo&list=PLwDocBHWTPAODtUE32f3TKfTtcJAwgfoV&index=39'
                ],
                ['Naftemporiki-Report', 'https://events.naftemporiki.gr/agrotiko/ReportAndConcludingRemarks'],
                [
                    'Agrocaptial-News',
        ...
        'helix-helix': {
            ...
            awards: '',
            technologies: ['Internet of Things'],
            domains: ['Cities', 'AgriFood', 'Logistics', 'Industry', 'Ports', 'Retail', 'Home', 'Health', 'Content'],
        ...
        'hopu-lowemissionzones': {
            ...
            references: '',
            awards: '',
            technologies: ['Artificial Intelligence', 'Data Analytics', 'Digital Twins', 'Modelling', 'Open Data'],
        ...
        'hostabee-bkeep': {
            ...
            docs: [],
            videos: [['Hostabee - Start-up Stories', 'https://www.dailymotion.com/video/x6l12n6']],
            materials: [
                [
                    'RTL-News',
        ...
        'jig-smartappcity': {
            ...
            videos: [
                ...
                ['App-Google Play', 'https://play.google.com/store/apps/details?id=com.jig.ayuntlogrono&hl=es'],
                ['App-AppStore', 'https://apps.apple.com/es/app/logro%C3%B1o-es/id562978369']
            ],
            materials: [
                ['eSMARTCITY', 'https://www.esmartcity.es/comunicaciones/smartappcity-app-para-ciudades-inteligentes'],
                ['Applicantes-News', 'https://applicantes.com/2014-smartappcity-servicios-una-aplicacion/'],
                ['SMART TRAVEL-News', 'https://www.smarttravel.news/smartappcity-la-app-de-las-ciudades-inteligentes/'],
                [
                    'LARAZON-News',
        ...
        'lahakx-skyxpass': {
            ...
            references: '',
            awards: '',
            technologies: ['Internet of Things', 'Logistsics', 'Micro/Nano Electronics'],
            domains: ['AgriFood'],
            docs: [],
            videos: [
                ['Detect and Avoid-YouTube', 'https://www.youtube.com/watch?v=NFLwfrhEQqQ'],
        ...
        'limmatgroup-imas': {
            ...
            docs: [],
            videos: [['Brochure', 'https://issuu.com/limmat-group/docs/imas-smart_maintenance_platform.']],
            materials: [
                [
                ...
                ['HOY-News', 'https://www.hoy.es/extremadura/limmat-predecira-averias-20190411222426-nt.html'],
                [
                    'segoviaudaz.es-News',
        ...
        'líneaciudadana-líneaciudadana': {
            ...
            references:
                '<ul> <li>City Council of Lucena</li> <li>City Council of Puertollano </li> <li>City Council of Iznájar </li> <li>City Council of Medina del Campo </li> <li>City Council of Benavente</li> <li>City Council of Moralzarzal </li> <li>City Council of Orihuela</li> <li>City Council of Pizarra</li> <li>City Council of Torrelodones </li> <li>City Council of Tres Cantos</li> <li>City Council of Turre</li> <li>City Council of Yecla </li> <li>City Council of Zambrana</li> </ul>',
            awards: '',
        ...
        'martelinnovate-orchestracities': {
            ...
            docs: [['Architecture', 'https://docs.orchestracities.io/en/latest/architecture/']],
            videos: [],
            materials: [
                ['Orchestra Cities-YouTube', 'https://www.youtube.com/watch?v=qePvlQn399k'],
        ...
        'movisat-ecosat': {
            ...
            awards: '',
            technologies: ['Artificial Intelligence', 'Data Analytics', 'Sensory Systems', 'Software as a Service'],
            domains: ['Cities', 'Government', 'Parks &amp; Gardens', 'Sustainability', 'Waste Management'],
            docs: [],
            videos: [],
            materials: [
                [
        ...
        'nixi1-nixi1': {
            ...
            docs: [],
            videos: [
                ['Demo Chatnfly WhatsApp-YouTube', 'https://www.youtube.com/watch?v=GD9ZsmNu48M'],
                ['Demo Chatnfly Hotels WhatsApp-YouTube', 'https://www.youtube.com/watch?v=x8JYMHV7a4I']
            ],
            materials: [],
        ...
        'openmove-openmove': {
            ...
            awards: '',
            technologies: ['Data Spaces', 'Mobility and Location', 'Open Data', 'Software as a Service'],
        ...
        'phoops-muvapp': {
            ...
            references: '',
            awards: '',
            technologies: ['Mobility and Location', 'Open Data', 'Software as a Service'],
            domains: ['Air Quality', 'Automotive', 'Logistics', 'Mobility', 'Transport'],
            docs: [
        ...
        'profirator-lakesprofispace': {
            ...
            domains: ['Cities'],
            docs: [
                ['Getting Started-Guidance ', 'https://lakes.profi.space/documentation'],
                [
                    'Overview',
        ...
        'projectray-ray': {
            ...
            technologies: ['Internet of Things', 'Data Analytics'],
            domains: ['Cities', 'Health'],
            docs: [['Documentation & Guides', 'https://project-ray.com/products/ray-vision/']],
            videos: [['User Guide-YouTube', 'https://www.youtube.com/watch?v=QPDJMuXtb1k']],
            materials: [],
        ...
        'purpleblob-baret': {
            ...
            domains: ['Smart Cities'],
            docs: [
                ['Presentation', 'https://baret.es/wp-content/uploads/2022/01/BARET-FIWARE-for-Smart-Destinations.pdf'],
                ['Brochure ', 'https://baret.es/wp-content/uploads/2022/01/3.007.6-Baret_en-brochure.pdf']
            ],
            videos: [],
            materials: [
                [
        ...
        'purpleblob-sara': {
            ...
            references:
                '<ul> <li>Ayuntamiento de Galdakao</li> <li>Grupo Amper</li> <li>Sarenet</li> <li>Autoridad Portuaria de Bilbao</li> <li>Terres del Maestrat</li> <li>Vaillant</li> <li>Mideos</li> <li>Ayuntamiento de La Nucía</li> <li>Consorcio de transportes de Bizkaia (CTB)</li> </ul>',
            awards: '',
            technologies: [
                'Artificial Intelligence',
                'Blockchain',
            ...
            domains: ['Cities', 'Industry', 'Measurement', 'Mobility', 'Utilities', 'Oil and Gas'],
            docs: [
                [
        ...
        'sensative-yggioplatform': {
            ...
            challenge: '',
            references:
                '<ul> <li>The city of Lund</li> <li>City of Malmö</li> <li>Municipality of Sundbyberg </li> <li>VaSyd</li> <li>C4 Energi </li> <li>Kraftringen </li> <li>HFAB</li> <li>Akelius </li> <li>Castellum</li> </ul>',
            ...
            domains: ['Agriculture', 'Cities', 'Construction and Building', 'Energy', 'Water'],
            docs: [
                ['Technology Overview', 'https://sensative.com/yggio/yggio-overview/'],
                ['Horizontal IoT Architecture', 'https://sensative.com/yggio/horizontal-model/'],
                [' IoT Interoperability Platform', 'https://sensative.com/yggio/more-than-fiware/']
            ],
            videos: [],
            materials: [
                [
                ...
                ['Future By Lund', 'https://www.futurebylund.se/smarta-offentliga-miljoer'],
                [
        ...
        'sensei-sensei': {
            ...
            references: '',
            awards: '',
            technologies: ['Artificial Intelligence', 'Data Analytics', 'Internet of Things'],
            domains: ['Content'],
            docs: [],
        ...
        'sensohivetechnologiesaps-maturix': {
            ...
            domains: ['Industry'],
            docs: [],
            videos: [['Maturix-YouTube', 'https://www.youtube.com/watch?v=sgcErItCgRg']],
            materials: [],
        ...
        'sensowave-digitanimal': {
            ...
            domains: ['AgriFood'],
            docs: [],
            videos: [['YouTube Channel', 'https://www.youtube.com/channel/UCvmW-L2u6dL33BCF1cTJkuQ']],
            materials: [
                [
        ...
        'snap4city-km4city': {
            ...
            docs: [
                ...
                ['Platform Overview', 'https://www.snap4city.org/download/video/Snap4City-PlatformOverview.pdf'],
                ['Tutorials', 'https://www.snap4city.org/drupal/node/108']
            ],
            videos: [
                ['Promo Video-YouTube', 'https://www.youtube.com/watch?v=UPpC9gbvEPs&t=1s'],
                ['Industry City Integration-YouTube', 'https://www.youtube.com/watch?v=s5NW8V5-yxw'],
                [' Smart city & Living Lab-YouTube', 'https://www.youtube.com/watch?v=41ciVrwX9Go'],
                ['Create IoT Application-YouTube', 'https://www.youtube.com/watch?v=T9Sp2XrLkuc&t=49s'],
            ...
            materials: [
                ...
                ['Snap4City & Km4City References ', 'https://www.snap4city.org/drupal/node/426'],
        ...
        'snap4city-snap4city': {
            ...
            docs: [
                ...
                ['Platform Overview', 'https://www.snap4city.org/download/video/DPL_SNAP4CITY_2022-v02.pdf'],
                ['Industry', 'https://www.snap4city.org/download/video/DPL_SNAP4INDUSTRY_2022-v03.pdf'],
        ...
        'srmconsulting-capacitycontrolsystem': {
            ...
            references: '',
            awards: '',
            technologies: ['Artificial Intelligence', 'Internet of Things', 'Data Analytics'],
        ...
        'stoneone-smartorchestra': {
            ...
            docs: [],
            videos: [
                ['S1 IoT Platform-YouTube', 'https://www.youtube.com/watch?v=B2Yjbf4OKv4'],
                ['S1 IoT Platform for Industry-YouTube', 'https://www.youtube.com/watch?v=8CQICa57hCg']
            ],
            materials: [],
        ...
        'teamdev-wisetown': {
            ...
            domains: ['Cities', 'Government', 'Mobility', 'Security', 'Utilities', 'Oil and Gas'],
            docs: [],
            videos: [
                ['GCTC’16 -ANDREA CRUCIANNI-Vimeo', 'https://vimeo.com/172887166'],
                ['YouTube Channel', 'https://www.youtube.com/channel/UCT_epf3tfO6iO8zEnN3dYJA'],
                ['Request a Demo', 'https://wise.town/en/request-a-demo/'],
                ['Press Release', 'https://wise.town/wp-content/uploads/2021/01/PRESS-RELEASE-WT-2020_.pdf'],
                [
            ...
            materials: [
                ...
                ['FIWARE-Success Stories', 'https://www.fiware.org/success-stories/wise-town/'],
                [
                    'FIWARE-Article',
        ...
        'teamdev-wisetowncrowdplanning': {
            ...
            domains: ['Cities', 'Government', 'Sustainability', 'Utilities', 'Oil and Gas'],
            docs: [],
            videos: [],
            materials: [
                [
        ...
        'teamdev-wisetowngeoanalytics': {
            ...
            domains: ['Cities', 'Government', 'Mobility', 'Sustainability', 'Utilities', 'Oil and Gas'],
            docs: [],
            videos: [],
            materials: [
                ['WiseTown-Story', 'https://wise.town/en/portfolio-items/water-point-mapping/'],
                [
                    'FIWARE-Impact Story',
                    'https://www.fiware.org/2021/11/15/perugias-digital-transition-to-smart-city-powered-by-fiware-technology/'
                ]
        ...
        'teamdev-wisetownopendatamanager': {
            ...
            awards: '',
            technologies: ['Cloud Computing', 'Data Analytics', 'Data Handling', 'Open Data', 'Service Architectures'],
            domains: ['Cities', 'Construction and Building', 'Government', 'Tourism', 'Utilities', 'Oil and Gas'],
            docs: [],
            videos: [],
            materials: [
                [
        ...
        'teamdev-wisetownsituationroom': {
            ...
            domains: ['Cities', 'Government', 'Security', 'Tourism', 'Utilities', 'Oil and Gas'],
            docs: [],
            videos: [],
            materials: [
                [
                ...
                ['WiseTown-Story', 'https://wise.town/en/portfolio-items/smart-security-app/']
            ],
            logo: 'https://www.fiware.org/style/imgs/Marketplace/product/powered-by-fiware/solution/logo_WiseTown.svg',
            featuredImage:
                'https://www.fiware.org/wp-content/marketplace/images/hero_teamdev_wisetown-situation-room.png',
        ...
        'teamdev-wisetownthematicdashboard': {
            ...
            domains: ['Cities', 'Government', 'Parks &amp; Gardens', 'Utilities', 'Oil and Gas', 'Water'],
            docs: [],
            videos: [],
            materials: [
                [
        ...
        'telefónica-thinkingcities': {
            ...
            docs: [['Documentation', 'https://thinking-cities.readthedocs.io/en/latest/index.html']],
            videos: [['Smart City Platform-YouTube', 'https://www.youtube.com/watch?v=KGzaEAOt1Q0']],
            materials: [
                ['Telefonica Blog', 'https://empresas.blogthinkbig.com/grandes-empresas-espana/'],
                ['ThinkBig Blog', 'https://blogthinkbig.com/peoplefirst/santander-smart-city/'],
        ...
        'tera-beeta': {
            ...
            awards: '',
            technologies: ['Sensory Systems', 'Cloud Computing', 'Data Analytics', 'Internet of Things'],
            domains: ['Cities', 'Home'],
            docs: [],
            videos: [
                [
        ...
        'tsenso-freshindex': {
            ...
            docs: [],
            videos: [
                ['TSENSO Pitch-YouTube', 'https://www.youtube.com/watch?v=ofNJeg8UBWA&t=6s'],
                ['Tseno Team-YouTube', 'https://www.youtube.com/watch?v=khZhr4wUS_c'],
                ['Temperature Monitoring-YouTube', 'https://www.youtube.com/watch?v=TQQlZyCn4fY'],
                ['Espresso Pitch-YouTube', 'https://www.youtube.com/watch?v=gwdY2pLU2PY']
            ],
            materials: [
                [
        ...
        'ubikwa-insylo': {
            ...
            videos: [
                ...
                ['Smart Monitoring of Silos-YouTube', 'https://www.youtube.com/watch?v=ck6VKKisHb8']
            ],
            materials: [
                ['Rtve Play-Ubikwa', 'https://www.rtve.es/play/videos/fabrica-de-ideas/fdiinvierte-ubikwa/3835464/'],
                [
                    'Ara-Article',
                    'https://www.ara.cat/ciencia-medi-ambient/insylo-grangers-controlar-sitges-mwc_8_3917726.html'
                ],
                ['Irish Examiner-Article', 'https://www.irishexaminer.com/farming/arid-20387906.html'],
        ...
        'ubiwhere-urbanplatform': {
            ...
            videos: [
                ...
                ['Urban Platform-YouTube', 'https://www.youtube.com/watch?v=fMkyE_6BSGc&t=1s']
            ],
            materials: [
                ['FIWARE-Article', 'https://www.fiware.org/2015/11/20/porto-a-city-that-has-become-a-real-time-guide/']
            ],
        ...
        'viur-viur': {
            ...
            yearOfValidation: 2017,
            description:
                '<p><strong>Viur</strong> connects all your databases, cloud services, and files and in seconds you can start exploring your data using drag &amp; drop or writing your own SQL queries. Share your most important metrics with your team or with the whole world.</p>',
            challenge:
        ...
        'witrac-witrac': {
            ...
            references: '',
            awards: '',
            technologies: ['Internet of Things', 'Data Analytics', 'Artificial Intelligence'],
            domains: ['Cities', 'Industry'],
            docs: [],
            videos: [['Smart City Solutions', 'http://witrac.es/videos/smartcities.mp4']],
            materials: [],
        ...
        'yerbabuenavr-ybvr': {
            ...
            yearOfValidation: 2018,
            description:
                '<p><strong>YBVR</strong> is a solution designed to optimize the distribution of quality VR video streaming for every device on any network. ​ We are creating VR 360 video streaming technology optimized for any available bandwidth condition. We envision to become the pioneers of real-time VR video platforms supporting massive live events such as sports and concerts.</p>',
            challenge:
        ...
        'amazonwebservices-smartterritoryframework': {
            ...
            domains: ['Cities', 'Energy', 'Sustainability', 'Utilities', 'Oil and Gas', 'Water'],
            docs: [
                ['GitHub', 'http://github.com/aws-samples/aws-stf'],
                ['Foundations for Smart Territories', 'http://www.youtube.com/watch?v=4MRZiC1VvKQ'],
            ...
            videos: [
                ...
                ['Heidelberg meets Smart Territory Framework ', 'http://www.youtube.com/watch?v=Q_fADZFZqSE'],
        ...
        'hypertegrityag-urbandataspaceplatformudsp': {
            ...
            references: '<p>More than 7+ German Municipalities or Municial Enterprises (e.g. Berlin Tegel GmbH)</p>',
            awards: '',
            technologies: [
                'Data Spaces',
                'Internet of Things',
            ...
            domains: ['Cities', 'Construction and Building', 'Energy', 'Government', 'Sustainability'],
            docs: [],
            videos: [],
            materials: [],
            logo:
        ...
        'engineeringingegneriainformatica-extendeddigitaltwinofsmartbuildings': {
            ...
            domains: ['Cities', 'Construction and Building', 'Energy', 'Sustainability'],
            docs: [],
            videos: [],
        ...
        'addixgmbh-adifi': {
            ...
            awards: '<p>-</p>',
            technologies: ['Data Analytics', 'Data Spaces', 'Mobility and Location', 'Open Data', 'Sensory Systems'],
    ...
    ready: {
        ...
        'axion-traxion': {
            ...
            technologies: ['Data Analytics', 'Internet of Things', 'Software as a Service'],
            domains: ['Cities', 'Logistics', 'Retail and Wholesale', 'Security', 'Telecommunication'],
            docs: [],
            videos: [['Traxión ENG-YouTube', 'https://www.youtube.com/watch?v=qlYKY5BjqDM']],
            materials: [],
        ...
        'breezetechnologies-breezeairqualitysensors': {
            ...
            videos: [['YouTube Channel', 'https://www.youtube.com/channel/UCqRNWyXf5yexIRTzLvY9Zqw']],
            materials: [
        ...
        'cedesadigital-lapsowork': {
            ...
            docs: [],
            videos: [['Lapsowork-YouTube', 'https://www.youtube.com/watch?v=-Wom6DH969E']],
            materials: [],
        ...
        'datakorumsolutions-beat': {
            ...
            domains: ['Cities'],
            docs: [
                ['Technical specifications', 'https://www.fiware.org/wp-content/uploads/2018/12/BEAT20_eng.pdf'],
                [
                    'Manual Template',
        ...
        'datakorumsolutions-lane': {
            ...
            technologies: ['Internet of Things', 'Cloud Computing'],
            domains: ['Cities'],
            docs: [['Technical specifications', 'https://www.fiware.org/wp-content/uploads/2018/12/LANE20_eng.pdf']],
            videos: [],
            materials: [],
            logo: 'https://www.fiware.org/style/imgs/Marketplace/product/fiware-ready/iot-device/logo_Datakorum.svg',
        ...
        'datakorumsolutions-plug': {
            ...
            domains: ['Cities'],
            docs: [
                ['Features', 'https://www.fiware.org/wp-content/uploads/2018/12/POLE-PLUG-TINY.pdf'],
                [
                    'Manual',
        ...
        'distromel-sigeus': {
            ...
            domains: ['Cities', 'Logistics', 'Mobility', 'Sustainability', 'Waste Management'],
            docs: [],
            videos: [],
            materials: [
                [
        ...
        'eficae-miluz': {
            ...
            references: '',
            awards: '',
            technologies: ['Communication Networks', 'Internet of Things', 'Sensory Systems', 'Service Architectures'],
            domains: ['Cities', 'Construction and Building', 'Electronics', 'Industry', 'Lighting'],
            docs: [],
            videos: [],
            materials: [],
        ...
        'egm-edgespot': {
            ...
            docs: [
                ['Technical features', 'https://www.egm.io/wp-content/uploads/2021/08/fiche-EGM-EdgeSpot-2-EN-3.pdf']
            ],
            videos: [],
            materials: [
                ['LOTUS Project', 'https://www.lotus-india.eu/'],
                ['Overview in French', 'https://www.egm.io/wp-content/uploads/2021/08/fiche-EGM-EdgeSpot-2-3.pdf']
            ],
        ...
        'engineering-knowage': {
            ...
            domains: ['Financial Services', 'Government', 'Healthcare', 'Industry', 'Manufacturing'],
            docs: [
                ['Official documentation', 'https://knowage-suite.readthedocs.io/en/8.0/'],
                ['KNOWAGE on FIWARE', 'https://knowage.readthedocs.io/en/latest/']
            ],
            videos: [['KNOWAGE DEMO', 'https://www.knowage-suite.com/site/resources/knowage-demo/']],
            materials: [
                ['Success Stories', 'https://www.knowage-suite.com/site/resources/success-stories/'],
        ...
        'gecorsystem-gecor': {
            ...
            videos: [
                ...
                ['Gecor System', 'https://www.youtube.com/watch?v=B127YqL1z7U&ab_channel=Gecor']
            ],
            materials: [
                [
                ...
                ['ALCALDE DE MÁLAGA Interview', 'https://www.youtube.com/watch?v=m9C5r41RapQ'],
        ...
        'greenglobesypa-nighteyeskysensor': {
            ...
            awards: '',
            technologies: ['Internet of Things', 'Modelling', 'Open Data', 'Photonics and Imaging', 'Sensory Systems'],
            domains: ['Air Quality', 'Cities', 'Energy', 'Government', 'Lighting'],
            docs: [],
            videos: [],
            materials: [['Astrotourism', 'https://www.cielosdealgeciras.es/astroturismo/']],
        ...
        'hopu-smartspot': {
            ...
            docs: [
                ...
                ['Ubiquitous documentation', 'https://hop-ubiquitous-documentation.readthedocs.io/en/latest/'],
                [
                    'Documentation in Spanish',
                    'file:///Users/mac/Downloads/datasheet%20smart%20spot%20global%202021%20v3.pdf'
                ],
                ['Architecture Presentation', 'file:///Users/mac/Downloads/English_HOPU_WednesdayFIWARE24062020.pdf']
            ],
            videos: [['[HOPU on Vimeo](Video Tutorials "HOPU on Vimeo")', 'https://byhs.eu/senda/videos/']],
            materials: [
                ['Urban Innovation Award 2020', 'https://hopu.eu/hopu-le-monde-2020-award/'],
                ['Impact Stories', 'https://www.fiware.org/wp-content/uploads/2020/06/FF_ImpactStories_Hopu.pdf'],
                [
        ...
        'libelium-meshlium': {
            ...
            domains: ['Cities'],
            docs: [['Technical Guide', 'https://development.libelium.com/meshlium/documentation']],
            videos: [
                ['Webinar: Cloud Platforms-YouTube', 'https://www.youtube.com/watch?v=Ol7PE0-mfhE'],
        ...
        'libelium-plugsense': {
            ...
            docs: [],
            videos: [
                ['Smart Parking Webinar-YouTube', 'https://www.youtube.com/watch?v=EnUdBrLepqI&t=754s'],
                ['Smart Water Quality Monitoring-YouTube', 'https://www.youtube.com/watch?v=p7Yrs7k8rYY'],
                ['The IoT Marketplace', 'https://www.the-iot-marketplace.com/'],
        ...
        'montemas-cityprobe2': {
            ...
            awards: '',
            technologies: ['Data Analytics', 'Data Spaces', 'Digital Twins', 'Internet of Things', 'Open Data'],
            domains: ['Air Quality', 'Cities'],
            docs: [],
            videos: [['Video', 'https://cityflow.live/videos/CP2-cover-1080p-trimmed-transcode.mp4']],
            materials: [],
        ...
        'odinsolutions-ipex04datalogger': {
            ...
            docs: [],
            videos: [['Success Case', 'http://www.odins.es/en/solutions/photovoltaic-energy-production/']],
            materials: [],
        ...
        'odinsolutions-ipex12datalogger': {
            ...
            domains: ['Cities', 'AgriFood', 'Industry'],
            docs: [],
            videos: [['Success Case ', 'https://www.odins.es/en/solutions/management-irrigation-communities/']],
            materials: [
                [
                    'La Verdad-Interview',
        ...
        'odinsolutions-ipex16datalogger': {
            ...
            domains: ['Cities', 'AgriFood', 'Industry'],
            docs: [
                ['Tech Aspect & Manual', 'https://www.fiware.org/wp-content/uploads/2018/12/FIWAREIoTIPEX16Manual.pdf']
            ],
            videos: [['Success Case', 'http://www.odins.es/en/solutions/hydroponic-greenhouses/']],
            materials: [],
            logo: 'https://www.fiware.org/style/imgs/Marketplace/product/fiware-ready/iot-device/logo_Odins.svg',
        ...
        'odinsolutions-mex06datalogger': {
            ...
            domains: ['Cities', 'AgriFood', 'Industry'],
            docs: [
                ['Tech Aspect & Manual', 'https://www.fiware.org/wp-content/uploads/2018/12/FIWAREIoTMEX06Manual.pdf']
            ],
            videos: [['Success Case', 'http://www.odins.es/en/solutions/crop-monitoring/']],
            materials: [
                [
                    'La Verdad-Interview',
                    'https://www.laverdad.es/ababol/ciencia/odin-solutions-20171023004031-ntvo.html'
        ...
        'secmotic-lockart': {
            ...
            awards: '',
            technologies: ['Internet of Things', 'Data Analytics', 'Open Data', 'Industrial Technology'],
            domains: ['Home'],
            docs: [],
            videos: [['Promo Video-YouTube', 'https://www.youtube.com/watch?v=lvholT9VZVs']],
            materials: [],
        ...
        'senecoas-citygrid': {
            ...
            awards: '',
            technologies: ['Communication Networks', 'Internet of Things', 'Sensory Systems'],
            domains: ['Cities', 'Energy', 'Lighting', 'Sustainability', 'Utilities', 'Oil and Gas'],
            docs: [
                [
            ...
            videos: [
                ['YouTube Channel', 'https://www.youtube.com/channel/UCM_O_iq_8oWVOWyGXAvP0Bw/featured'],
                ['Smart Lighting in Middelfart-YouTube', 'https://www.youtube.com/watch?v=oxDRm8tkvdchttp://'],
                ['How e-Sense Motion works ', 'https://vimeo.com/202912088']
            ],
            materials: [
                ['Press Relase', 'https://drive.google.com/file/d/1dEd_zdC9wqZVCKRxMMWGh75PqA06rQRw/view'],
                ['Seneco -Viborg References', 'https://drive.google.com/file/d/186texgjm0jN35jNpQiYKkOxMBHel6Wvt/view']
            ],
        ...
        'sensowave-digitanimal': {
            ...
            domains: ['AgriFood'],
            docs: [
                ['Technologies-Innovation Digitanimal', 'https://innovation.digitanimal.com/en/technologies/'],
        ...
        'sensowave-digitanimallivestockgps': {
            ...
            references: '',
            awards: '',
            technologies: ['Blockchain', 'Data Analytics', 'Data Handling', 'Sensory Systems', 'Software as a Service'],
            domains: ['Agriculture', 'AgriFood', 'Consumer Goods / Products', 'Green Deal'],
            docs: [],
            videos: [],
            materials: [],
            logo: 'https://www.fiware.org/style/imgs/Marketplace/product/fiware-ready/iot-device/logo_DigitAnimal.svg',
        ...
        'situmindoorpositioning-situmindoornavigation': {
            ...
            videos: [
                ['System Overview-YouTube', 'https://www.youtube.com/watch?v=QzJFFupuGpE'],
                [
            ...
            materials: [
                ...
                ['Carto-Use Cases', 'https://carto.com/blog/location-intelligence-for-indoor-maps/']
            ],
        ...
        'situmindoorpositioning-situmindoortracking': {
            ...
            references: '',
            awards: '',
            technologies: ['Data Analytics', 'Software as a Services', 'Internet Services'],
        ...
        'srmconsulting-fiwaremapviewer': {
            ...
            domains: ['Cities', 'AgriFood', 'Logistics', 'Industry', 'Health'],
            docs: [],
            videos: [['Maps', 'http://maps.geomotionvideo.com:30014/shared/maps/j7gxvj91wuijXs_']],
            materials: [],
        ...
        'tstsistemas-tscontrolindustrialcontrol': {
            ...
            videos: [['TSmart Tweet', 'https://twitter.com/TSTsistemas/status/324128164831969281']],
            materials: [],
        ...
        'tstsistemas-tsmartdevelopmentplatform': {
            ...
            docs: [
                ['Celestia Technology', 'https://celestia-tech.com/'],
                ['IoT Engineering ', 'https://tst-sistemas.com/en/tst/'],
                ['OrganiCity Tech Docs', 'https://docs.organicity.eu/tools/tsmart/tsmart/']
            ],
            videos: [['Wave Power Buoy Management Tweet', 'https://twitter.com/TSTsistemas/status/331807558815854593']],
            materials: [
                ['IoT Technology Guidebook', 'https://www.postscapes.com/internet-of-things-technologies/'],
                [
                    'Europapress',
        ...
        'urbaser-sensiot': {
            ...
            awards: '',
            technologies: ['Big Data', 'Cloud Computing', 'Data Analytics', 'Internet of Things'],
            domains: ['Cities', 'Energy', 'Industry', 'Machinery', 'Waste Management'],
            docs: [],
            videos: [['GAB 2019-Track Virtual-YouTube', 'https://www.youtube.com/watch?v=wSCHUYrv10Y']],
            materials: [
        ...
        'viralstudios-virtualart': {
            ...
            awards: '',
            technologies: ['Internet of Things', 'Industrial Technology', 'Data Analytics', 'Open Data'],
        ...
        'mobamobileautomation-mawisu2': {
            ...
            docs: [
                ...
                ['MAWIS U2-YouTube/Spanish', 'https://www.youtube.com/watch?v=JHpeZTfv7n8']
            ],
        ...
        'edagproductionsolutionsgmbhcokg-opensourcesmartcitydashboard': {
            ...
            linkedIn: '',
            twitter: '',
            productWebsite: 'https://smartcity.edag.com/en/referenzen/smart-city-dashboard/',
            excerpt:
            ...
            videos: [['Smart City Dashboard', 'https://dashboard-smartcity.de/uebersicht']],
    ...
    cities: {
        'cityofvienna-smartdatawien': {
            ...
            technologies: ['Internet of Things', 'Mobility and Location', 'Open Data'],
            domains: ['Cities', 'Government'],
            docs: [['Instructions', 'https://www.wien.gv.at/english/info/index.html']],
            videos: [],
            materials: [
                [
                    'FIWARE-Medium',
    ...
    services: {
        'atos-connectedterritories': {
            ...
            videos: [
                ['Atos Spain Tweet', 'https://twitter.com/AtosES/status/804643300435226625'],
                ['Press Release', 'https://atos.net/en/2021/press-release_2021_02_09/leader-smart-cities-idc']
            ],
            materials: [
                [
        ...
        'ballistix-ballistix': {
            ...
            technologies: ['Blockchain'],
            domains: ['Cities', 'AgriFood', 'Logistics', 'Industry', 'Ports', 'Retail', 'Home', 'Health'],
            docs: [],
        ...
        'egm-designoffice': {
            ...
            awards: '',
            technologies: ['Internet of Things', 'Sensory Systems'],
            domains: ['Electronics', 'Measurement', 'Process Manufacturing', 'Telecommunication'],
            docs: [],
            videos: [],
            materials: [],
            logo:
        ...
        'faubourgnumérique-fiwareihub': {
            ...
            references: '',
            awards: '',
            technologies: ['Data Spaces', 'Internet of Things', 'Modelling', 'Open Data'],
            domains: ['Cities', 'Green Deal', 'Industry', 'Logistics'],
            docs: [],
            videos: [
                ['Connected Canteens-YouTube', 'https://www.youtube.com/watch?v=WiU1_vwH7KA'],
                ['IOT INSTEAD FRANCK GROSSEL', 'https://www.youtube.com/watch?v=25mYRpaBbjQ'],
                ['Draft presentation EWRC2020-YouTube', 'https://www.youtube.com/watch?v=19Rh0PXPj3k']
            ],
            materials: [
        ...
        'fiwareinnovaihub-coachingtrainingservices': {
            ...
            technologies: [],
            domains: ['AgriFood', 'Cities', 'Government', 'Industry', 'Utilities', 'Oil and Gas'],
            docs: [],
            videos: [
                ['YouTube Channel', 'https://www.youtube.com/channel/UC_PaoSrMzgx4h78e4yhMxvg/videos'],
                [' GreenCities Málaga-YouTube', 'https://www.youtube.com/watch?v=farf5ZXpptU'],
        ...
        'fiwarespace-coachingtrainingservices': {
            ...
            docs: [],
            videos: [
                ['Driving Innovation-YouTube', 'https://www.youtube.com/watch?v=QUxep_Isc7Y'],
                ['Smart Province-YouTube', 'https://www.youtube.com/watch?v=VAtvmiHYNG0']
            ],
            materials: [
                [
                ...
                ['Promoting a Technological Standpoint', 'https://agencias.abc.es/noticia.asp?noticia=2991942'],
                ['EUROPE Press', 'https://www.hoy.es/badajoz/diputacion-badajoz-fiware-20181203172928-nt.html'],
                ['FIWARE Space in Badajoz', 'https://www.youtube.com/watch?v=mjzJ-taZWYk'],
                [
        ...
        'fiwarespace-consultancyintegrationservices': {
            ...
            docs: [],
            videos: [
                ['FIWARE Space-Driving Innovation', 'https://www.youtube.com/watch?v=QUxep_Isc7Y'],
                ['Smart Province-YouTube', 'https://www.youtube.com/watch?v=VAtvmiHYNG0']
            ],
            materials: [
                [
                ...
                ['Hoy-News', 'https://www.hoy.es/badajoz/diputacion-badajoz-fiware-20181203172928-nt.html'],
        ...
        'hearingsoftware-consultancyintegrationservices': {
            ...
            materials: [
                ...
                ['Telefonica-Think Big', 'https://blogthinkbig.com/author/antonio-sanchez'],
                [
                    'Geriatricarea-Senda',
        ...
        'hopu-fiwareexpertcertification': {
            ...
            docs: [],
            videos: [
                ['HOPU Marketplace', 'https://drive.google.com/file/d/1XhGm9FNG1eZvs5tyNjhBhyV4zg2JZxpr/view'],
                ['HOPU Dashboard', 'https://opendata.hopu.eu/grafana/d/46VKVlJZz/home?orgId=1'],
                ['HOPU Visualiser', 'https://opendata.hopu.eu/grafana/d/46VKVlJZz/home?orgId=1'],
        ...
        'martelinnovate-martellab': {
            ...
            domains: ['AgriFood', 'Cities', 'Energy', 'Manufacturing', 'Sustainability'],
            docs: [
                ['Architecture', 'https://docs.orchestracities.io/en/latest/architecture/'],
            ...
            materials: [
                ...
                ['News 1', 'https://www.martel-innovate.com/news/2022/03/25/digital-data-sovereignty/'],
                [
                    'News 2',
        ...
        'mnxonline-coachingtrainingservices': {
            ...
            references: '',
            awards: '',
            technologies: ['Data Spaces', 'Digital Twins', 'Mobility and Location', 'Software as a Service'],
            domains: ['Cities', 'Consumer Goods / Products', 'Education', 'Mobility', 'Tourism'],
            docs: [],
            videos: [],
            materials: [],
        ...
        'naevatec-fiwareconsultancy': {
            ...
            domains: ['Cities', 'Content', 'Education', 'Government', 'Telecommunication'],
            docs: [
                [
        ...
        'secmotic-iotdevelopment': {
            ...
            awards: '',
            technologies: ['Internet of Things', 'Artificial Intelligence', 'Blockchain', 'Open Data', 'Big Data'],
            domains: ['Cities', 'AgriFood', 'Logistics', 'Industry', 'Ports', 'Retail', 'Home', 'Health'],
        ...
        'snap4city-coachingtrainingservices': {
            ...
            videos: [
                ['Promo Video-YouTube', 'https://www.youtube.com/watch?v=UPpC9gbvEPs&t=1s'],
                ['Industry City Integration-YouTube', 'https://www.youtube.com/watch?v=s5NW8V5-yxw'],
                [' IOT App & Data Analytic Tutorial', 'https://www.youtube.com/watch?v=SBIoZpYU73E&t=28s'],
                ['Dashboard for Smart City IoT Tutorial', 'https://www.youtube.com/watch?v=DFCizDVTTlE&t=18s']
            ],
            materials: [
                ['List of Snap4City Articles', 'https://www.snap4city.org/drupal/node/78'],
                ['References of Snap4City & Km4City', 'https://www.snap4city.org/drupal/node/426'],
                ['Snap4City -EOSC Marketplace', 'https://marketplace.eosc-portal.eu/services/snap4city'],
                [
                    'Tutorial ',
        ...
        'snap4city-consultancyintegrationservices': {
            ...
            domains: ['Air Quality', 'Cities', 'Industry', 'Manufacturing', 'Tourism'],
            docs: [],
            videos: [],
            materials: [],
            logo:
        ...
        'stoneone-stoneoneservices': {
            ...
            awards: '',
            technologies: ['Artificial Intelligence', 'Quantum Computing', 'Internet of Things'],
            domains: ['Cities', 'AgriFood', 'Logistics', 'Industry', 'Ports', 'Retail', 'Home', 'Health', 'Content'],
            docs: [],
            videos: [],
            materials: [],
        ...
        'teamdev-fiwareprofessionalservices': {
            ...
            domains: ['Cities', 'Government', 'Industry', 'Sustainability', 'Utilities', 'Oil and Gas'],
            docs: [['Technology', 'https://www.teamdev.it/en/']],
            videos: [['YouTube Channel', 'https://www.youtube.com/channel/UCq2du3L6tXHgs8GCrW7CZhA']],
            materials: [
