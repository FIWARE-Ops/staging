var pageData = {
  powered: {
    'uiurbansoftware-uiurbanpulse': {
      ...
      references:
        '<p>City of Bad Hersfeld City of Darmstadt City of Langenfeld City of Brisbane</p>',
      awards:
    ...
    'bettaircities-bettair': {
      ...
      description:
        '<p>Bettair – high-quality large scale pollution mapping tools for big cities.</p> <p>Description &amp; Benefit Bettair® is a Platform as a Service (PaaS) that permits, for the first time, to map urban air pollution in cities on a previously unimaginable scale based on a large deployment of outstandingly accurate gas sensors by using an advanced post-processing algorithm. A proprietary calibration process combined with the use of unsupervised machine learning techniques to take into account both the known and unknown factors that affect the sensors allows Bettair® to increase the accuracy of the measurement up to 90% and more depending on the pollutant.</p> <p>Bettair Static Node. The Bettair Static Nodes are standalone sensor packs. The nodes do not require any external power supply and transmit data directly to a server for cloud processing. The specifications of the node are as follows:</p> <p>The static nodes are composed of electrochemical gas sensors (up to 4) to measure (ppb or ug/m3):  NO2 </p> <ul> <li><p>NO </p></li> <li><p>CO or H2S </p></li> <li><p>O3 or SO2 Optical Particle Counter (ug/m3) for: PM1 </p></li> <li><p>PM2.5 </p></li> <li><p>PM10 Other ambient quality indicators are also measured such as:</p></li> <li><p>Temperature (ºC) </p></li> <li><p>Relative humidity (%RH) </p></li> <li><p>Atmospheric pressure (hPa) </p></li> <li><p>Ambient noise (dbA) Features</p></li> <li><p>Dust tight and water resistant (IP65 rated) </p></li> <li><p>Extended battery life (over 1 year of operation) </p></li> <li><p>Fully customized design </p></li> <li><p>Low-power electronics </p></li> <li><p>Wireless</p></li> </ul>',
      challenge:
    ...
    'breezetechnologies-environmentalintelligencesuite': {
      ...
      references:
        '<p>City of Vilnius City of Neckarsulm City of Moers City of Hennef City of Siegburg (non-exhaustive list)</p>',
      awards:
        '<p>Future Hamburg Award Nordic Smart City Award Smavard Smart City Awards - Special Merits Award - Sensing and ICT German Startup Games Winner Porsche Mobility for a better world award (non-exhaustive list)</p>',
      technologies: [
        'Artificial Intelligence',
        'Big Data',
        'Data Analytics',
    ...
    'civity-snifferbike': {
      ...
      references:
        '<p>References/Customers and Partners:</p> <p>This project is developed in collaboration with the province of Utrecht and municipalities in the Utrecht region. Since then, other provinces and municipalities have also joined. Also local (cycling and sustainability) communities are participating. Non-profit organizations like the cyclist union and the RIVM are also partners.</p>',
      awards: '',
    ...
    'dksr-openurbandataplatform': {
      ...
      description:
        "<p>The Open Urban Data Platform (OUP) is the basic building block for the use of digital solutions to achieve sustainable and public welfare-oriented urban development. Via the OUP, urban data can be integrated, networked, and used to meet challenges in various areas of urban design. An open platform approach such as DKSR's OUP has the enormous advantage that data sets from different systems can be easily added, harmonized, and linked: This way, data-based solutions that individual municipalities develop are easily and quickly scalable and transferable and can contribute to the efficient management of similar tasks in numerous municipalities beyond organizational and city boundaries.</p>",
      challenge: '',
      references:
    ...
    'egm-carpoolparking': {
      ...
      description:
        '<p>SOLUTION </p> <p>The solution has been conceptualized to measure the impact and the use of car parks. The solution integrates artificial intelligence algorithms allowing the detection of cars and statistics (distribution of parking times, determination and counting of carpoolers, counting of "suction cars", etc.) The statistics are displayed via a customized dashboard.</p> <p>ROI  *To know the occupancy rate of the car park *To know if the car park is used for carpooling *Estimate the CO2 emissions avoided thanks to the carpooling encouraged by this car park *Determine whether the car park is used for other purposes (in particular, to identify "suction cars")</p>',
      challenge:
    ...
    'egm-smartirrigation': {
      ...
      yearOfValidation: 2021,
      description:
        '<p>ASSESSMENT Water consumption can be considerably reduced by dosing it according to the real water needs of the grass. It allows eliminating a recurrent tendency to over-water the ground.</p> <p>SOLUTIONS </p> <p>The solution includes: *humidity sensors set up on the ground *the interoperable context broker Stellio in order to contextualize data and propose an automatized watering schedule. ROI  *up to 30% of water consumption savings *operations associated with the maintenance (watering, mowing, use of fertilizers, mechanical operations) can be greatly simplified and reduced to the strict minimum thanks to an autonomous and remote control system of various equipment (mower, sprinklers) *obtaining a better quality ground allowing to reduce interventions on-site (fertilization, mechanical operations)</p>',
      challenge:
    ...
    'engineeringdss-curavesta': {
      ...
      yearOfValidation: 2020,
      description:
        '<p>CuraVesta© takes on this problem. This application software for mobile devices such as smartphones assists in the phase of preparation as well as in the phase of daily care. It is designed to provide effective and lasting support to people who care for their relatives and enable them to live independently and safely at home.</p> <p>The innovative mHealth service is available to the person providing care as well as the person in need of care, anytime, and anywhere. The system consists of three main components that support home care:</p> <p>Nursing Guide - The nursing app shall facilitate the accomplishment of daily tasks and reduce the mental pressure of nurturing persons. Directly at the place of nurturing, the app shall also impart knowledge on how to professionally execute typical tasks and which resources are available. Exchange platform - The nursing app shall link the nursing persons with other relatives and suppliers such as doctors, nursing services, or centralized consultation services / telemed. providers. Purchasing avatar - The nursing app shall support the nursing persons to purchase medicine, resources, meals, and so on. The nursing app supervises the stock and encourages the nursing persons to re-order in time, e.g., before public holidays. Within these components, the App provides a variety of functions to support the carer and the person in daily needs . The main functions include:</p> <p>Module daily routine with assisting documentation and control of the nursing progress. Electronic patient file with export function and link to family and GP. Accelerated application and order processes as well as time management with cost objects and care providers (supplier independent). Supplier independent integration of digital medical products and AAL. Multimedia transfer of nursing know-how. The advice of experienced nursing personnel and doctors using the patient file via video communication (support center). The assisting system will be provided in a restricted basic version and – if user acceptance is proved - it will be further developed in at least three stages.</p>',
      challenge:
    ...
    'floud-floud': {
      ...
      references:
        '<p>Municipality of Prato (Public body - Italy) Municipality of Funchal (Public body - Portugal) CATC SE (Company - sweden) Harris County Precinct Two (Public body - US) plus several other companies around the world.</p>',
      awards:
    ...
    'jig-smartappcity': {
      ...
      yearOfValidation: 2017,
      description:
        '<p>SmartAppCity brings together all the city services and information. Some examples of the data provided by the app are: arrival information on public transportation, traffic cameras, alerts, municipal news and events, open pharmacies, gas stations prices, tourist information and routes, city street guide, shopping, weather forecast, radars, public Wi-Fi zones, parks, free parking spots, environmental parameters… The app is addressed to the citizens and tourists of a city. Under a public-private partnership (PPP) framework, the municipality shows its open data to serve the citizens, and the city shops and businesses offer their products and services. The app is based on a technological and competitive differentiation about what exists for the problem solution, as well as it has a great market potential for making relevant use of cloud technologies and the existing open data of the city.</p>',
      challenge:
    ...
    'líneaciudadana-líneaciudadana': {
      ...
      yearOfValidation: 2018,
      description:
        "<p>Línea Ciudadana brings the public administration closer to the citizens with a simple and effective tool. The pillars of Línea Ciudadana's Smart City solution include facilitating governance through support for  constructive leadership and sustainability, facilitating citizen participation and democratizing cities, implementing technology with the functionalities that allow the interaction of people, and improving the quality of life of citizens.</p> <p>Today’s mobile devices allow us to create applications that are very useful for a municipality, offering participative, tourist, informative, management capacities, and more. These are some of the features and benefits we can offer via app + Cloud service Línea Ciudadana:</p> <ul> <li><p>Citizen participation: Get direct and bidirectional communication. </p></li> <li><p>Internal management: Streamlines and facilitates maintenance.</p></li> <li><p>Municipal Information: Keep the citizen informed of the latest developments in your municipality.</p></li> <li><p>Tourist information: Provides visitors with all tourist information.</p></li> <li><p>Reports and Statistics: Generates and studies results with statistics and performance KPIs. </p></li> <li><p>Citizen security: Notification service for real-time, geo-referenced alerts.</p></li> </ul>",
      challenge:
    ...
    'movisat-ecosat': {
      ...
      yearOfValidation: 2020,
      description:
        '<p>MOVISAT has developed a technological solution which integrates all the agents involved in the environmental services - Public Administration, Concessionaire Companies and Citizens - into a single platform, guaranteeing the optimization of the service.</p> <p>EcoSAT is an intelligent solution for planning, managing and controlling urban services, integrating specific modules to manage the organic waste collection, report incidents and audit service quality, optimize containerization and waste collection routes or facilitate participation in composting, recycling or reusing initiatives.</p> <p>In addition, we have all the necessary field solutions to integrate vehicles, machinery and urban furniture with the platform, guaranteeing perfect traceability through the installation of GPS, activity sensors that guarantee effective work, antennas and RFID readers, weighing scales, filling sensors for measuring the level information to plan the most efficient routes or IoT locks which recordes container opening and use information.</p>',
      challenge:
      ...
      references:
        '<p>In the last 25 years, MOVISAT has developed and implemented more than 1.000 projects all over Spain.</p> <p>Some examples:  TELEFÓNICA SMART CITIES BADAJOZ (Diputación Badajoz - Extremadura) TELEFÓNICA LA NUCÍA (Ayto La Nucía - Comunidad Valenciana) URBASER MADRID (Ayto Madrid - Madrid) UTE RM2 MADRID (Ayto Madrid - Madrid) LIPASAM (Ayto. Sevilla - Andalucía) LIMPIEZA DE MÁLAGA (Ayto. Málaga - Andalucía) UTE INDRA SATOCAN LAS PALMAS (Ayto. Las Palmas de Gran Canaria - Canarias) UTE ALICANTE (Ayto. Alicante - Comunidad Valenciana) CONSORCIO RSU CIUDAD REAL (Diputación Ciudad Real - Castilla La Mancha) VALORIZA ALBACETE (Ayto Albacete - Castilla La Mancha) CONSORCIO RSU MÁLAGA (Diputación Málaga - Andalucía) CONSORCIO PROVINCIAL DE MEDIO AMBIENTE DE VALLADOLID (Diputación Valladolid - Castilla y León) UTE ATLÁNTICA (Ayto. A Coruña - Galicia) VALORIZA SANTA CRUZ DE TENERIFE (Ayto. Santa Cruz de Tenerife - Canarias) ARCGISA (Mancomunidad Campo de Gibraltar - Andalucía) UTE ALMANZORA (Consorcio Almanzora Levante Vélez - Andalucía)  RIVAMADRID (Ayto. Rivas Vaciamadrid - Madrid) VALORIZA IBIZA (Ayto. Ibiza - Baleares) STV Torrepacheco (Ayto. Torrepacheco - Murcia) Mancomunidad de Residuos Domésticos de Cinco Villas Bortziriak (Navarra)</p>',
      awards: '',
      technologies: [
        'Artificial Intelligence',
        'Data Analytics',
    ...
    'nec-cloudcityoperationscenter': {
      ...
      yearOfValidation: 2017,
      description:
        '<p>NEC Cloud City Operations Centre (CCOC) platform acts as the brain of a smart city to enable service transformation with big data collected from diverse sources such as historical databases, IoT sensors and CCTV. City Operations Centre Predictive Analytics is a managed service that allows cities to manage, interpret and automate responses to the data collected across the city.  City Operations Centre Predictive Analytics service includes a set of CCOC modules which the client can use to create required data visualizations as defined by specific use cases. Main CCOC platform modules included with this service are: Dashboard (Content Management System): Based on widgets, it can be configured to display a customizable subset of data in a variety of ways. It also includes the feature of generating alarms. Furthermore, it includes a public citizen site with contents to be managed by the client. Big Data Storage: This handles and processes large amounts of data from IoT devices, condensing them into useful aggregated results. Real-time analyses and historical data file. IoT Broker: Connects to any kind of IoT device, without any protocol or communication constraint. ESB (Enterprise Service Bus): Connects to legacy systems, such as OSS/BSS and any application using existing API and interfaces Streaming Media Server: Brings and handles video streaming on the platform. Real-Time Processing Engine: Processes all events online, so fast actions can be taken based on them. API: Exposes all data to upper layers to get advantage of it. Publish / Subscription Notification Engine: For any system or interface to subscribe only to the information they are interested in. BPM &amp; BRE (Rules and workflows engines): Engines to create rules and workflows that automate all manual processes within the client. Analytics and Prediction Engine: By the use of algorithms, through this engine the platform can analyze what has happened and why, then it can predict what is going to happen and prescribe actions to be taken. BI (Business Intelligence): Create KPI reports for the purposes of city analytics and export in multiple formats (HTML, PDF, Excel, etc.).</p> <p>All tools and data can be accessed via one consolidated and user friendly web-based interface.  NEC CCOC platform has been developed according to de facto standards in the industry, namely FIWARE, enabling the client to easily connect with their other or third-party systems.</p>',
      challenge: '',
      references: '',
      awards: '',
    ...
    'nixi1-nixi1': {
      ...
      yearOfValidation: 2018,
      description:
        '<p>After multiple iterations and evolutions, nixi1 has become the most advanced Travel chatbot (or AITA; Artificial Intelligence Travel Agency) of the world. Since August 2016, it has acquired more than 80,000 users.</p> <p>Currently, the company has two products that correspond to two business lines. The first is AITA, focused on offering all Travel services to the end-user. The second is the white label Chatbot SaaS (Software as a Service), focused on Travel Service Suppliers, so that they can boost their direct sales channels through the CHAT.</p> <p>The Travel chatbot, AITA, has been developed with the following fundamental values:</p> <ul> <li><p>Transactional and assistance: 100% automated, it doesn’t require any human assistance. This is a particularly important milestone to allow its scalability. </p></li> <li><p>Omnichannel: Currently works in Telegram, WhatsApp, Facebook Messenger, SMS, App, and Web. nixi1’s team has developed a deep know-how to integrate any new messaging quickly. In addition, it can be integrated into mail and in the future, it will do the same in Voice Assistants such as Siri, Alexa, or Google when their respective marketplaces are enabled. </p></li> <li><p>Multi-language: Currently the chatbot is available natively in English, Spanish, French, and German and available in 95 other languages ​​through automatic translation protocols (non-native). The linguistic corpus architecture based on a contextualized sales funnel and several layers of neural networks allow the easy native translation of the chatbot into different languages.</p></li> <li><p>Voice notes: We have added the functionality of voice notes to the text and we have provided the forms with predictive capabilities.</p></li> </ul> <p>Currently, nixi1 is integrated with a broad universe of travel suppliers that gives access to a massive range of tourism services at the best price. 92% of our users say they have found the cheapest option with our solution.</p> <p>The solution for B2B helps to avoid intermediates by promoting a new direct sales channel, which also helps to acquire users at a low price, improve loyalty rates and reduce operational costs thanks to the AI. For the final consumer, it is a more economical and convenient solution.</p>',
      challenge:
        '<p>nixi1 has two customer segments. On one hand, the main problems for Travel Service Suppliers (B2B) like hotels and airlines are:</p> <ul> <li><p>DISINTERMEDIATION. There’s an excessive dependence on indirect sales channels such as OTAs (Online Travel Agencies), which charge high commissions, 15-35%. </p></li> <li><p>OPERATIONAL COSTS. Expensive and numerous call-centers. It is estimated that between 10% and 15% of all reservations of Travel Service Suppliers is via phone call and 100% of the services of customer services are operated by humans, with a high operational cost. It is a constant priority to search for mechanisms to reduce these costs. </p></li> <li><p>LOYALTY. Most travelers are price-oriented, which generates a dependence on OTAs, a channel in which the user can compare the wide range of services. The only two channels of direct communication (email and phone calls) handled by Travel Service Suppliers, beyond the web and the App, have a very low acceptance rate. </p></li> <li><p>CUSTOMER ACQUISITION COSTS (CAC). CACs are very high due to the duopoly of Booking Holdings and Expedia in Google SEM. Besides, it’s an oligopolistic sector, a few GDSs, Consolidators, TA (Travel Agencies), OTA, and Metasearchers have more than 80% share in their respective categories).</p></li> </ul> <p>On the other hand, if we consider the traveler (B2C), the two biggest challenges in the industry are:</p> <ul> <li><p>PRICE. In general terms, the traveler is sensitive to the price, the cheaper the better, as long as a quality threshold is maintained. This is even more relevant in the FLIGHT reservation, which is the first purchase of a trip. In addition, the user wants to know the final price from the beginning and not be tricked by unexpected charges at the end of the process. </p></li> <li><p>CONVENIENCE. The more comfortable the solution, the better. The traveler aims to access the biggest and most competitive offer in the market on  a single site, without unwanted redirects and without having to consult several websites or apps.</p></li> </ul>',
      references: '',
      awards: '',
      technologies: ['Data Analytics', 'Open Data'],
      domains: ['Cities'],
    ...
    'openmove-openmove': {
      ...
      description:
        '<p>OpenMove is an end-to-end mobility platform with 24/7 cloud provision which features multiple ITS (Intelligent Transport Systems) modules. AFC (Automated Fare Collection) system which allows sales capabilities across multiple channels as well as a comprehensive set of tools for the personnel of the transport service provider. Account-Based Ticketing Omnichannel digital sales (e-commerce, white-label app, sales tools for field personnel and ticket shops, on-board validators and gates) Fast and reliable activation of tickets Anti-fraud detection DRT (Demand-Responsive Transit). A system able to feature on-demand services and reservations on fixed-line services, including interfaces for final users, management tool, and dynamic vehicle routing engine capable of optimizing trip dispatchment. Flexible on-call services based on demand Boarding lists in real-time Improved accessibility to services for various user categories Automated trip management Optimization of seat reservations RTPI (Real-Time Passenger Information). A system providing travelers with accurate real-time information for moving seamlessly. Route calculation with intermodal trip planning Real-time vehicle location  Calculation of ETA (Estimated Time of Arrival) Dynamic timetables Real-time changes and alerts for the planned itinerary MaaS (Mobility as a Service). MaaS Integration layer to provide real answers to users’ freedom of movement and enable governance over the mobility scheme. Intermodal integration of multiple transport services Access and booking services to the mobility options of a region Communication channel with users Full interoperability of data and services Enabling a new transportation marketplace able to increase user base and revenues</p>',
      challenge:
    ...
    'phoops-muvapp': {
      ...
      challenge:
        "<p>MUV-App is a platform designed to turn the mobility system into a safe, sustainable and user-friendly system. Urban mobility is, in fact, often perceived as a messy and complex world to deal with. However, we believe that there are a lot of chances to improve the performance of the system. The ever-evolving world of mobility is enriching the offer (especially in terms of Mobility as a Service - MaaS - system), but, in parallel, the complexity of the system is growing. The plurality of actors and services available leads to an atomization of the users' experience and  fragmentation of sources and data. MUV's core idea is based on the concept of MaaS for  public administration. Thanks to the application of the MaaS' governance system, MUV provides innovative tools for the management of the entire mobility system. Looking for a clear and easy city mobility view, we developed the MUV App identifying four main areas of intervention:</p> <p>1) Fragmentation and complexity derived from multiple subjects and different services (fragmented data to collect, too much subject to get in touch, etc.);  2) Poor quality of user experience throughout the services delivered;  3) Lack of attention for the users in terms of engagement and empowering;  4) Need for effective tools to support green mobility policies.</p>",
      references: '',
      awards: '',
      technologies: [
        'Mobility and Location',
    ...
    'scuter-scuter': {
      ...
      yearOfValidation: 2018,
      description:
        '<p>Scuter has developed a vertically integrated service to overcome and satisfy widespread fast and clean urban commuting demand. We designed a 3-wheels electric scooter that can be driven without wearing a helmet. This blinks at car drivers that are not used to motorcycle driving experience and are looking for an alternative to their cars. Our service will be a free-floating pay per use vehicle sharing, with  dynamic pricing based on an AI algorithm that will allow References/Customers to earn money if they help us with logistics and battery swap, thus reducing the opex for us. We are enabling a crypto token service to leverage  the cleantech economy. Our design inputs were:</p> <ul> <li><p>A fast and light scooter: cars in any form (proprietary or shared) are too traffic affected in urban environments. </p></li> <li><p>The safest and the cleanest scooter. </p></li> <li><p>Everyone must feel comfortable in using SCUTER, not only the experienced riders.</p></li> </ul> <p>In addition, Scuter is:</p> <ul> <li><p>Clean: Zero-emissions, 100% electric vehicle. </p></li> <li><p>Easy: You just need your smartphone to pick Scuter up. </p></li> <li><p>Safe: 3-wheels, safety belts, no helmet, just ride and save your time. </p></li> <li><p>Smart: Use the smart platform onboard to connect to your friends and have fun.</p></li> </ul>',
      challenge:
    ...
    'snap4city-km4city': {
      ...
      awards:
        '<p>Winner of the ENEL-X Challenge on Open Data: https://openinnovability.enel.com/projects/New-smart-city-solutions-enabled-by-open-data  Winner of the Select4Cities PCP for the design of the IoT/IoE solution and Living Lab for Helsinki and Antwerp (https://www.select4cities.eu/phase-3-winners)  Snap4City is certified to offer FIWARE Training Services Snap4City is certified to offer FIWARE Consultancy Services Snap4City is a platform proposed on the Marketplace of EOSC Snap4city is on BeeSmart marketplace Snap4City is compliant with OBD2 Devices for vehicles and fleets monitoring Snap4City is fully compliant with GIS, ArcGIS, QGIS, etc., interoperating with WMS and WFS services, see the examples of Snap4City in connection with ArcGIS or OpenGIS provided and made available Km4City: Km4City of Snap4City is an official API of E015 suite LoraWAN: Snap4City is compliant with LoraWan SigFOX: Snap4City is a partner of SigFOX Node-RED, JSFoundation: Snap4City is an official library of Node-RED CKAN: Km4City/Snap4City are Powered by CKAN, since they provide DataGate CKAN module for shortening the ingestion and publication of Data Sets, and the eventual connection with other CKAN tools and installations in the world. Gold Member of the FIWARE Foundation Official Powered by FIWARE Solution GAIA-X member</p>',
      technologies: [
        'Advanced or High Performance Computing',
        'Artificial Intelligence',
        'Data Analytics',
    ...
    'snap4city-snap4city': {
      ...
      yearOfValidation: 2021,
      description:
        '<p>Cities are rapidly transforming their services to address current societal, environmental, and economic challenges. Vertical smart solutions are being progressively replaced by solutions capable of exploiting a huge range of data channels, getting smarter, and cross exploiting data. Cities/areas require highly tailored solutions, exploiting the legacy and pushing to the future and innovation. A flexible, dynamic, and highly interoperable platform is needed to increase sustainability, profit, and full control of operational objectives, fully integrated with the territory and all the stakeholders. Cities are abandoning an approach based on single data sources and becoming aware of actual data channels where information and actions flow in multiple directions and Digital Twins and creating living labs with all stakeholders, 3D City and building representation, BIM local and global. Multi-directional flows are key services in implementing the city/area operating system enabling daily tuning to deal with current challenges, mobility as a service, smart waste, smart lighting and smart parking. Snap4City is a 100% open-source platform used in many cities and areas. It is an official FIWARE Platform and Solution (https://www.snap4city.org/467, https://www.fiware.org/) developed under the coordination of DISIT Lab of the University of Florence, Italy. Snap4City is GDPR compliant, passed PENTest, and it is an EOSC platform, an official Node-RED Library, an official E015 API, etc. The platform is provided  as a “ Service” basis, or installed in your location (by yourself, as well as using a number of companies), no license fee is needed. The platform has at present a wide range of activities in the smart city and IoT/IoE (Internet of Things/Internet of Everything) integrated domains: defining city strategies, implementing control room, realizing ethics and explainable artificial intelligent solutions and computing key performance indicators which are used daily in both city and industry management. Snap4City has incorporated Km4City (https://www.km4city.org) ontological and semantic model to guarantee the data interoperability with any kind of IoT Devices, device models, data entities, and physical structures ranging from the city, industry, and home. And thus, also with FIWARE Smart Data Models, providing a number of real-time open-source solutions to support decision-makers in cities and large industries to ground their daily operational actions on solid explainable artificial intelligence predictions, deductions and assessments. It provides a complete understanding of the context and its trends, receiving an early warning, anomaly detections, and performing simulation and what-if analysis. This information is used to suggest strategic interventions to improve city services and general quality of life, in multiple domains (e.g., Smart Cities and Smart Industry). The proposed solution is flexible enough to support extensions at different levels of granularity: data, analytics, tools, applications, MicroServices, and IoT brokers. In this regard, the solution uses FIWARE Orion Broker based on NGSI to connect with a large number of devices thanks to the IoT Directory and Km4City Knowledge base. The solution also developed NGSI compliant IoT Edge of several kinds. Snap4City is also compliant with other protocols and models such as MQTT, AMQP, OneM2M, SigFOX, LoraWAN, and many others.</p>',
      challenge: '',
      references:
        '<p>Snap4City is operative with services and data in more than 40 cities/areas in countries such as: Firenze (IT), Helsinki (FI), Antwerp (BE), Lonato del Garda (IT), Lavagno (IT), Valencia (SP), Pont Du Gard (FR), WestGreece (GR), Mostar (BA), Dubrovnik (KR), Santiago di Compostela (SP), Pisa (IT), Prato (IT), Pistoia (IT), Lucca (IT), Arezzo (IT), Grosseto (IT), Livorno (IT), Siena (IT), Massa (IT), Modena (IT), Cagliari (IT), Venezia (IT), Roma (IT), etc.; and from regions as Tuscany (IT), Garda Lake (IT), Svealand Region (Sweden), Sardegna (IT), Belgium (BE), Finland (Fl), Emilia Romagna (IT), Spain (SP), WestGreece (GR), Occitanie (FR), Bosnia-Herzegovina (BA), Croatia (KR), and many industries.</p>',
      awards: '',
    ...
    'teamdev-wisetowngeoanalytics': {
      ...
      yearOfValidation: 2014,
      description:
        '<p>WiseTown GeoAnalytics is a digital platform based on customized dashboards and integrates data collected by IoT sensors, GIS (Geographical Information System) data, information from city portals and various applications to create a tool to support city intervention strategies. The DSS platform (Decision Support System) is able to analyze city data and show correlations between different phenomena, thanks to the use of included cartographic maps and the possibility of superimposing information from different information streams. Maps, graphs, infographics and statistics highlight valuable information and provide an extrapolation of complex information useful for more informed urban planning.</p>',
      challenge:
    ...
    'teamdev-wisetownissuemanager': {
      ...
      yearOfValidation: 2014,
      description:
        '<p>WiseTown Issue Manager is the digital system that creates a direct link between the municipal administration and citizens. The module consists of two main elements: a reporting tool for citizens and a workflow management software for reporting by the public administration. On the citizen’s side, WiseTown Issue Manager is a smartphone app – available for both IOS and Android – through which they can report problems in the city to their administration: breakdowns, malfunctions, damaged goods and so on. The report of the criticality generates a task to be assigned to the right department of the administration. On the Public Administration side, WiseTown Issue Manager is a report management software that simplifies collection and automates internal management by improving staff workflow. Each issue generated by the report is converted into a task and assigned. The fully automated process avoids the use of additional resources for sorting reports, optimizes response times to critical issues, facilitates the planning of interventions and provides immediate feedback to the citizen.</p>',
      challenge:
    ...
    'teamdev-wisetownsituationroom': {
      ...
      yearOfValidation: 2014,
      description:
        '<p>WiseTown Situation Room responds to the need for administrations to monitor city events, mobility flows and emergency situations in real-time, with the aim of safely managing urban dynamics. The basis of the WiseTown platform is the huge amount of data produced by the monitored phenomena. The data collected comes from various sources: video surveillance systems, dedicated apps, IoT sensor data, video cameras, the web, geo-referenced social data and more. The control room collects and aggregates the “situation” data and uses them as tools to make and implement operational decisions in a short time. The data is then displayed in a single dashboard in which the central element is the map of the area, complemented by information boxes, media streams and customized statistics. The dashboard provides a visualization of the data that ensures immediate analysis and response.</p>',
      challenge:
    ...
    'teamdev-wisetownthematicdashboard': {
      ...
      yearOfValidation: 2014,
      description:
        '<p>WiseTown Thematic Dashboard is an application that creates customized views to compare cartographic information with statistical data and real-time data from satellite systems. All dashboards offer the highest degree of configurability and allow effective analysis of urban phenomena. Among the many possibilities, there are time-lapse satellite dashboards for comparing the evolution of the phenomenon over time; dashboards for analyzing public parks and gardens for reports on health of plants and vegetation; dashboards on the degree of urban land consumption; dashboards with social and economic data on the population; dashboards on quality of life indicators; dashboards on the analysis of mobility flows; dashboards for monitoring the safety of the city and the territory. Our interactive dashboards are map-based and contain statistical data analysis boxes with the ability to activate filters and selections to differentiate the display of information.</p>',
      challenge:
    ...
    'telefónica-thinkingcities': {
      ...
      yearOfValidation: 2016,
      description:
        '<p>The Thinking Cities platform is an integral solution to support City services. It includes a series of modules that allow the acquisition, processing, storage, and distribution of data, on which several City Services, vertical IoT solutions,and Data Analytics can be implemented easily. This platform is based on the standards, and interfaces developed within the framework of the European FIWARE initiative The functionality of  Telefonica’s Thinking Cities platform focuses on the lifecycle of the data related to the service and aspects related to the client’s part. In this sense, four main groups of the case of use can be distinguished: Data insertion in the platform: acquisition of data from sensors and external systems to be stored on the platform. Data transformation in the platform: operations carried out in the platform with the data available to generate new data. Query of data of the platform - Visualization and extraction of data stored on the platform, either by end-users or by other modules. Sending data from the platform - Sending notifications or commands as a consequence of data entry on the platform or administrative tasks. The main modules of this platform are:</p> <p>1) IoT Agents. This component collects all the observations that come from the devices and transforms them into NGSi events available in the Context Broker. In this way, applications can consume information from observations from the devices and send commands (in the case of devices that support this functionality). 2) Context Broker (Orion) The Context Broker is a module that retrieves, maintains, and introduces context information within the platform. It is an implementation of the Generic Enabler Publish / Subscribe Context Broker defined in FIWARE, providing NGSI interfaces. 3) NGSI Data Adapter (Cygnus) Cygnus is the component that is responsible for processing the data sent by the Context Broker in its notification format and adapting them to the different sinks of the platform, such as MySQL, CKAN, Hadoop, or Mongo. 4) Open Data Portal (CKAN) CKAN is a tool for open data web portals. Facilitates the management and publication of data collections. It is widely used by national, regional and local governments, research centers and other organizations that accumulate large amounts of data. 5) Short-term historic (STH) Allows the storage of data processed by the Context Broker and allows its subsequent recovery both in the form of raw data and aggregated data. 6) Analytical database (ADB) Makes the data stored internally on the platform available to the presentation layer. 7) Business Intelligence (BI) Main part of the presentation layer. 8) Extract, Transform and Load information tools (ETL, ESB) Because there is data stored in external sources that have to be loaded in the platform, there are two modules in charge of obtaining information from these sources, transforming it into a format compatible with the platform and storing it in the different data sinks. 9) Complex Event Processor (CEP) Analyzes data coming from events in real-time, infers insights immediately and makes possible an instantaneous response to changing conditions. 10) Bid Data Analysis (Hadoop) Free code framework for the storage and large-scale processing of datasets in consumer hardware clusters. 11) Identity Manager, Policy Enforcement, Policy Administration (IDM&amp;AUTH) Identity management, authentication and authorization scheme based on three main elements (IDM, PEP, and PAP/PDP). 12) Administration portal. The administration portal provides a user interface to facilitate certain operations of the platform such as the creation of services, sub services, and users as well as the administration of entities, devices, subscriptions, and rules of each one of the services discharged.</p>',
      challenge:
        '<p>Smart Valencia VLCi - Ajuntament de Valencia Smart Santander STDRi - Ayuntamiento de Santander Smart Guadalajara - Ayuntamiento de Guadalajara Smart Región Andalucía - Junta de Andalucía Smart ALBA - Ayuntamiento de Almendralejo y Badajoz Smart Toledo - Ayuntamiento de Toledo Ajuntament de Calvià (Mallorca) Málaga Smart City - Ayuntamiento de Málaga Technoport 2025 - Puerto de Sevilla Badajoz Es Más - Diputación de Badajoz Territorio Rural Inteligente - Junta de Castilla y León Ayuntamiento de Cartagena Smart Vigo Ciudad Inteligente VCI+ - Ayuntamiento de Vigo Lanzarote Smart Island Reserva Inteligente de la Biosfera – Cabildo de Lanzarote Smart Island Mallorca - Consell de Mallorca Mi Murcia - Ayuntamiento de Murcia Ayuntamiento de Benidorm Universidad de Málaga Universidad de Cádiz Ayuntamiento de Rota La Nucía Smart Sport Salamanca Tormes+ Diputación de Castellón – Smart Villages Fuerteventura Open Island Smart La Palma DTI Diputación de Cádiz Alcoi Smart City DTI Diputación Ourense Ayuntamiento de Calpe Smart Destination Puerto de la Cruz Smart Región Murcia La Manga 365 (DUSI - Smart Region)</p>',
      references:
    ...
    'ubiwhere-urbanplatform': {
      ...
      yearOfValidation: 2018,
      description:
        "<p>Our Urban Platform allows data collection from multiple domains such as traffic, air quality, and waste collection, displaying it in a unified way. Having information from different fields combined in a single, customizable dashboard, enables municipalities to get the information they need to create informed, data-driven policies. This way, decision-makers can ensure that the decisions they take are well-founded and get empirical reports on their impact. Our end-users can set their customized dashboards, choosing the information from any source available and combining it through different domains such as mobility, environment and public policies, with the ultimate purpose of reducing operational costs, reducing greenhouse gasses emissions, and improving their citizens' overall quality of life.</p>",
      challenge: '',
      references:
        '<p>City of Porto City of Guimarães City of Évora  City of Helsinki  City of Granada</p>',
    ...
    'universityofdeusto-waste4think': {
      ...
      yearOfValidation: 2017,
      description:
        '<p>The main objective of Waste4Think is to move forward the current waste management practices into a circular economy motto demonstrating the value of integrating and validating 20 eco-innovative solutions that cover all the waste value chain. The benefits of these solutions will be enhanced by a holistic waste data management methodology and will be demonstrated in 4 complementary urban areas in Europe.  Attached to this main objective a set of specific ones have been defined to indicate what the project will be focused into:</p> <ul> <li><p>To reduce generation of waste thanks to prevention campaigns and cooperative activities to promote reuse and eco-design solutions.</p></li> <li><p>To promote behavioural changes in the waste generators by awareness campaigns and new educational tools in order to foster more sustainable consumption and production habits and to increase the rate of waste sorting. </p></li> <li><p>To improve the integral waste management services reducing their management costs and the GHG (greenhouse gas) emissions. </p></li> <li><p>To reduce the amount of primary waste deposited in landfill to zero and to the maximum in case of secondary waste.</p></li> <li><p>To identify the waste products with a low potential for recycling and to propose eco-innovative valorisation and production solutions.</p></li> <li><p>To assess the transferability to the market of the new proposed eco-innovative solutions. Expected impacts Integrating all these solutions we will be able to construct a virtual smart city laying the foundations of the circular economy maximizing the expected results up to:</p></li> <li><p>A 8% reduction of waste generation </p></li> <li><p>A 10% reduction of GHG emissions </p></li> <li><p>20% increment of waste sorting </p></li> <li><p>10% savings in the management costs</p></li> </ul>',
      challenge:
  ...
  ready: {
    ...
    'datakorumsolutions-ls40': {
      ...
      yearOfValidation: 2017,
      description:
        '<p>With one unique device, we can master from one point/location of light to whole streets. Its connection to E3TGlobal CLOUD is via WiFi and user applications are available for PC, Android and IOS.</p> <p>Individual point to point control is the best option for installations where each point of light should behave differently in on/off switching, dimming, energy, and any problem in real-time.</p> <p>The Smart version LS40 also allows setting behavior, alarms and sensors associated events. LS40 line has been thought to transform one point of light into a smart element of the Smart City. With this device in its different configurations we can control on/off switching, dimming, power consumption measuring, air quality measuring, pollution, noise level, temperature, humidity…</p> <p>In addition to its point of light main electric parameters measuring, the equipment allows fail, blinking and stealing detection and on/off switching scheduled programming.</p>',
      challenge: '',
      references: '',
      awards: '',
      technologies: ['Internet of Things', 'Cloud Computing'],
    ...
    'datakorumsolutions-peak': {
      ...
      yearOfValidation: 2018,
      description:
        '<p>Our system allows remote control and monitoring of any new or existing streetlight network. This control is achieved by installing one PEAK device just before the lights section we want to command. With one unique device, we can master from one point of light to whole streets.</p> <p>PEAK line has been thought to transform one point of light into a smart element of the Smart City. With this device in its different configurations, we can control on/off switching, dimming, power consumption measuring, air quality measuring, pollution, noise level, temperature, humidity.</p> <p>In addition to its point of light main electric parameters measuring, the equipment allows failing, blinking, and stealing detection and on/off switching scheduled programming.</p> <p>Datakorum platform allows our devices to establish point-to-point connections with both our cloud and user applications developed by us or third parties. The implementation of MQTTcommunication and MySQL databases allows fast and easy integration with other platforms.</p>',
      challenge: '',
      references: '',
      awards: '',
      technologies: ['Internet of Things', 'Cloud Computing'],
    ...
    'datakorumsolutions-plug': {
      ...
      yearOfValidation: 2018,
      description:
        '<p>The smart lighting solution consists of a wireless programmable communication device for each light fixture, connecting to the cloud without intermediate points.</p> <p>The controller allows the light fitting to be easily turned on and off or adjusted; the main electrical parameters can be monitored, sending warnings if faults are detected. Control is possible by time programming, using motion and/or luminosity sensors, and by manual commands executed from the user application.</p> <p>Best Suited for Street Lamps that Meet ANSI C136.41:</p> <p>ANSI C136.41 compliant dimming receptacle. IP65 waterproof rating. 230VAC power supply. Power consumption measuring. 1-10V and/or DALI regulation. Supports up to 1 external sensor. Nodes or gateways are not required. Full control of data flow. Configurable data storage. Configurable alerts and alarms. Remote firmware updates.</p>',
      challenge: '',
      references: '',
      awards: '',
      technologies: ['Internet of Things', 'Cloud Computing'],
    ...
    'datakorumsolutions-pole': {
      ...
      yearOfValidation: 2018,
      description:
        '<p>The smart lighting solution consists of a wireless programmable communication device for each light fixture, connecting to the cloud without intermediate points.</p> <p>The controller allows the light fitting to be easily turned on and off or adjusted; the main electrical parameters can be monitored, sending warnings if faults are detected. Control is possible by time programming, using motion and/or luminosity sensors, and by manual commands executed from the user application.</p> <p>Best Suited for Smart Lighting Projects:</p> <p>IP65 waterproof rating. 230VAC power supply. Power consumption measuring. 1-10V and/or DALI regulation. Supports 1 external sensor. Full control of data flow. Nodes or gateways are not required. Configurable data storage. Configurable alerts and alarms. Remote firmware updates.</p>',
      challenge: '',
      references: '',
      awards: '',
      technologies: ['Internet of Things', 'Cloud Computing'],
    ...
    'datakorumsolutions-sc40': {
      ...
      yearOfValidation: 2017,
      description:
        "<p>IoT sensor monitoring system allows any analog or digital sensor to behave as if it were an IoT sensor, and establishes a real-time connection between the cloud and sensors. The measures taken by sensors can be sent instantaneously, and enable events, alerts and alarms associated with them.</p> <p>Our controller implements policies that allow minimum data transfer using very low cost M2M lines.</p> <p>SC40 controllers let you connect up to four different sensors to the same controller. It's the cheapest way to implement a sensor network worldwide.</p> <p>Its connection to E3TGlobal CLOUD is via WiFi and user applications are available for PC, Android, and IOS.</p>",
      challenge: '',
      references: '',
      awards: '',
      technologies: ['Internet of Things', 'Cloud Computing'],
    ...
    'datakorumsolutions-ss47': {
      ...
      yearOfValidation: 2017,
      description:
        '<p>IoT sensor monitoring system allows any analog or digital sensor to behave as if it were an IoT sensor, and establishes a real-time connection between the cloud and sensors. The measures taken by sensors can be sent instantaneously, and enable events, alerts and alarms associated with them.</p> <p>Our controller implements policies that allow minimum data transfer using very low cost M2M lines.</p> <p>SS47 controller has four built-in internal sensors; Temperature, humidity, luminosity, and presence.</p> <p>The RS485 port lets you connect any standard modbus sensor to the internet. Its connection to E3TGlobal CLOUD is via WiFi and user applications are available for PC, Android, and IOS.</p>',
      challenge: '',
      references: '',
      awards: '',
      technologies: ['Internet of Things', 'Cloud Computing'],
    ...
    'datakorumsolutions-tiny': {
      ...
      yearOfValidation: 2018,
      description:
        '<p>The smart lighting solution consists of a wireless programmable communication device for each light fixture, connecting to the cloud without intermediate points.</p> <p>The controller allows the light fitting to be easily turned on and off or adjusted; the main electrical parameters can be monitored, sending warnings if faults are detected. Control is possible by time programming, using motion and/or luminosity sensors, and by manual commands executed from the user application.</p> <p>Best Suited for Lighting Manufacturers:</p> <p>12 to 48 VDC supply (through driver). Power consumption measuring. 1-10V and/or DALI regulation. Supports up to 1 external sensor. Nodes or gateways are not required. Full control of data flow. Configurable data storage. Configurable alerts and alarms. Remote firmware updates.</p>',
      challenge: '',
      references: '',
      awards: '',
      technologies: ['Internet of Things', 'Cloud Computing'],
    ...
    'devicegateway-udg': {
      ...
      yearOfValidation: 2017,
      description:
        '<p>Value Proposition: Interoperability, legacy integration and increased reliability</p> <p>By enabling  wide interoperability with over 40 standards and communication protocols, UDG enables  smooth integration of legacy systems and transition towards new technologies. Cross systems integration and simplification</p> <p>UDG enables the integration of heterogeneous systems and IoT technologies into a common data plane that enables it to bring together all sorts of data in real-time. It enables the development of cross-domain applications and  centralized control and monitoring of your deployed IoT systems. This leads to  simplified maintenance with substantial cost savings, and increased reliability. Cost-saving</p> <p>By giving access to a larger offer in terms of solutions and suppliers, UDG enables a more open competition with reduced cost and a richer offer in terms of functionalities. It also enables smart cities to adapt and reuse a large set of applications and solutions developed by other smart cities at a very low cost. UDG is a source of both capital and operating expenditure savings.</p> <p>Increased reliability</p> <p>By enabling extensive interoperability, UDG enables smart cities to avoid vendors lock-in. It increases  reliability by easing the adoption of alternative solutions and technology providers. It is more reliable and cost saving through competition.</p> <p>Compliance with present and future solutions for smart cities</p> <p>UDG is a certified FIWARE solution, fully interoperable with OASC API, oneM2M, LWM2M, CoAP, MQTT, and other protocols. UDG Alliance is a partner of the European Large Scale Pilot on Internet of Things for Smart Cities (Synchronicity), where it will lead the development of the European marketplace for smart cities IoT solutions. It is also in the core group developing the Urban Platform of the European Innovation Partnership for Smart Cities and Communities (EIP-SCC). A guarantee that UDG technology will be compliant with emerging technologies, applications, and platforms for smart cities.</p> <p>Real-Time Data Monitoring</p> <p>UDG enables smart cities to benefit from customized graphical user interfaces and applications with real time monitoring of their environment and better services for their citizens.</p> <p>Data sharing and comparison</p> <p>Thanks to  close integration with the mainstream European smart cities frameworks and platforms for IoT management, UDG eases  data sharing, data comparison, and benchmarking among cities.</p> <p>Privacy by Design</p> <p>UDG has been designed to fully comply with the European General Data Protection Regulation (GDPR) and benefits from several research projects in this domain. It is also working on close collaboration with top European experts to deliver fully privacy by design solutions</p>',
      challenge: '',
      references: '',
      awards: '',
      technologies: ['Internet of Things'],
    ...
    'egm-edgespot': {
      ...
      yearOfValidation: 2021,
      description:
        '<p>The EdgeSpot allows the connection of sensors and actuators through all types of telecommunication networks for a wide variety of use cases.</p> <p>Its capabilities allow remote intelligent processing and control algorithms in the field (edge processing) while maintaining a low energy footprint. Powered by a battery, solar charge, or electrical network, it adapts to all situations.</p> <p>Once the use case is clarified, the card can be adjusted to meet the need at an optimized cost while reusing the software already developed.</p>',
      challenge:
    ...
    'engineering-dashram': {
      ...
      yearOfValidation: 2021,
      description:
        '<p>Dashram provides all the tools necessary to display data through numerous charts and to compose and share dashboards. To do this, Dashram implements a layered architecture composed of different components that allow:  to connect to heterogeneous data sources through the Digital Enabler (powered by FIWARE Platform), including the Orion Context Broker ; to create and manage different types of graphs, including 3D urban and timeline graphs; to create, manage and share dashboards made up of multiple charts and other graphic and text components.</p>',
      challenge:
    ...
    'engineering-knowage': {
      ...
      yearOfValidation: 2014,
      description:
        '<p>KNOWAGE is the professional open-source suite for analytics and business intelligence over traditional sources and cloud/big data systems. KNOWAGE is developed according to the NGSI standards and implements the GE reference for data visualization. KNOWAGE provides two main modules and four plug-ins focused on specific domains, allowing to settle a tailored product for every analytical scope.</p> <p>The modules of the suite are: </p> <ul> <li>SI (smart intelligence) carries out the “usual” business intelligence on structured data, focused on self-service and ad-hoc reporting ER (enterprise reporting) produces and distributes static reports with a pixel-perfect and ready- to-print layout in a secure way</li> </ul> <p>The plug-ins for the SI module are:</p> <p>SD (smart data) allows to combine Solr index with other data sources and provides faceted views and full-text search. LI (location intelligence) combines business data with spatial or geographical information through mashup techniques. PM (performance management) manages KPIs with thresholds and organizes scorecards with real-time alerts. CA (custom analytics) allows to add what-if capabilities and take full advantage of R/python embedding possibilities.</p> <p>KNOWAGE complies the criteria of modern BI, giving high customization capabilities and high autonomy to the end-user, ow able to build his own analysis and explore his own data space, always in a secure and well-managed environment, fully supporting the bi-modal approach where fast development meets enterprise requirements such as data consistency and reliability.</p> <p>Thanks to the open-source model and adoption of open standards, KNOWAGE can be used as-is or easily included in a third-part application giving it new value with embedded analytics.</p>',
      challenge:
    ...
    'greenglobesypa-nighteyeskysensor': {
      ...
      references:
        '<p>Telefónica. Citelum. Edf Group. Junta de Andalucía. Ayuntamiento de Algeciras. Cabildo de Tenerife.</p>',
      awards: '',
      technologies: [
        'Internet of Things',
        'Modelling',
    ...
    'wellnesstechgroup-quamtra': {
      ...
      yearOfValidation: 2017,
      description:
        '<p>The Quamtra system optimizes collection routes by constantly monitoring the content level of waste containers. By installing sensors in the containers it is possible to receive real-time alerts for collection based on container content level, temperature variation (fires), or movement (shaking) enabling a reduction in damage liability and response time.  Municipalities: Operational costs reduction by up to 35%. Reduce collection costs by optimizing routes and fuel. Real-time filing status of containers. Real-time fire alarms to reduce response time and damage compensations and liability. Container location monitoring (optional GPS module). ROI &lt; 2 years. Emissions reduction through optimization of routes. Better quality of service and street cleaning. Civic awareness (App.)</p> <p>Waste management companies / Utilities: Easy installation and deployment. Remote configuration of dispositives. Routes and fuel optimization. Integrable with client waste management solutions. ROI &lt; 2 years. Installable in a wide range of existing containers in the market.</p> <p>Citizens: Improved perception about the quality of service. Citizen participation (App). Traffic descongestion. GHG emissions reduction.</p> <p>Use Cases: Collection planning Fire detection Tipping detection Identifying displaced containers Analysis to optimize the placement, quantity, and use of containers throughout the city Service audits</p>',
      challenge:
  ...
  services: {
    ...
    'egm-designoffice': {
      ...
      yearOfValidation: 2021,
      description:
        '<p>EGM ensures the design of your solution taking into account your criteria of performance, price, quantities, standards, mechanical integration, optimization, the choice of technologies, and manufacturing methods with a user-centered creation process.</p> <p>FEASABILITY STUDY Our engineering design office offers you its expertise and know-how in electronics and embedded IoT to provide technical  expertise for your project. Based on your idea, EGM will identify the key development points and offer you the best solution to carry out your project.</p> <p>DESIGN We develop systems from scratch or  technological bricks. According to the technical specifications that we draft with you, we select the best  components taking into account the requirements of the project.</p> <p>PROTOTYPING The development involves the realization of an electronic prototype V1 which allows you  to validate together the functionalities and the concept of your product. Then, we proceed to the electronic prototype V2 which integrates the possible evolutions, or modifications seen previously.</p> <p>INDUSTRIALIZATION AND MANUFACTURING Thanks to our skills, we are able to calibrate, optimize costs and electronic card manufacturing processes. Whether for prototypes, small, medium, or large series, we offer production plans adapted to the objectives of our References/Customers. We are supporting organizations in deploying FIWARE architectures, starting from data ingestion up to data processing, with new NGSI-LD data models.</p>',
      challenge: '',
      references: '',
      awards: '',
      technologies: ['Internet of Things', 'Sensory Systems'],
    ...
    'hopu-fiwareexpertcertification': {
      ...
      yearOfValidation: 2021,
      description:
        '<p>The course is organized in 4 blocks for 8 weeks; this means 2 weeks per block; where we will have every week 2 sessions online; plus individual work/activities offline. This means an intensive programme of 180 hours; including 60 hours online and 120 hours of individual activities to become a FIWARE Expert!</p> <p>During every block, the organization planned is as follows: ● Day 1 (Monday) - Theoretical introduction to get key concepts. ● Day 2 (Thursday) - Discussion (Note that FIWARE Expert evaluation is based on discussion questions). ● Day 3 (Monday) - Hands-on practices ● Day 4 (Thursday) - Example of FIWARE expert questions/exercises and evaluation.</p>',
      challenge: '',
      references:
        '<p>Canarian companies selected in the framework of the FIMAC project (Spain) University of Alicante summer Bootcamp (Spain)</p>',
      awards:
        '<p>*Catalyst Awards Honorees 2019 - Green Electronic Council  *Vice Chair of the IEEE Communications Society  *Internet of Things Technical Committee </p> <ul> <li>FIWARE Foundation Gold member </li> <li>ETSI ISG CIM Member (Semantic Interoperability for Smart Cities) </li> <li>OMA Members (LwM2M and NGSI real-time communication protocols) </li> <li>IPSO Alliance Challenge - People Choice Award (Sponsored by Google) </li> <li>Best Smart City demo award - MIT</li> </ul>',
      technologies: [],
      domains: ['Cities', 'AgriFood', 'Industry', 'Ports'],
      docs: [],
      videos: [
    ...
    'martelinnovate-martellab': {
      ...
      challenge: '',
      references: '<p>Antwerp Helsinki Wolfsburg EKZ</p>',
      awards:
    ...
    'snap4city-coachingtrainingservices': {
      ...
      yearOfValidation: 2021,
      description:
        '<p>Snap4City - Scalable Smart aNalytic APplication Builder for Sentient Cities, the powered by FIWARE solution proving flexible method and solution to quickly create a large range of smart city applications exploiting heterogeneous data and enabling services for stakeholders by IoT/IoE, data analytics, and big data technologies.</p> <p>Snap4City team organizes the course on "Smart City IoT Course from data gathering to smart applications and Control Rooms"</p> <p>The course includes frontal slides, full access to the Snap4City platform (officially powered by FIWARE solution) and development tools, and exercises during the courses. A final certificate is provided under request to certify the level of proficiency of participants. Courses organized by the Snap4City team are typically open to everybody and free of charge.</p> <p>Snap4City provides consultancy on setting up the smart city, data discovering and aggregation, data identification, living lab set up, living lab management and workshops, data agreement establishing with your stakeholders, GDPR, etc.; consultancy on technical aspects of smart city design, and of the infrastructure, technical integration with your legacy solutions and infrastructures, etc.; customization of the powered by FIWARE solution Snap4City platform (https://www.snap4city.org), design and development of new modules, tools, and plugins; smart city as a service on the Snap4City.org infrastructure (see also EOSC https://www.snap4city.org/503 marketplace in which Snap4City is listed); installation of the platform on your premise, or on your indicated public cloud; maintenance of an installed Snap4City solution, on our cloud, on any cloud, on your premise. As well as  second-level maintenance or support to your personnel that has taken  charge of the management of your installation of Snap4City tools; organizing and managing hackathons and coworking sections for your stakeholders; training your operative personnel for using the platform, creating dashboards, IoT Applications, installing the platform, etc. (this can be personalized or cumulated in training days and week with other References/Customers), it can be on our location or  your premise; developing data analytics over those that are freely provided, and/or setting up data analytics that needs learning phases on your premise; For example, the development and/or the set up of traffic flow reconstruction solution in your city and/or area; developing new mobile Apps, tools, and applications; or new modules in our Apps of the "FIWARE servicesx in a Snap" series; developing customization of the SnapBot Telegram bot attached to your solution based on Snap4City technology; developing new IoT Devices with requested sensors and actuators; help desk support on all the aspects over an exceeding amount of hours that are free of charge;</p> <p>Smart Cities/Industries companies need to set up a flexible Living Lab to cope with their evolution in terms of services and city users’ needs and sustainability. Snap4City is a 100% open-source platform used in many cities and areas. It is an official FIWARE Platform and Solution (https://www.snap4city.org/467, https://www.fiware.org/) developed under the coordination of DISIT Lab of the University of Florence, Italy. Snap4City is GDPR compliant, passed PENTest, and it is an EOSC platform, an official Node-RED Library, an official E015 API, etc. The platform is provided as a “ Service” basis or installed in your location (by yourself, as well as using a number of companies), no license fee is needed. The platform has at present a wide range of activities in the smart city and IoT/IoE (Internet of Things/Internet of Everything) integrated domains: defining city strategies, implementing control room, realizing ethics and explainable artificial intelligent solutions, and computing key performance indicators which are used daily in both city and industry management. Snap4City has incorporated Km4City (https://www.km4city.org) ontological and semantic model to guarantee the data interoperability with any kind of IoT Devices, device models, data entities, and physical structures ranging from the city, industry, and home. And thus, also with FIWARE Smart Data Models, providing a number of real-time open-source solutions to support decision-makers in cities and large industries to ground their daily operational actions on solid explainable artificial intelligence predictions, deductions, and assessments. It provides a complete understanding of the context and its trends, receiving an early warning, anomaly detections, and performing simulation and what-if analysis. This information is used to suggest strategic interventions to improve city services and general quality of life, in multiple domains (e.g., Smart Cities and Smart Industry). The proposed solution is flexible enough to support extensions at different levels of granularity: data, analytics, tools, applications, MicroServices, and IoT brokers. In this regard, the solution uses FIWARE Orion Broker based on NGSI to connect with a large number of devices thanks to the IoT Directory and Km4City Knowledge base. The solution also developed NGSI compliant IoT Edge of several kinds. Snap4City is also compliant with other protocols and models such as MQTT, AMQP, OneM2M, SigFOX, LoraWAN, and many others.</p>',
      challenge: '',
      references:
        '<p>Snap4City is operative with services and data in more than 40 cities/areas in countries such as Firenze (IT), Helsinki (FI), Antwerp (BE), Lonato del Garda (IT), Lavagno (IT), Valencia (SP), Pont Du Gard (FR), WestGreece (GR), Mostar (BA), Dubrovnik (KR), Santiago di Compostela (SP), Pisa (IT), Prato (IT), Pistoia (IT), Lucca (IT), Arezzo (IT), Grosseto (IT), Livorno (IT), Siena (IT), Massa (IT), Modena (IT), Cagliari (IT), Venezia (IT), Roma (IT), etc.; and from regions as Tuscany (IT), Garda Lake (IT), Svealand Region (Sweden), Sardegna (IT), Belgium (BE), Finland (Fl), Emilia Romagna (IT), Spain (SP), WestGreece (GR), Occitanie (FR), Bosnia-Herzegovina (BA), Croatia (KR), and many industries.</p>',
      awards:
    ...
    'teamdev-fiwareprofessionalservices': {
      ...
      yearOfValidation: 2014,
      description:
        '<p>TeamDev is a software house founded in 2008 that designs and develops innovative solutions to make data actionable for industrial digitalization, sustainable development and urban management. Areas of action: Smart Industry: We design and develop Industry 4.0 solutions ranging from advanced analytics to human machine interfaces and AI powered manufacturing control systems. Digital PA: We deliver consulting services to international organizations and Public Administrations engaged in sustainable development and international cooperation projects. Smart City: We support local governments with a comprehensive suite of solutions that range from civic technologies to advanced decision support systems for local administrators. Thanks to our wide range of skills and multisectorial projects, we can provide teaching, mentoring, and on-the-job training, as well as outsourced support related to the use of FIWARE technologies in multiple frameworks. Technical expertise: AI, GIS, IoT, Data Visualization, BIG DATA, Remote Sensing, Predictive Maintenance, advanced HMI and UX design.</p>',
      challenge: '',
      references:
