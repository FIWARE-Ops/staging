...
const isShuttleBus = ["==", ["get", "type"], "Shuttle Bus"];
...
function addLayer(source) {
  ...
  source,
  layout: {
    "icon-image": ["case", isVenue, 'venue', isPOI, 'attraction',  isHotel, 'hotel',  isRestaurant, 'restaurant', isAirport, 'airport',  isShuttleBus, 'shuttle', 'trainStation'],
