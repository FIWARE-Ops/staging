...
var modalData = [
    ...
    { 
        ...
        badge: "<img src='https://www.fiware.org/custom/brand-guide/img/badges/catalogue/01/svg/core.svg'/>",
        chapter: "core", 
        content: "<p><img src='https://img.shields.io/github/license/N5GEH/n5geh.tools.entirety.svg' alt='License' /> <img src='https://img.shields.io/github/release-date/N5GEH/n5geh.tools.entirety.svg' alt='' /> <img src='https://img.shields.io/github/commits-since/N5GEH/n5geh.tools.entirety/latest.svg' alt='' /></p> <h4 id='whatisentirety'>What is Entirety?</h4> <p>Entirety is a web-based graphical user interface (GUI) meant to provide easy access to some of FIWARE's Generic Enablers (GE) without requiring deeper knowledge on their APIs: Context Brokers like Orion and the IoT Agent JSON. Entirety is python-based and relies on the FIWARE Library for Python (FiLiP) for the communication with the GE APIs.</p> <p>Entirety holds modules (as displayed on the left hand side of the GUI) providing features to perform CRUD (create, read, update, delete) operations to entities in the Context Broker, devices in the IoT Agent, and subscriptions / notifications to QuantumLeap or other applications. Furthermore, Entirety provides a graphical overview of the semantic relationships between entities in the Semantics module as well as a store for standardized data models that can be either created or imported from external sources.</p> <h4 id='whyuseentirety'>Why use Entirety?</h4> <p>Entirety simplifies the process of updating context data and displays relationships between entities allowing for simpler interactions between components.</p>",  
        domain: "Data Connector",  
        technology: "",
        status: "Incubating",
        gitHub: "https://github.com/N5GEH/n5geh.tools.entirety",
        gitHubOrg: "https://github.com/N5GEH",
        docker: "https://ghcr.io/n5geh/n5geh.tools.entirety",
        quay: "",
